---
title: Shoda jazyka Visual C++ | Dokumentace Microsoftu
ms.date: 11/15/2017
ms.technology:
- cpp-language
ms.topic: conceptual
...
|Oblast funkcí| |
|----|---|
|__C ++ 03/11 základní funkce jazyka__|__Podporované__|
|&nbsp;&nbsp;Všechno ostatní|VS 2015 <sup> [A](#note_A)</sup>|
|&nbsp;&nbsp;Dvoufázové vyhledávání názvů|VS 2017 15.7 <sup> [B](#note_B)</sup>|
|&nbsp;&nbsp;[N2634 Výraz SFINAE](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2008/n2634.html)|VS 2017 15.7|
|&nbsp;&nbsp;[Preprocesor C99 N1653](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2004/n1653.htm)|Částečné <sup> [D](#note_D)</sup>|
...
|__C ++ 14 základní funkce jazyka__|__Podporované__|
...
|__C ++ 17 základní funkce jazyka__|__Podporované__|
...
|&nbsp;&nbsp;[CWG 1581: Pokud jsou členské funkce constexpr definován?](https://wg21.cmeerw.net/cwg/issue1581)|Ne|
...
|&nbsp;&nbsp;[Přejmenování Variadické P0156R2 Zámek\_ochranu do oboru\_zámku](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/p0156r2.html)|VS 2017 15.3 <sup> [17](#note_17)</sup>|
