---
title: x64 (amd64) – seznam vnitřních objektů | Dokumentace Microsoftu
ms.custom: ''
ms.date: 06/01/2018
ms.technology:
- cpp-tools
...
- Soubor hlaviček. Mnoho vnitřní objekty jsou popsány v komentářích v hlavičkovém souboru.
...
Následující tabulka uvádí vnitřní objekty dostupné na x64 procesory. Technologie sloupec uvádí vyžaduje podporu sada instrukcí. Použití [__cpuid](../intrinsics/cpuid-cpuidex.md) vnitřní určit podporu instrukční sada v době běhu. Pokud dvě položky jsou v jednom řádku, představují různé vstupní body pro vnitřní stejné. [1] značí, že vnitřní objekt je k dispozici pouze u procesorů AMD. [2] značí, že vnitřní objekt je k dispozici pouze na procesorech Intel. [3] značí, že prototyp je makro. Záhlaví, vyžaduje se pro prototyp funkce je uveden v záhlaví sloupce. Hlaviček intrin.h zahrnuje immintrin.h i ammintrin.h pro zjednodušení.

|Název vnitřního objektu|Technologie|Záhlaví|Prototyp funkce|
|--------------------|----------------|------------|------------------------|
|_addcarry_u16||intrin.h|unsigned char _addcarry_u16 (unsigned char c_in, unsigned short src1, unsigned short src2 unsigned short \*součet)|
|[_addcarry_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u32)||intrin.h|unsigned char _addcarry_u32 (unsigned char c_in, src1 unsigned int, unsigned int src2, unsigned int \*součet)|
|[_addcarry_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u64)||intrin.h|unsigned char _addcarry_u64 (unsigned char c_in, bez znaménka \__int64 src1, bez znaménka \__int64 src2, bez znaménka \__int64 \*součet)|
|_addcarry_u8||intrin.h|unsigned char _addcarry_u8 (unsigned char c_in, src1 unsigned char, src2 unsigned char, unsigned char \*součet)|
|[_addcarryx_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u32)|ADX [2]|immintrin.h|unsigned char _addcarryx_u32 (unsigned char c_in, src1 unsigned int, unsigned int src2, unsigned int \*součet)|
|[_addcarryx_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u64)|ADX [2]|immintrin.h|unsigned char _addcarryx_u64 (unsigned char c_in, bez znaménka \__int64 src1, bez znaménka \__int64 src2, bez znaménka \__int64 \*součet)|
|[__addgsbyte](../intrinsics/addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsbyte (unsigned char bez znaménka, dlouhé)|
|[__addgsdword](../intrinsics/addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsdword (unsigned int bez znaménka, dlouhé)|
|[__addgsqword](../intrinsics/addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsqword (unsigned long, bez znaménka \__int64)|
|[__addgsword](../intrinsics/addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsword (unsigned short long bez znaménka)|
...
|[_BitScanForward](../intrinsics/bitscanforward-bitscanforward64.md)||intrin.h|Logická _BitScanForward (OUT ULONG\* maska ULONG Index, Indie)|
|[_BitScanForward64](../intrinsics/bitscanforward-bitscanforward64.md)||intrin.h|Logická _BitScanForward64 (OUT ULONG\* maska ULONG64 Index, Indie)|
|[_BitScanReverse](../intrinsics/bitscanreverse-bitscanreverse64.md)||intrin.h|Logická _BitScanReverse (OUT ULONG\* maska ULONG Index, Indie)|
|[_BitScanReverse64](../intrinsics/bitscanreverse-bitscanreverse64.md)||intrin.h|Logická _BitScanReverse64 (OUT ULONG\* maska ULONG64 Index, Indie)|
|[_bittest](../intrinsics/bittest-bittest64.md)||intrin.h|unsigned char _bittest (dlouho const \*dlouho a, b).|
|[_bittest64](../intrinsics/bittest-bittest64.md)||intrin.h|unsigned char _bittest64 (\__int64 const \*,\__int64 b).|
|[_bittestandcomplement](../intrinsics/bittestandcomplement-bittestandcomplement64.md)||intrin.h|unsigned char _bittestandcomplement (long \*dlouho a, b).|
...
|[_bittestandreset](../intrinsics/bittestandreset-bittestandreset64.md)||intrin.h|unsigned char _bittestandreset (long \*dlouho a, b).|
...
|[_bittestandset](../intrinsics/bittestandset-bittestandset64.md)||intrin.h|unsigned char _bittestandset (long \*dlouho a, b).|
...
|[__inbytestring](../intrinsics/inbytestring.md)||intrin.h|void __inbytestring (unsigned char unsigned short Port \*vyrovnávací paměti, unsigned long počet)|
...
|[__indwordstring](../intrinsics/indwordstring.md)||intrin.h|void __indwordstring (unsigned short Port unsigned long \*vyrovnávací paměti, unsigned long počet)|
|[__int2c](../intrinsics/int2c.md)||intrin.h|void __int2c(void)|
|[_InterlockedAnd](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedAnd (long volatile \*, long)|
|[_InterlockedAnd_HLEAcquire](../intrinsics/interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedAnd_HLEAcquire (long volatile \*, long)|
|[_InterlockedAnd_HLERelease](../intrinsics/interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedAnd_HLERelease (long volatile \*, long)|
|[_InterlockedAnd_np](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedAnd_np (long \*, long)|
|[_InterlockedAnd16](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|krátký _InterlockedAnd16 (krátký volatile \*, short)|
|[_InterlockedAnd16_np](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|krátký _InterlockedAnd16_np (short \*, short)|
...
|[_interlockedbittestandreset](../intrinsics/interlockedbittestandreset-intrinsic-functions.md)||intrin.h|unsigned char _interlockedbittestandreset (long \*dlouho a, b).|
|[_interlockedbittestandreset_HLEAcquire](../intrinsics/interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandreset_HLEAcquire (long \*dlouho a, b).|
|[_interlockedbittestandreset_HLERelease](../intrinsics/interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandreset_HLERelease (long \*dlouho a, b).|
...
|[_interlockedbittestandset](../intrinsics/interlockedbittestandset-intrinsic-functions.md)||intrin.h|unsigned char _interlockedbittestandset (long \*dlouho a, b).|
|[_interlockedbittestandset_HLEAcquire](../intrinsics/interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandset_HLEAcquire (long \*dlouho a, b).|
|[_interlockedbittestandset_HLERelease](../intrinsics/interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandset_HLERelease (long \*dlouho a, b).|
...
|[_InterlockedCompareExchange](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedCompareExchange (long volatile \*, long, dlouhý)|
|[_InterlockedCompareExchange_HLEAcquire](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedCompareExchange_HLEAcquire (long volatile \*, long, dlouhý)|
|[_InterlockedCompareExchange_HLERelease](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedCompareExchange_HLERelease (long volatile \*, long, dlouhý)|
|[_InterlockedCompareExchange_np](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedCompareExchange_np (long \*, long, dlouhý)|
...
|[_InterlockedCompareExchange16](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|krátký _InterlockedCompareExchange16 (krátký volatile \*krátký operand porovnávání cíl, krátký Exchange)|
|[_InterlockedCompareExchange16_np](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|krátký _InterlockedCompareExchange16_np (krátký volatile \*krátký operand porovnávání cíl, krátký Exchange)|
...
|[_InterlockedCompareExchange8](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|Char _InterlockedCompareExchange8 (char volatile \*cíl, char Exchange, char operand porovnávání)|
...
|[_InterlockedCompareExchangePointer_HLEAcquire](../intrinsics/interlockedcompareexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|typ void * _InterlockedCompareExchangePointer_HLEAcquire (void \*volatile \*, void \*, void \*)|
|[_InterlockedCompareExchangePointer_HLERelease](../intrinsics/interlockedcompareexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|typ void * _InterlockedCompareExchangePointer_HLERelease (void \*volatile \*, void \*, void \*)|
...
|[_InterlockedExchange](../intrinsics/interlockedexchange-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedExchange (long volatile \*, long)|
|[_InterlockedExchange_HLEAcquire](../intrinsics/interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedExchange_HLEAcquire (long volatile \*, long)|
|[_InterlockedExchange_HLERelease](../intrinsics/interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedExchange_HLERelease (long volatile \*, long)|
|[_InterlockedExchange16](../intrinsics/interlockedexchange-intrinsic-functions.md)||intrin.h|krátký _InterlockedExchange16 (krátký volatile \*, short)|
...
|[_InterlockedExchangeAdd](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedExchangeAdd (long volatile \*, long)|
|[_InterlockedExchangeAdd_HLEAcquire](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedExchangeAdd_HLEAcquire (long volatile \*, long)|
|[_InterlockedExchangeAdd_HLERelease](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedExchangeAdd_HLERelease (long volatile \*, long)|
|[_InterlockedExchangeAdd16](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)||intrin.h|krátký _InterlockedExchangeAdd16 (krátký volatile \*, short)|
...
|[_InterlockedExchangePointer_HLERelease](../intrinsics/interlockedexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|typ void * _InterlockedExchangePointer_HLERelease (void \*volatile \*, void \*)|
...
|[_InterlockedOr](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedOr (long volatile \*, long)|
|[_InterlockedOr_HLEAcquire](../intrinsics/interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedOr_HLEAcquire (long volatile \*, long)|
|[_InterlockedOr_HLERelease](../intrinsics/interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedOr_HLERelease (long volatile \*, long)|
|[_InterlockedOr_np](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedOr_np (long \*, long)|
|[_InterlockedOr16](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|krátký _InterlockedOr16 (krátký volatile \*, short)|
|[_InterlockedOr16_np](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|krátký _InterlockedOr16_np (short \*, short)|
...
|[_InterlockedXor](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedXor (long volatile \*, long)|
|[_InterlockedXor_HLEAcquire](../intrinsics/interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedXor_HLEAcquire (long volatile \*, long)|
|[_InterlockedXor_HLERelease](../intrinsics/interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedXor_HLERelease (long volatile \*, long)|
|[_InterlockedXor_np](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedXor_np (long \*, long)|
|[_InterlockedXor16](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|krátký _InterlockedXor16 (krátký volatile \*, short)|
|[_InterlockedXor16_np](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|krátký _InterlockedXor16_np (short \*, short)|
...
|[__inwordstring](../intrinsics/inwordstring.md)||intrin.h|void __inwordstring (unsigned short Port unsigned short \*vyrovnávací paměti, unsigned long počet)|
...
|_load_be_u16<br /><br /> [_loadbe_i16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i16&expand=3071)|MOVBE|immintrin.h|unsigned short _load_be_u16 (void const\*);<br /><br /> krátký _loadbe_i16 (void const\*); [3]|
...
|[_mm_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_i32gather_epi32 (int const \*base,\__m128i index, const int škálování)|
...
|[_mm_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_i32gather_pd (double const \*base,\__m128i index, const int škálování)|
|[_mm_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_i32gather_ps (float const \*base,\__m128i index, const int škálování)|
|[_mm_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_i64gather_epi32 (int const \*base,\__m128i index, const int škálování)|
...
|[_mm_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_i64gather_pd (double const \*base,\__m128i index, const int škálování)|
|[_mm_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_i64gather_ps (float const \*base,\__m128i index, const int škálování)|
...
|[_mm_loadh_pi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_loadh_pi)|SSE|intrin.h|__m128 _mm_loadh_pi (\__m128,\_výrazů _m64\*)|
...
|[_mm_loadl_pi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_loadl_pi)|SSE|intrin.h|__m128 _mm_loadl_pi (\__m128,\_výrazů _m64\*)|
...
|[_mm_storeh_pi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storeh_pi)|SSE|intrin.h|void _mm_storeh_pi (\_výrazů _m64\*,\__m128)|
...
|[_mm_storel_pi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storel_pi)|SSE|intrin.h|void _mm_storel_pi (\_výrazů _m64\*,\__m128)|
...
|[_mm256_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_i32gather_epi32 (int const \*base,\__m256i index, const int škálování)|
...
|[_mm256_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_i32gather_pd (double const \*base,\__m128i index, const int škálování)|
|[_mm256_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_ps)|AVX2 [2]|immintrin.h|__m256 _mm256_i32gather_ps (float const \*base,\__m256i index, const int škálování)|
|[_mm256_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_i64gather_epi32 (int const \*base,\__m256i index, const int škálování)|
...
|[_mm256_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_i64gather_pd (double const \*base,\__m256i index, const int škálování)|
|[_mm256_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm256_i64gather_ps (float const \*base,\__m256i index, const int škálování)|
...
|[__movsb](../intrinsics/movsb.md)||intrin.h|VOID __movsb (PBYTE Indie, IN BAJTŮ const \*, SIZE_T Indie)|
|[__movsd](../intrinsics/movsd.md)||intrin.h|VOID __movsd (PDWORD Indie, IN DWORD const \*, SIZE_T Indie)|
|[__movsq](../intrinsics/movsq.md)||intrin.h|VOID __movsq (PDWORD64 Indie, IN DWORD64 const \*, SIZE_T Indie)|
|[__movsw](../intrinsics/movsw.md)||intrin.h|VOID __movsw (pword – Indie, IN slovo const \*, SIZE_T Indie)|
|[_mul128](../intrinsics/mul128.md)||intrin.h|__int64 _mul128 (\__int64 multiplikátor\__int64 násobenec\__int64 \*highproduct)|
...
|[__outbytestring](../intrinsics/outbytestring.md)||intrin.h|void __outbytestring (unsigned char unsigned short Port \*vyrovnávací paměti, unsigned long počet)|
|[__outdword](../intrinsics/outdword.md)||intrin.h|void __outdword (unsigned short Port, unsigned long – datový)|
|[__outdwordstring](../intrinsics/outdwordstring.md)||intrin.h|void __outdwordstring (unsigned short Port unsigned long \*vyrovnávací paměti, unsigned long počet)|
|[__outword](../intrinsics/outword.md)||intrin.h|void __outword (unsigned short Port, unsigned short – datový)|
|[__outwordstring](../intrinsics/outwordstring.md)||intrin.h|void __outwordstring (unsigned short Port unsigned short \*vyrovnávací paměti, unsigned long počet)|
...
|[__readgsbyte](../intrinsics/readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|unsigned char __readgsbyte (unsigned long posunu)|
|[__readgsdword](../intrinsics/readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|unsigned long __readgsdword (unsigned long posunu)|
|[__readgsqword](../intrinsics/readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|unsigned __int64 \__readgsqword (unsigned long posunu)|
|[__readgsword](../intrinsics/readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|unsigned short __readgsword (unsigned long posunu)|
...
|[_rotl16](../intrinsics/rotl8-rotl16.md)||intrin.h|unsigned short _rotl16 (krátké hodnoty bez znaménka, unsigned char shift)|
|[_rotl8](../intrinsics/rotl8-rotl16.md)||intrin.h|unsigned char _rotl8 (hodnota typu char bez znaménka, unsigned char shift)|
|[_rotr16](../intrinsics/rotr8-rotr16.md)||intrin.h|unsigned short _rotr16 (krátké hodnoty bez znaménka, unsigned char shift)|
|[_rotr8](../intrinsics/rotr8-rotr16.md)||intrin.h|unsigned char _rotr8 (hodnota typu char bez znaménka, unsigned char shift)|
...
|[__shiftleft128](../intrinsics/shiftleft128.md)||intrin.h|unsigned __int64 \__shiftleft128 (unsigned \__int64 LowPart, bez znaménka \__int64 HighPart unsigned char Shift)|
|[__shiftright128](../intrinsics/shiftright128.md)||intrin.h|unsigned __int64 \__shiftright128 (unsigned \__int64 LowPart, bez znaménka \__int64 HighPart unsigned char Shift)|
...
|_store_be_u16<br /><br /> [_storebe_i16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i16&expand=5141)|MOVBE|immintrin.h|void _store_be_u16 (void \*, short bez znaménka);<br /><br /> void _storebe_i16 (void \*, short); [3]|
...
|[__stosb](../intrinsics/stosb.md)||intrin.h|void __stosb (SIZE_T PBYTE Indie, IN BYTE, Indie)|
|[__stosd](../intrinsics/stosd.md)||intrin.h|void __stosd (PDWORD Indie, IN DWORD v SIZE_T)|
|[__stosq](../intrinsics/stosq.md)||intrin.h|void __stosq (PDWORD64 Indie, IN DWORD64 v SIZE_T)|
|[__stosw](../intrinsics/stosw.md)||intrin.h|void __stosw (SIZE_T pword – Indie, IN slovo, Indie)|
|_subborrow_u16||intrin.h|unsigned char _subborrow_u16 (unsigned char b_in, unsigned short src1, unsigned short src2 unsigned short \*rozdíl)|
|[_subborrow_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u32)||intrin.h|unsigned char _subborrow_u32 (unsigned char b_in, src1 unsigned int, unsigned int src2, unsigned int \*rozdíl)|
|[_subborrow_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u64)||intrin.h|unsigned char _subborrow_u64 (unsigned char b_in, bez znaménka \__int64 src1, bez znaménka \__int64 src2, bez znaménka \__int64 \*rozdíl)|
|_subborrow_u8||intrin.h|unsigned char _subborrow_u8 (unsigned char b_in, src1 unsigned char, src2 unsigned char, unsigned char \*rozdíl)|
...
|[_umul128](../intrinsics/umul128.md)||intrin.h|unsigned __int64 _umul128 (unsigned \__int64 násobitel, bez znaménka \__int64 násobenec, bez znaménka \__int64 \*highproduct)|
...
|[__writedr](../intrinsics/writedr.md)||intrin.h|void __writedr (bez znaménka, bez znaménka \__int64)|
...
|[__writegsbyte](../intrinsics/writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsbyte (bez znaménka dlouho posunu, unsigned char Data)|
|[__writegsdword](../intrinsics/writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsdword (bez znaménka dlouho posunu, unsigned long – datový)|
|[__writegsqword](../intrinsics/writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsqword (unsigned long posun unsigned \__int64 Data)|
|[__writegsword](../intrinsics/writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsword (bez znaménka dlouho posunu, unsigned short – datový)|
|[__writemsr](../intrinsics/writemsr.md)||intrin.h|void __writemsr (unsigned long, bez znaménka \__int64)|
...
|[_xbegin](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xbegin)|RTM [2]|immintrin.h|bez znaménka _xbegin(void)|
...
|[_xrstor](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xrstor)|XSAVE [2]|immintrin.h|void _xrstor (void const\*bez znaménka \__int64)|
|[_xrstor64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xrstor64)|XSAVE [2]|immintrin.h|void _xrstor64 (void const\*bez znaménka \__int64)|
|[_xsave](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave)|XSAVE [2]|immintrin.h|void _xsave (void\*bez znaménka \__int64)|
|[_xsave64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave64)|XSAVE [2]|immintrin.h|void _xsave64 (void\*bez znaménka \__int64)|
|[_xsaveopt](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsaveopt)|XSAVEOPT [2]|immintrin.h|void _xsaveopt (void\*bez znaménka \__int64)|
|[_xsaveopt64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsaveopt64)|XSAVEOPT [2]|immintrin.h|void _xsaveopt64 (void\*bez znaménka \__int64)|
...
[x86 vnitřních objektů](../intrinsics/x86-intrinsics-list.md)