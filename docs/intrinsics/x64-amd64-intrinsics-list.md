...
ms.locfileid: "74163523"
---
# <a name="x64-amd64-intrinsics-list"></a>x64 (amd64) – seznam vnitřních funkcí

Tento dokument obsahuje seznam vnitřních objektů, které C++ kompilátor společnosti Microsoft podporuje, pokud je cílem x64 (označovaného také jako amd64).
...
- Hlavičkový soubor. Mnoho vnitřních objektů je dokumentováno v komentářích v hlavičkovém souboru.

- [Průvodce vnitřními prvky Intel](https://software.intel.com/sites/landingpage/IntrinsicsGuide). Pomocí vyhledávacího pole můžete najít konkrétní vnitřní prvky.

- [Příručky pro vývojáře softwaru pro architekturu Intel 64 a IA-32](https://software.intel.com/articles/intel-sdm)

- [Referenční informace o programování rozšíření sady instrukcí Intel Architecture](https://software.intel.com/isa-extensions)
...
## <a name="x64-intrinsics"></a>vnitřní objekty x64

V následující tabulce jsou uvedeny vnitřní objekty dostupné pro procesory x64. Ve sloupci technologie je uvedena požadovaná podpora sady instrukcí. Pomocí vnitřní [__cpuid](cpuid-cpuidex.md) můžete určit podporu sady instrukcí v době běhu. Pokud jsou dvě položky na jednom řádku, představují různé vstupní body pro stejný vnitřní typ. A [1] označuje, že vnitřní je k dispozici pouze pro procesory AMD. A [2] označuje, že vnitřní funkce je k dispozici pouze pro procesory Intel. A [3] označuje prototyp jako makro. Hlavička požadovaná pro prototyp funkce je uvedena ve sloupci záhlaví. Hlavička intrin. h obsahuje pro jednoduchost immintrin. h i ammintrin. h.

|Název vnitřního objektu|Technologie|Záhlaví|Prototyp funkce|
|--------------------|----------------|------------|------------------------|
|_addcarry_u16||intrin. h|Nepodepsaný znak _addcarry_u16 (nepodepsaný znak, unsigned short, ununsigned Short, unsigned short \*)|
|[_addcarry_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u32)||intrin. h|Nepodepsaný znak _addcarry_u32 (unsigned char, unsigned int, unsigned int, unsigned int \*)|
|[_addcarry_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u64)||intrin. h|Nepodepsaný znak _addcarry_u64 (bez znaménka char, unsigned \__int64, nepodepsaný \__int64, nepodepsaný \__int64 \*)|
|_addcarry_u8||intrin. h|unsigned char _addcarry_u8 (bez znaménka char, unsigned char, unsigned char, unsigned char \*)|
|[_addcarryx_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u32)|ADX [2]|immintrin. h|Nepodepsaný znak _addcarryx_u32 (unsigned char, unsigned int, unsigned int, unsigned int \*)|
|[_addcarryx_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u64)|ADX [2]|immintrin. h|Nepodepsaný znak _addcarryx_u64 (bez znaménka char, unsigned \__int64, nepodepsaný \__int64, nepodepsaný \__int64 \*)|
...
|_andn_u64|BMI [1]|ammintrin. h|Nepodepsaný __int64 _andn_u64 (nepodepsaný \__int64, nepodepsaný \__int64)|
...
|[_bextr_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bextr_u64)|BMI|ammintrin. h, immintrin. h|Nepodepsaný __int64 _bextr_u64 (bez znaménka \__int64, unsigned int, unsigned int)|
|_bextri_u32|ABM [1]|ammintrin. h|unsigned int _bextri_u32 (unsigned int, unsigned int)|
|_bextri_u64|ABM [1]|ammintrin. h|Nepodepsaný __int64 _bextri_u64 (bez znaménka \__int64, unsigned int)|
|[_BitScanForward](bitscanforward-bitscanforward64.md)||intrin. h|Nepodepsaný znak _BitScanForward (unsigned long\*, unsigned long)|
|[_BitScanForward64](bitscanforward-bitscanforward64.md)||intrin. h|Nepodepsaný znak _BitScanForward64 (unsigned long\*, unsigned \__int64)|
|[_BitScanReverse](bitscanreverse-bitscanreverse64.md)||intrin. h|Nepodepsaný znak _BitScanReverse (unsigned long\*, unsigned long)|
|[_BitScanReverse64](bitscanreverse-bitscanreverse64.md)||intrin. h|Nepodepsaný znak _BitScanReverse64 (unsigned long\*, unsigned \__int64)|
|[_bittest](bittest-bittest64.md)||intrin. h|Nepodepsaný znak _bittest (Long const \*, Long)|
|[_bittest64](bittest-bittest64.md)||intrin. h|unsigned char _bittest64 (\__int64 const \*, \__int64)|
|[_bittestandcomplement](bittestandcomplement-bittestandcomplement64.md)||intrin. h|Nepodepsaný znak _bittestandcomplement (dlouhý \*, Long)|
...
|[_bittestandreset](bittestandreset-bittestandreset64.md)||intrin. h|Nepodepsaný znak _bittestandreset (dlouhý \*, Long)|
|[_bittestandreset64](bittestandreset-bittestandreset64.md)||intrin. h|unsigned char _bittestandreset64 (\__int64 \*, \__int64)|
|[_bittestandset](bittestandset-bittestandset64.md)||intrin. h|Nepodepsaný znak _bittestandset (dlouhý \*, Long)|
|[_bittestandset64](bittestandset-bittestandset64.md)||intrin. h|unsigned char _bittestandset64 (\__int64 \*, \__int64)|
|_blcfill_u32|ABM [1]|ammintrin. h|Nepodepsaný int _blcfill_u32 (unsigned int)|
|_blcfill_u64|ABM [1]|ammintrin. h|Nepodepsaný __int64 _blcfill_u64 (bez znaménka \__int64)|
|_blci_u32|ABM [1]|ammintrin. h|Nepodepsaný int _blci_u32 (unsigned int)|
|_blci_u64|ABM [1]|ammintrin. h|Nepodepsaný __int64 _blci_u64 (bez znaménka \__int64)|
|_blcic_u32|ABM [1]|ammintrin. h|Nepodepsaný int _blcic_u32 (unsigned int)|
|_blcic_u64|ABM [1]|ammintrin. h|Nepodepsaný __int64 _blcic_u64 (bez znaménka \__int64)|
|_blcmsk_u32|ABM [1]|ammintrin. h|Nepodepsaný int _blcmsk_u32 (unsigned int)|
|_blcmsk_u64|ABM [1]|ammintrin. h|Nepodepsaný __int64 _blcmsk_u64 (bez znaménka \__int64)|
|_blcs_u32|ABM [1]|ammintrin. h|Nepodepsaný int _blcs_u32 (unsigned int)|
|_blcs_u64|ABM [1]|ammintrin. h|Nepodepsaný __int64 _blcs_u64 (bez znaménka \__int64)|
|_blsfill_u32|ABM [1]|ammintrin. h|Nepodepsaný int _blsfill_u32 (unsigned int)|
|_blsfill_u64|ABM [1]|ammintrin. h|Nepodepsaný __int64 _blsfill_u64 (bez znaménka \__int64)|
|[_blsi_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsi_u32)|BMI|ammintrin. h, immintrin. h|Nepodepsaný int _blsi_u32 (unsigned int)|
|[_blsi_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsi_u64)|BMI|ammintrin. h, immintrin. h|Nepodepsaný __int64 _blsi_u64 (bez znaménka \__int64)|
|_blsic_u32|ABM [1]|ammintrin. h|Nepodepsaný int _blsic_u32 (unsigned int)|
|_blsic_u64|ABM [1]|ammintrin. h|Nepodepsaný __int64 _blsic_u64 (bez znaménka \__int64)|
|[_blsmsk_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsmsk_u32)|BMI|ammintrin. h, immintrin. h|Nepodepsaný int _blsmsk_u32 (unsigned int)|
|[_blsmsk_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsmsk_u64)|BMI|ammintrin. h, immintrin. h|Nepodepsaný __int64 _blsmsk_u64 (bez znaménka \__int64)|
|[_blsr_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsr_u32)|BMI|ammintrin. h, immintrin. h|Nepodepsaný int _blsr_u32 (unsigned int)|
|[_blsr_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsr_u64)|BMI|ammintrin. h, immintrin. h|Nepodepsaný __int64 _blsr_u64 (bez znaménka \__int64)|
...
|[_bzhi_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bzhi_u64)|BMI [2]|immintrin. h|Nepodepsaný __int64 _bzhi_u64 (bez znaménka \__int64, unsigned int)|
...
|[__emulu](emul-emulu.md)||intrin. h|Nepodepsaná __int64 [Pascal/CDECL]\__emulu (unsigned int, unsigned int)|
...
|[__inbyte](inbyte.md)||intrin. h|Nepodepsaný znak __inbyte (unsigned short)|
|[__inbytestring](inbytestring.md)||intrin. h|void __inbytestring (nepodepsaný krátkým, nepodepsaným znakem \*, unsigned long)|
...
|[__indword](indword.md)||intrin. h|Long __indword bez znaménka (krátký unsigned)|
...
|[_InterlockedAnd](interlockedand-intrinsic-functions.md)||intrin. h|Long _InterlockedAnd (dlouhý nestálý \*, Long)|
|[_InterlockedAnd_HLEAcquire](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin. h|Long _InterlockedAnd_HLEAcquire (dlouhý nestálý \*, Long)|
|[_InterlockedAnd_HLERelease](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin. h|Long _InterlockedAnd_HLERelease (dlouhý nestálý \*, Long)|
|[_InterlockedAnd_np](interlockedand-intrinsic-functions.md)||intrin. h|Long _InterlockedAnd_np (dlouhý \*, Long)|
|[_InterlockedAnd16](interlockedand-intrinsic-functions.md)||intrin. h|krátký _InterlockedAnd16 (krátký volatile \*, short)|
|[_InterlockedAnd16_np](interlockedand-intrinsic-functions.md)||intrin. h|krátký _InterlockedAnd16_np (krátký \*, short)|
...
|[_interlockedbittestandreset](interlockedbittestandreset-intrinsic-functions.md)||intrin. h|Nepodepsaný znak _interlockedbittestandreset (dlouhý \*, Long)|
|[_interlockedbittestandreset_HLEAcquire](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin. h|Nepodepsaný znak _interlockedbittestandreset_HLEAcquire (dlouhý \*, Long)|
|[_interlockedbittestandreset_HLERelease](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin. h|Nepodepsaný znak _interlockedbittestandreset_HLERelease (dlouhý \*, Long)|
...
|[_interlockedbittestandset](interlockedbittestandset-intrinsic-functions.md)||intrin. h|Nepodepsaný znak _interlockedbittestandset (dlouhý \*, Long)|
|[_interlockedbittestandset_HLEAcquire](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin. h|Nepodepsaný znak _interlockedbittestandset_HLEAcquire (dlouhý \*, Long)|
|[_interlockedbittestandset_HLERelease](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin. h|Nepodepsaný znak _interlockedbittestandset_HLERelease (dlouhý \*, Long)|
...
|[_InterlockedCompareExchange](interlockedcompareexchange-intrinsic-functions.md)||intrin. h|Long _InterlockedCompareExchange (dlouhý nestálý \*, dlouhý, dlouhý)|
|[_InterlockedCompareExchange_HLEAcquire](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin. h|Long _InterlockedCompareExchange_HLEAcquire (dlouhý nestálý \*, dlouhý, dlouhý)|
|[_InterlockedCompareExchange_HLERelease](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin. h|Long _InterlockedCompareExchange_HLERelease (dlouhý nestálý \*, dlouhý, dlouhý)|
|[_InterlockedCompareExchange_np](interlockedcompareexchange-intrinsic-functions.md)||intrin. h|Long _InterlockedCompareExchange_np (dlouhý \*Long)|
...
|[_InterlockedCompareExchange16](interlockedcompareexchange-intrinsic-functions.md)||intrin. h|krátké _InterlockedCompareExchange16 (krátká nestálá \*, krátká, krátká)|
|[_InterlockedCompareExchange16_np](interlockedcompareexchange-intrinsic-functions.md)||intrin. h|krátké _InterlockedCompareExchange16_np (krátká nestálá \*, krátká, krátká)|
...
|[_InterlockedDecrement](interlockeddecrement-intrinsic-functions.md)||intrin. h|Long _InterlockedDecrement (dlouhý stálý \*)|
|[_InterlockedDecrement16](interlockeddecrement-intrinsic-functions.md)||intrin. h|krátký _InterlockedDecrement16 (krátký volatile \*)|
...
|[_InterlockedExchange](interlockedexchange-intrinsic-functions.md)||intrin. h|Long _InterlockedExchange (dlouhý nestálý \*, Long)|
|[_InterlockedExchange_HLEAcquire](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin. h|Long _InterlockedExchange_HLEAcquire (dlouhý nestálý \*, Long)|
|[_InterlockedExchange_HLERelease](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin. h|Long _InterlockedExchange_HLERelease (dlouhý nestálý \*, Long)|
|[_InterlockedExchange16](interlockedexchange-intrinsic-functions.md)||intrin. h|krátký _InterlockedExchange16 (krátký volatile \*, short)|
...
|[_InterlockedExchangeAdd](interlockedexchangeadd-intrinsic-functions.md)||intrin. h|Long _InterlockedExchangeAdd (dlouhý nestálý \*, Long)|
|[_InterlockedExchangeAdd_HLEAcquire](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin. h|Long _InterlockedExchangeAdd_HLEAcquire (dlouhý nestálý \*, Long)|
|[_InterlockedExchangeAdd_HLERelease](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin. h|Long _InterlockedExchangeAdd_HLERelease (dlouhý nestálý \*, Long)|
|[_InterlockedExchangeAdd16](interlockedexchangeadd-intrinsic-functions.md)||intrin. h|krátký _InterlockedExchangeAdd16 (krátký volatile \*, short)|
...
|[_InterlockedIncrement](interlockedincrement-intrinsic-functions.md)||intrin. h|Long _InterlockedIncrement (dlouhý stálý \*)|
|[_InterlockedIncrement16](interlockedincrement-intrinsic-functions.md)||intrin. h|krátký _InterlockedIncrement16 (krátký volatile \*)|
...
|[_InterlockedOr](interlockedor-intrinsic-functions.md)||intrin. h|Long _InterlockedOr (dlouhý nestálý \*, Long)|
|[_InterlockedOr_HLEAcquire](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin. h|Long _InterlockedOr_HLEAcquire (dlouhý nestálý \*, Long)|
|[_InterlockedOr_HLERelease](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin. h|Long _InterlockedOr_HLERelease (dlouhý nestálý \*, Long)|
|[_InterlockedOr_np](interlockedor-intrinsic-functions.md)||intrin. h|Long _InterlockedOr_np (dlouhý \*, Long)|
|[_InterlockedOr16](interlockedor-intrinsic-functions.md)||intrin. h|krátký _InterlockedOr16 (krátký volatile \*, short)|
|[_InterlockedOr16_np](interlockedor-intrinsic-functions.md)||intrin. h|krátký _InterlockedOr16_np (krátký \*, short)|
...
|[_InterlockedXor](interlockedxor-intrinsic-functions.md)||intrin. h|Long _InterlockedXor (dlouhý nestálý \*, Long)|
|[_InterlockedXor_HLEAcquire](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin. h|Long _InterlockedXor_HLEAcquire (dlouhý nestálý \*, Long)|
|[_InterlockedXor_HLERelease](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin. h|Long _InterlockedXor_HLERelease (dlouhý nestálý \*, Long)|
|[_InterlockedXor_np](interlockedxor-intrinsic-functions.md)||intrin. h|Long _InterlockedXor_np (dlouhý \*, Long)|
|[_InterlockedXor16](interlockedxor-intrinsic-functions.md)||intrin. h|krátký _InterlockedXor16 (krátký volatile \*, short)|
|[_InterlockedXor16_np](interlockedxor-intrinsic-functions.md)||intrin. h|krátký _InterlockedXor16_np (krátký \*, short)|
...
|[__inword](inword.md)||intrin. h|krátký __inword bez znaménka (Short unsigned)|
|[__inwordstring](inwordstring.md)||intrin. h|void __inwordstring (nepodepsaný krátkým, nepodepsaným krátkým \*, unsigned long)|
...
|_load_be_u16<br /><br /> [_loadbe_i16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i16&expand=3071)|MOVBE|immintrin. h|krátké _load_be_u16 bez znaménka (void const\*);<br /><br /> short _loadbe_i16 (void const\*); 1|
|_load_be_u32<br /><br /> [_loadbe_i32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i32&expand=3072)|MOVBE|immintrin. h|unsigned int _load_be_u32 (void const\*);<br /><br /> int _loadbe_i32 (void const\*); 1|
|_load_be_u64<br /><br /> [_loadbe_i64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i64&expand=3073)|MOVBE|immintrin. h|Nepodepsaný __int64 _load_be_u64 (void const\*);<br /><br /> \__int64 _loadbe_i64 (void const\*); 1|
|__lwpins32|LWP [1]|ammintrin. h|Nepodepsaný znak typu __lwpins32 (unsigned int, unsigned int, unsigned int)|
|__lwpins64|LWP [1]|ammintrin. h|unsigned char __lwpins64 (bez znaménka \__int64, unsigned int, unsigned int)|
|__lwpval32|LWP [1]|ammintrin. h|void __lwpval32 (unsigned int, unsigned int, unsigned int)|
|__lwpval64|LWP [1]|ammintrin. h|void __lwpval64 (nepodepsaný \__int64, unsigned int, unsigned int)|
|[__lzcnt](lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin. h|Nepodepsaný int __lzcnt (unsigned int)|
|[_lzcnt_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_lzcnt_u32)|BMI|ammintrin. h, immintrin. h|Nepodepsaný int _lzcnt_u32 (unsigned int)|
|[_lzcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_lzcnt_u64)|BMI|ammintrin. h, immintrin. h|Nepodepsaný __int64 _lzcnt_u64 (bez znaménka \__int64)|
|[__lzcnt16](lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin. h|krátký __lzcnt16 bez znaménka (Short unsigned)|
|[__lzcnt64](lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin. h|Nepodepsaný __int64 \__lzcnt64 (nepodepsaný \__int64)|
...
|[_mm_addsub_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_addsub_pd)|INSTRUKČNÍ SSE3|intrin. h|__m128d _mm_addsub_pd (\__m128d, \__m128d)|
|[_mm_addsub_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_addsub_ps)|INSTRUKČNÍ SSE3|intrin. h|__m128 _mm_addsub_ps (\__m128, \__m128)|
...
|[_mm_blend_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_blend_epi16)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_blend_epi16 (\__m128i, \__m128i, const int)|
...
|[_mm_blend_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_blend_pd)|POVOLÍ sadu SSE41|intrin. h|__m128d _mm_blend_pd (\__m128d, \__m128d, const int)|
|[_mm_blend_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_blend_ps)|POVOLÍ sadu SSE41|intrin. h|__m128 _mm_blend_ps (\__m128, \__m128, const int)|
|[_mm_blendv_epi8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_blendv_epi8)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_blendv_epi8 (\__m128i, \__m128i, \__m128i)|
|[_mm_blendv_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_blendv_pd)|POVOLÍ sadu SSE41|intrin. h|__m128d _mm_blendv_pd (\__m128d, \__m128d, \__m128d)|
|[_mm_blendv_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_blendv_ps)|POVOLÍ sadu SSE41|intrin. h|__m128 _mm_blendv_ps (\__m128, \__m128, \__m128)|
|[_mm_broadcast_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_broadcast_ss)|AVX [2]|immintrin. h|_mm_broadcast_ss __m128 (float const \*)|
...
|[_mm_cmpeq_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpeq_epi64)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_cmpeq_epi64 (\__m128i, \__m128i)|
...
|[_mm_cmpestra](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpestra)|POVOLÍ sadu SSE42|intrin. h|int _mm_cmpestra (\__m128i, int, \__m128i, int, const int)|
|[_mm_cmpestrc](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpestrc)|POVOLÍ sadu SSE42|intrin. h|int _mm_cmpestrc (\__m128i, int, \__m128i, int, const int)|
|[_mm_cmpestri](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpestri)|POVOLÍ sadu SSE42|intrin. h|int _mm_cmpestri (\__m128i, int, \__m128i, int, const int)|
|[_mm_cmpestrm](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpestrm)|POVOLÍ sadu SSE42|intrin. h|__m128i _mm_cmpestrm (\__m128i, int, \__m128i, int, const int)|
|[_mm_cmpestro](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpestro)|POVOLÍ sadu SSE42|intrin. h|int _mm_cmpestro (\__m128i, int, \__m128i, int, const int)|
|[_mm_cmpestrs](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpestrs)|POVOLÍ sadu SSE42|intrin. h|int _mm_cmpestrs (\__m128i, int, \__m128i, int, const int)|
|[_mm_cmpestrz](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpestrz)|POVOLÍ sadu SSE42|intrin. h|int _mm_cmpestrz (\__m128i, int, \__m128i, int, const int)|
...
|[_mm_cmpgt_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpgt_epi64)|POVOLÍ sadu SSE42|intrin. h|__m128i _mm_cmpgt_epi64 (\__m128i, \__m128i)|
...
|[_mm_cmpistra](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpistra)|POVOLÍ sadu SSE42|intrin. h|int _mm_cmpistra (\__m128i, \__m128i, const int)|
|[_mm_cmpistrc](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpistrc)|POVOLÍ sadu SSE42|intrin. h|int _mm_cmpistrc (\__m128i, \__m128i, const int)|
|[_mm_cmpistri](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpistri)|POVOLÍ sadu SSE42|intrin. h|int _mm_cmpistri (\__m128i, \__m128i, const int)|
|[_mm_cmpistrm](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpistrm)|POVOLÍ sadu SSE42|intrin. h|__m128i _mm_cmpistrm (\__m128i, \__m128i, const int)|
|[_mm_cmpistro](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpistro)|POVOLÍ sadu SSE42|intrin. h|int _mm_cmpistro (\__m128i, \__m128i, const int)|
|[_mm_cmpistrs](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpistrs)|POVOLÍ sadu SSE42|intrin. h|int _mm_cmpistrs (\__m128i, \__m128i, const int)|
|[_mm_cmpistrz](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpistrz)|POVOLÍ sadu SSE42|intrin. h|int _mm_cmpistrz (\__m128i, \__m128i, const int)|
...
|[_mm_crc32_u16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u16)|POVOLÍ sadu SSE42|intrin. h|unsigned int _mm_crc32_u16 (unsigned int, unsigned short)|
|[_mm_crc32_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u32)|POVOLÍ sadu SSE42|intrin. h|unsigned int _mm_crc32_u32 (unsigned int, unsigned int)|
|[_mm_crc32_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u64)|POVOLÍ sadu SSE42|intrin. h|Nepodepsaný __int64 _mm_crc32_u64 (nepodepsaný \__int64, nepodepsaný \__int64)|
|[_mm_crc32_u8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u8)|POVOLÍ sadu SSE42|intrin. h|unsigned int _mm_crc32_u8 (unsigned int, unsigned char)|
...
|[_mm_cvtepi16_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtepi16_epi32)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_cvtepi16_epi32 (\__m128i)|
|[_mm_cvtepi16_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtepi16_epi64)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_cvtepi16_epi64 (\__m128i)|
|[_mm_cvtepi32_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtepi32_epi64)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_cvtepi32_epi64 (\__m128i)|
...
|[_mm_cvtepi8_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtepi8_epi16)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_cvtepi8_epi16 (\__m128i)|
|[_mm_cvtepi8_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtepi8_epi32)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_cvtepi8_epi32 (\__m128i)|
|[_mm_cvtepi8_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtepi8_epi64)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_cvtepi8_epi64 (\__m128i)|
|[_mm_cvtepu16_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtepu16_epi32)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_cvtepu16_epi32 (\__m128i)|
|[_mm_cvtepu16_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtepu16_epi64)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_cvtepu16_epi64 (\__m128i)|
|[_mm_cvtepu32_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtepu32_epi64)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_cvtepu32_epi64 (\__m128i)|
|[_mm_cvtepu8_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtepu8_epi16)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_cvtepu8_epi16 (\__m128i)|
|[_mm_cvtepu8_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtepu8_epi32)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_cvtepu8_epi32 (\__m128i)|
|[_mm_cvtepu8_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtepu8_epi64)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_cvtepu8_epi64 (\__m128i)|
...
|[_mm_cvtsd_f64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtsd_f64)|SSSE3|intrin. h|Dvojitá _mm_cvtsd_f64 (\__m128d)|
...
|[_mm_dp_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_dp_pd)|POVOLÍ sadu SSE41|intrin. h|__m128d _mm_dp_pd (\__m128d, \__m128d, const int)|
|[_mm_dp_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_dp_ps)|POVOLÍ sadu SSE41|intrin. h|__m128 _mm_dp_ps (\__m128, \__m128, const int)|
...
|[_mm_extract_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_extract_epi32)|POVOLÍ sadu SSE41|intrin. h|int _mm_extract_epi32 (\__m128i, const int)|
|[_mm_extract_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_extract_epi64)|POVOLÍ sadu SSE41|intrin. h|__int64 _mm_extract_epi64 (\__m128i, const int)|
|[_mm_extract_epi8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_extract_epi8)|POVOLÍ sadu SSE41|intrin. h|int _mm_extract_epi8 (\__m128i, const int)|
|[_mm_extract_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_extract_ps)|POVOLÍ sadu SSE41|intrin. h|int _mm_extract_ps (\__m128, const int)|
...
|[_mm_hadd_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_hadd_pd)|INSTRUKČNÍ SSE3|intrin. h|__m128d _mm_hadd_pd (\__m128d, \__m128d)|
|[_mm_hadd_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_hadd_ps)|INSTRUKČNÍ SSE3|intrin. h|__m128 _mm_hadd_ps (\__m128, \__m128)|
...
|[_mm_hsub_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_hsub_pd)|INSTRUKČNÍ SSE3|intrin. h|__m128d _mm_hsub_pd (\__m128d, \__m128d)|
|[_mm_hsub_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_hsub_ps)|INSTRUKČNÍ SSE3|intrin. h|__m128 _mm_hsub_ps (\__m128, \__m128)|
...
|[_mm_insert_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_insert_epi32)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_insert_epi32 (\__m128i, int, const int)|
|[_mm_insert_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_insert_epi64)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_insert_epi64 (\__m128i, \__int64, const int)|
|[_mm_insert_epi8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_insert_epi8)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_insert_epi8 (\__m128i, int, const int)|
|[_mm_insert_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_insert_ps)|POVOLÍ sadu SSE41|intrin. h|__m128 _mm_insert_ps (\__m128, \__m128, const int)|
...
|[_mm_lddqu_si128](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_lddqu_si128)|INSTRUKČNÍ SSE3|intrin. h|__m128i _mm_lddqu_si128 (\__m128i const\*)|
...
|[_mm_loaddup_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_loaddup_pd)|INSTRUKČNÍ SSE3|intrin. h|_mm_loaddup_pd __m128d (Double const\*)|
...
|[_mm_maskload_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskload_pd)|AVX [2]|immintrin. h|_mm_maskload_pd __m128d (Double const \*, \__m128i)|
|[_mm_maskload_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskload_ps)|AVX [2]|immintrin. h|_mm_maskload_ps __m128 (float const \*, \__m128i)|
...
|[_mm_maskstore_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskstore_pd)|AVX [2]|immintrin. h|void _mm_maskstore_pd (dvojitá \*, \__m128i, \__m128d)|
...
|[_mm_max_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_max_epi32)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_max_epi32 (\__m128i, \__m128i)|
|[_mm_max_epi8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_max_epi8)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_max_epi8 (\__m128i, \__m128i)|
|[_mm_max_epu16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_max_epu16)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_max_epu16 (\__m128i, \__m128i)|
|[_mm_max_epu32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_max_epu32)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_max_epu32 (\__m128i, \__m128i)|
...
|[_mm_min_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_min_epi32)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_min_epi32 (\__m128i, \__m128i)|
|[_mm_min_epi8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_min_epi8)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_min_epi8 (\__m128i, \__m128i)|
|[_mm_min_epu16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_min_epu16)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_min_epu16 (\__m128i, \__m128i)|
|[_mm_min_epu32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_min_epu32)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_min_epu32 (\__m128i, \__m128i)|
...
|[_mm_minpos_epu16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_minpos_epu16)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_minpos_epu16 (\__m128i)|
|[_mm_monitor](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_monitor)|INSTRUKČNÍ SSE3|intrin. h|void _mm_monitor (void const\*, unsigned int, unsigned int)|
...
|[_mm_movedup_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_movedup_pd)|INSTRUKČNÍ SSE3|intrin. h|__m128d _mm_movedup_pd (\__m128d)|
|[_mm_movehdup_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_movehdup_ps)|INSTRUKČNÍ SSE3|intrin. h|__m128 _mm_movehdup_ps (\__m128)|
...
|[_mm_moveldup_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_moveldup_ps)|INSTRUKČNÍ SSE3|intrin. h|__m128 _mm_moveldup_ps (\__m128)|
...
|[_mm_mpsadbw_epu8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mpsadbw_epu8)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_mpsadbw_epu8 (\__m128i, \__m128i, const int)|
...
|[_mm_mul_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mul_epi32)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_mul_epi32 (\__m128i, \__m128i)|
...
|[_mm_mullo_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mullo_epi32)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_mullo_epi32 (\__m128i, \__m128i)|
|[_mm_mwait](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mwait)|INSTRUKČNÍ SSE3|intrin. h|void _mm_mwait (unsigned int, unsigned int)|
...
|[_mm_packus_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_packus_epi32)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_packus_epi32 (\__m128i, \__m128i)|
...
|[_mm_popcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_popcnt_u64)|POPCNT|intrin. h|_mm_popcnt_u64 __int64 (bez znaménka \__int64)|
...
|[_mm_round_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_round_pd)|POVOLÍ sadu SSE41|intrin. h|__m128d _mm_round_pd (\__m128d, const int)|
|[_mm_round_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_round_ps)|POVOLÍ sadu SSE41|intrin. h|__m128 _mm_round_ps (\__m128, const int)|
|[_mm_round_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_round_sd)|POVOLÍ sadu SSE41|intrin. h|__m128d _mm_round_sd (\__m128d, \__m128d, const int)|
|[_mm_round_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_round_ss)|POVOLÍ sadu SSE41|intrin. h|__m128 _mm_round_ss (\__m128, \__m128, const int)|
...
|[_mm_set_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_set_epi16)|SSE2|intrin. h|__m128i _mm_set_epi16 (krátká, krátká, krátká, krátká, krátká, krátká, krátká, krátká)|
...
|[_mm_set1_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_set1_epi16)|SSE2|intrin. h|__m128i _mm_set1_epi16 (krátký)|
...
|[_mm_setr_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_setr_epi16)|SSE2|intrin. h|__m128i _mm_setr_epi16 (krátká, krátká, krátká, krátká, krátká, krátká, krátká, krátká)|
...
|[_mm_store_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_store_pd)|SSE2|intrin. h|void _mm_store_pd (dvojitá\*, \__m128d)|
...
|[_mm_store_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_store_sd)|SSE2|intrin. h|void _mm_store_sd (dvojitá\*, \__m128d)|
...
|[_mm_store1_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_store1_pd)|SSE2|intrin. h|void _mm_store1_pd (dvojitá\*, \__m128d)|
|[_mm_storeh_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storeh_pd)|SSE2|intrin. h|void _mm_storeh_pd (dvojitá\*, \__m128d)|
...
|[_mm_storel_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storel_pd)|SSE2|intrin. h|void _mm_storel_pd (dvojitá\*, \__m128d)|
...
|[_mm_storer_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storer_pd)|SSE2|intrin. h|void _mm_storer_pd (dvojitá\*, \__m128d)|
...
|[_mm_storeu_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storeu_pd)|SSE2|intrin. h|void _mm_storeu_pd (dvojitá\*, \__m128d)|
...
|[_mm_stream_load_si128](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_stream_load_si128)|POVOLÍ sadu SSE41|intrin. h|__m128i _mm_stream_load_si128 (\__m128i\*)|
|[_mm_stream_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_stream_pd)|SSE2|intrin. h|void _mm_stream_pd (dvojitá\*, \__m128d)|
...
|[_mm_stream_sd](mm-stream-sd.md)|SSE4a|intrin. h|void _mm_stream_sd (dvojitá\*, \__m128d)|
...
|[_mm_testc_si128](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_testc_si128)|POVOLÍ sadu SSE41|intrin. h|int _mm_testc_si128 (\__m128i, \__m128i)|
...
|[_mm_testnzc_si128](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_testnzc_si128)|POVOLÍ sadu SSE41|intrin. h|int _mm_testnzc_si128 (\__m128i, \__m128i)|
...
|[_mm_testz_si128](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_testz_si128)|POVOLÍ sadu SSE41|intrin. h|int _mm_testz_si128 (\__m128i, \__m128i)|
...
|[_mm256_broadcast_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_broadcast_sd)|AVX [2]|immintrin. h|_mm256_broadcast_sd __m256d (Double const \*)|
|[_mm256_broadcast_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_broadcast_ss)|AVX [2]|immintrin. h|_mm256_broadcast_ss __m256 (float const \*)|
...
|[_mm256_load_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_load_pd)|AVX [2]|immintrin. h|_mm256_load_pd __m256d (Double const \*)|
|[_mm256_load_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_load_ps)|AVX [2]|immintrin. h|_mm256_load_ps __m256 (float const \*)|
...
|[_mm256_loadu_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_loadu_pd)|AVX [2]|immintrin. h|_mm256_loadu_pd __m256d (Double const \*)|
|[_mm256_loadu_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_loadu_ps)|AVX [2]|immintrin. h|_mm256_loadu_ps __m256 (float const \*)|
...
|[_mm256_maskload_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskload_pd)|AVX [2]|immintrin. h|_mm256_maskload_pd __m256d (Double const \*, \__m256i)|
|[_mm256_maskload_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskload_ps)|AVX [2]|immintrin. h|_mm256_maskload_ps __m256 (float const \*, \__m256i)|
...
|[_mm256_maskstore_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskstore_pd)|AVX [2]|immintrin. h|void _mm256_maskstore_pd (dvojitá \*, \__m256i, \__m256d)|
...
|[_mm256_set_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_set_epi16)|AVX [2]|immintrin. h|(__m256i _mm256_set_epi16 (krátký|
...
|[_mm256_set_epi64x](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_set_epi64x)|AVX [2]|immintrin. h|__m256i _mm256_set_epi64x (dlouhé dlouhé, dlouhé dlouhé, dlouhé)|
...
|[_mm256_set_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_set_pd)|AVX [2]|immintrin. h|__m256d _mm256_set_pd (dvojitá, dvojitá, dvojitá, dvojitá)|
...
|[_mm256_set1_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_set1_epi16)|AVX [2]|immintrin. h|__m256i _mm256_set1_epi16 (krátký)|
...
|[_mm256_setr_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_setr_epi16)|AVX [2]|immintrin. h|(__m256i _mm256_setr_epi16 (krátký|
...
|[_mm256_setr_epi64x](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_setr_epi64x)|AVX [2]|immintrin. h|__m256i _mm256_setr_epi64x (dlouhé dlouhé, dlouhé dlouhé, dlouhé)|
...
|[_mm256_setr_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_setr_pd)|AVX [2]|immintrin. h|__m256d _mm256_setr_pd (dvojitá, dvojitá, dvojitá, dvojitá)|
...
|[_mm256_store_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_store_pd)|AVX [2]|immintrin. h|void _mm256_store_pd (dvojitá \*, \__m256d)|
...
|[_mm256_storeu_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_storeu_pd)|AVX [2]|immintrin. h|void _mm256_storeu_pd (dvojitá \*, \__m256d)|
...
|[__movsq](movsq.md)||intrin. h|VOID __movsq (nepodepsaný \__int64 \*, unsigned \__int64 const \*, size_t)|
|[__movsw](movsw.md)||intrin. h|VOID __movsw (krátký \*bez znaménka, krátký typ const \*, size_t)|
...
|_mulx_u64|BMI [2]|immintrin. h|Nepodepsaný __int64 _mulx_u64 (bez znaménka \__int64, nepodepsané \__int64, nepodepsaný \__int64\*)|
...
|[__outbytestring](outbytestring.md)||intrin. h|void __outbytestring (nepodepsaný krátkým, nepodepsaným znakem \*, unsigned long)|
...
|[__outwordstring](outwordstring.md)||intrin. h|void __outwordstring (nepodepsaný krátkým, nepodepsaným krátkým \*, unsigned long)|
...
|[_pdep_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pdep_u64)|BMI [2]|immintrin. h|Nepodepsaný __int64 _pdep_u64 (nepodepsaný \__int64, nepodepsaný \__int64)|
...
|[_pext_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pext_u64)|BMI [2]|immintrin. h|Nepodepsaný __int64 _pext_u64 (nepodepsaný \__int64, nepodepsaný \__int64)|
|[__popcnt](popcnt16-popcnt-popcnt64.md)|POPCNT|intrin. h|Nepodepsaný int __popcnt (unsigned int)|
|[__popcnt16](popcnt16-popcnt-popcnt64.md)|POPCNT|intrin. h|krátký __popcnt16 bez znaménka (Short unsigned)|
|[__popcnt64](popcnt16-popcnt-popcnt64.md)|POPCNT|intrin. h|Nepodepsaný __int64 \__popcnt64 (nepodepsaný \__int64)|
|[_rdrand16_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand16_step)|RDRAND [2]|immintrin. h|int _rdrand16_step (krátký \*unsigned)|
...
|[_rdrand64_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand64_step)|RDRAND [2]|immintrin. h|int _rdrand64_step (nepodepsaný \__int64 \*)|
|[_rdseed16_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdseed16_step)|RDSEED [2]|immintrin. h|int _rdseed16_step (krátký \*unsigned)|
...
|[_rdseed64_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdseed64_step)|RDSEED [2]|immintrin. h|int _rdseed64_step (nepodepsaný \__int64 \*)|
|[__rdtsc](rdtsc.md)||intrin. h|Nepodepsaný __int64 \__rdtsc (void)|
|[__rdtscp](rdtscp.md)|RDTSCP|intrin. h|Nepodepsaný __int64 \__rdtscp (unsigned int\*)|
|[_ReadBarrier](readbarrier.md)||intrin. h|void _ReadBarrier (void)|
|[__readcr0](readcr0.md)||intrin. h|Nepodepsaný __int64 \__readcr0 (void)|
|[__readcr2](readcr2.md)||intrin. h|Nepodepsaný __int64 \__readcr2 (void)|
|[__readcr3](readcr3.md)||intrin. h|Nepodepsaný __int64 \__readcr3 (void)|
|[__readcr4](readcr4.md)||intrin. h|Nepodepsaný __int64 \__readcr4 (void)|
|[__readcr8](readcr8.md)||intrin. h|Nepodepsaný __int64 \__readcr8 (void)|
|[__readdr](readdr.md)||intrin. h|Nepodepsaný __int64 \__readdr (bez znaménka)|
|[__readeflags](readeflags.md)||intrin. h|Nepodepsaný __int64 \__readeflags (void)|
...
|[_readfsbase_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_readfsbase_u64)|FSGSBASE [2]|immintrin. h|Nepodepsaný __int64 _readfsbase_u64 (void)|
...
|[_readgsbase_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_readgsbase_u64)|FSGSBASE [2]|immintrin. h|Nepodepsaný __int64 _readgsbase_u64 (void)|
|[__readgsbyte](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin. h|Nepodepsaný znak __readgsbyte (unsigned long)|
|[__readgsdword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin. h|Long __readgsdword bez znaménka (unsigned long)|
|[__readgsqword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin. h|Nepodepsaný __int64 \__readgsqword (bez znaménka Long)|
|[__readgsword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin. h|krátký __readgsword bez znaménka (unsigned long)|
|[__readmsr](readmsr.md)||intrin. h|Nepodepsaný __int64 \__readmsr (bez znaménka Long)|
|[__readpmc](readpmc.md)||intrin. h|Nepodepsaný __int64 \__readpmc (bez znaménka Long)|
...
|_rorx_u64|BMI [2]|immintrin. h|Nepodepsaný __int64 _rorx_u64 (unsigned \__int64, const unsigned int)|
|[_rotl16](rotl8-rotl16.md)||intrin. h|krátký _rotl16 bez znaménka (Short, krátký znak bez znaménka)|
|[_rotl8](rotl8-rotl16.md)||intrin. h|Nepodepsaný znak _rotl8 (nepodepsaný znak, znak bez znaménka)|
|[_rotr16](rotr8-rotr16.md)||intrin. h|krátký _rotr16 bez znaménka (Short, krátký znak bez znaménka)|
|[_rotr8](rotr8-rotr16.md)||intrin. h|Nepodepsaný znak _rotr8 (nepodepsaný znak, znak bez znaménka)|
...
|[__segmentlimit](segmentlimit.md)||intrin. h|Long __segmentlimit bez znaménka (unsigned long)|
|_sgdt||intrin. h|void _sgdt (void\*)|
|[__shiftleft128](shiftleft128.md)||intrin. h|Nepodepsaný __int64 \__shiftleft128 (nepodepsaný \__int64, nepodepsaný \__int64, nepodepsaný znak)|
|[__shiftright128](shiftright128.md)||intrin. h|Nepodepsaný __int64 \__shiftright128 (nepodepsaný \__int64, nepodepsaný \__int64, nepodepsaný znak)|
|_shlx_u32|BMI [2]|immintrin. h|unsigned int _shlx_u32 (unsigned int, unsigned int)|
|_shlx_u64|BMI [2]|immintrin. h|Nepodepsaný __int64 _shlx_u64 (bez znaménka \__int64, unsigned int)|
|_shrx_u32|BMI [2]|immintrin. h|unsigned int _shrx_u32 (unsigned int, unsigned int)|
|_shrx_u64|BMI [2]|immintrin. h|Nepodepsaný __int64 _shrx_u64 (bez znaménka \__int64, unsigned int)|
|[__sidt](sidt.md)||intrin. h|void __sidt (void\*)|
|__slwpcb|LWP [1]|ammintrin. h|void \*__slwpcb (void)|
|_stac|SMAP|intrin. h|void _stac (void)|
|_store_be_u16<br /><br /> [_storebe_i16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i16&expand=5141)|MOVBE|immintrin. h|void _store_be_u16 (void \*, unsigned short);<br /><br /> void _storebe_i16 (void \*, short); 1|
|_store_be_u32<br /><br /> [_storebe_i32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i32&expand=5142)|MOVBE|immintrin. h|void _store_be_u32 (void \*, unsigned int);<br /><br /> void _storebe_i32 (void \*, int); 1|
|_store_be_u64<br /><br /> [_storebe_i64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i64&expand=5143)|MOVBE|immintrin. h|void _store_be_u64 (void \*, unsigned \__int64);<br /><br /> void _storebe_i64 (void \*, \__int64); 1|
...
|[__stosb](stosb.md)||intrin. h|void __stosb (nepodepsaný znak \*, unsigned char, size_t)|
|[__stosd](stosd.md)||intrin. h|void __stosd (unsigned long \*, unsigned long, size_t)|
|[__stosq](stosq.md)||intrin. h|void __stosq (nepodepsaný \__int64 \*, nepodepsaný \__int64, size_t)|
|[__stosw](stosw.md)||intrin. h|void __stosw (nepodepsaný krátký \*, unsigned short, size_t)|
|_subborrow_u16||intrin. h|Nepodepsaný znak _subborrow_u16 (nepodepsaný znak, unsigned short, ununsigned Short, unsigned short \*)|
|[_subborrow_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u32)||intrin. h|Nepodepsaný znak _subborrow_u32 (unsigned char, unsigned int, unsigned int, unsigned int \*)|
|[_subborrow_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u64)||intrin. h|Nepodepsaný znak _subborrow_u64 (bez znaménka char, unsigned \__int64, nepodepsaný \__int64, nepodepsaný \__int64 \*)|
|_subborrow_u8||intrin. h|unsigned char _subborrow_u8 (bez znaménka char, unsigned char, unsigned char, unsigned char \*)|
...
|_t1mskc_u32|ABM [1]|ammintrin. h|Nepodepsaný int _t1mskc_u32 (unsigned int)|
|_t1mskc_u64|ABM [1]|ammintrin. h|Nepodepsaný __int64 _t1mskc_u64 (bez znaménka \__int64)|
|[_tzcnt_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_tzcnt_u32)|BMI|ammintrin. h, immintrin. h|Nepodepsaný int _tzcnt_u32 (unsigned int)|
|[_tzcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_tzcnt_u64)|BMI|ammintrin. h, immintrin. h|Nepodepsaný __int64 _tzcnt_u64 (bez znaménka \__int64)|
|_tzmsk_u32|ABM [1]|ammintrin. h|Nepodepsaný int _tzmsk_u32 (unsigned int)|
|_tzmsk_u64|ABM [1]|ammintrin. h|Nepodepsaný __int64 _tzmsk_u64 (bez znaménka \__int64)|
|[__ud2](ud2.md)||intrin. h|void __ud2 (void)|
|[_div128](udiv128.md)||intrin. h|Nepodepsaný __int64 _udiv128 (bez znaménka \__int64, nepodepsané \__int64, nepodepsaný \__int64, nepodepsaný \__int64 \*)|
|[_div64](udiv64.md)||intrin. h|unsigned int \_udiv64 (bez znaménka \__int64, unsigned int, unsigned int *)|
|[__ull_rshift](ull-rshift.md)||intrin. h|unsigned __int64 [Pascal/CDECL] \__ull_rshift (unsigned \__int64, int)|
|[_umul128](umul128.md)||intrin. h|Nepodepsaný __int64 _umul128 (bez znaménka \__int64, nepodepsané \__int64, nepodepsaný \__int64 \*)|
|[__umulh](umulh.md)||intrin. h|Nepodepsaný __int64 \__umulh (nepodepsaný \__int64, nepodepsaný \__int64)|
|[__vmx_off](vmx-off.md)||intrin. h|void __vmx_off (void)|
|[__vmx_on](vmx-on.md)||intrin. h|unsigned char __vmx_on (bez znaménka \__int64\*)|
|[__vmx_vmclear](vmx-vmclear.md)||intrin. h|unsigned char __vmx_vmclear (bez znaménka \__int64\*)|
|[__vmx_vmlaunch](vmx-vmlaunch.md)||intrin. h|Nepodepsaný znak __vmx_vmlaunch (void)|
|[__vmx_vmptrld](vmx-vmptrld.md)||intrin. h|unsigned char __vmx_vmptrld (bez znaménka \__int64\*)|
|[__vmx_vmptrst](vmx-vmptrst.md)||intrin. h|void __vmx_vmptrst (nepodepsaný \__int64 \*)|
|[__vmx_vmread](vmx-vmread.md)||intrin. h|unsigned char __vmx_vmread (size_t, size_t\*)|
|[__vmx_vmresume](vmx-vmresume.md)||intrin. h|Nepodepsaný znak __vmx_vmresume (void)|
|[__vmx_vmwrite](vmx-vmwrite.md)||intrin. h|Nepodepsaný znak __vmx_vmwrite (size_t, size_t)|
|[__wbinvd](wbinvd.md)||intrin. h|void __wbinvd (void)|
|[_WriteBarrier](writebarrier.md)||intrin. h|void _WriteBarrier (void)|
|[__writecr0](writecr0.md)||intrin. h|void __writecr0 (nepodepsaný \__int64)|
|[__writecr3](writecr3.md)||intrin. h|void __writecr3 (nepodepsaný \__int64)|
|[__writecr4](writecr4.md)||intrin. h|void __writecr4 (nepodepsaný \__int64)|
|[__writecr8](writecr8.md)||intrin. h|void __writecr8 (nepodepsaný \__int64)|
|[__writedr](writedr.md)||intrin. h|void __writedr (bez znaménka, nepodepsaný \__int64)|
|[__writeeflags](writeeflags.md)||intrin. h|void __writeeflags (nepodepsaný \__int64)|
...
|[_writefsbase_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writefsbase_u64)|FSGSBASE [2]|immintrin. h|void _writefsbase_u64 (nepodepsaný \__int64)|
...
|[_writegsbase_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writegsbase_u64)|FSGSBASE [2]|immintrin. h|void _writegsbase_u64 (nepodepsaný \__int64)|
...
|[__writegsdword](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin. h|void __writegsdword (bez znaménka Long, bez znaménka)|
...
|[_xbegin](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xbegin)|RTM [2]|immintrin. h|Nepodepsaná _xbegin (void)|
|[_xend](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xend)|RTM [2]|immintrin. h|void _xend (void)|
|[_xgetbv](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xgetbv)|XSAVE [2]|immintrin. h|Nepodepsaný __int64 _xgetbv (unsigned int)|
...
|[_xtest](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xtest)|XTEST [2]|immintrin. h|Nepodepsaný znak _xtest (void)|

## <a name="see-also"></a>Viz také:

[Vnitřní objekty kompilátoru](compiler-intrinsics.md)\
[Vnitřní objekty ARM](arm-intrinsics.md)\
[Vnitřní\ ARM64](arm64-intrinsics.md)
[x86 – vnitřní objekty](x86-intrinsics-list.md)
