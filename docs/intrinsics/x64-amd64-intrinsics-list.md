...
- Soubor hlaviček. Mnoho vnitřní funkce jsou popsány v komentářích v záhlaví souboru.
...
|--------------------|----------------|------------|------------------------|
|_addcarry_u16||intrin.h|nepodepsané char _addcarry_u16 (bez znaménka char c_in, nepodepsané krátké src1, nepodepsané krátké src2 nepodepsané prostě * součet)|
|[_addcarry_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u32)||intrin.h|nepodepsané char _addcarry_u32 (bez znaménka char c_in, src1 nepodepsané int, src2 nepodepsané int, nepodepsané int * součet)|
|[_addcarry_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u64)||intrin.h|nepodepsané char _addcarry_u64 (bez znaménka c_in char, nepodepsané \__int64 src1, nepodepsané \__int64 src2, nepodepsané \__int64 * součet)|
|_addcarry_u8||intrin.h|nepodepsané char _addcarry_u8 (bez znaménka char c_in, src1 unsigned char, src2 unsigned char, unsigned char * součet)|
|[_addcarryx_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u32)|ADX [2]|immintrin.h|nepodepsané char _addcarryx_u32 (bez znaménka char c_in, src1 nepodepsané int, src2 nepodepsané int, nepodepsané int * součet)|
...
|[__addgsbyte](../intrinsics/addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsbyte (unsigned char dlouho bez znaménka)|
|[__addgsdword](../intrinsics/addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsdword (bez znaménka int dlouho bez znaménka)|
|[__addgsqword](../intrinsics/addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsqword (bez znaménka dlouho, nepodepsané \__int64)|
|[__addgsword](../intrinsics/addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsword (bez znaménka krátké dlouho bez znaménka)|
|[_AddressOfReturnAddress](../intrinsics/addressofreturnaddress.md)||intrin.h|void * _AddressOfReturnAddress(void)|
|_andn_u32|BMI [1]|ammintrin.h|nepodepsané int _andn_u32 (bez znaménka int, int bez znaménka)|
|_andn_u64|BMI [1]|ammintrin.h|nepodepsané __int64 _andn_u64 (bez znaménka \__int64, nepodepsané \__int64)|
|[_bextr_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bextr_u32)|BMI|ammintrin.h, immintrin.h|nepodepsané int _bextr_u32 (bez znaménka int, unsigned int, int bez znaménka)|
|[_bextr_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bextr_u64)|BMI|ammintrin.h, immintrin.h|nepodepsané __int64 _bextr_u64 (bez znaménka \_nepodepsané _int64, nepodepsané int, int)|
|_bextri_u32|ABM [1]|ammintrin.h|nepodepsané int _bextri_u32 (bez znaménka int, int bez znaménka)|
|_bextri_u64|ABM [1]|ammintrin.h|nepodepsané __int64 _bextri_u64 (bez znaménka \__int64, nepodepsané int)|
|[_BitScanForward](../intrinsics/bitscanforward-bitscanforward64.md)||intrin.h|Logická hodnota _BitScanForward (OUT ULONG * maska ULONG Index, IN)|
|[_BitScanForward64](../intrinsics/bitscanforward-bitscanforward64.md)||intrin.h|Logická hodnota _BitScanForward64 (OUT ULONG * maska ULONG64 Index, IN)|
|[_BitScanReverse](../intrinsics/bitscanreverse-bitscanreverse64.md)||intrin.h|Logická hodnota _BitScanReverse (OUT ULONG * maska ULONG Index, IN)|
|[_BitScanReverse64](../intrinsics/bitscanreverse-bitscanreverse64.md)||intrin.h|Logická hodnota _BitScanReverse64 (OUT ULONG * maska ULONG64 Index, IN)|
|[_bittest](../intrinsics/bittest-bittest64.md)||intrin.h|nepodepsané char _bittest (dlouho const * dlouho a, b).|
|[_bittest64](../intrinsics/bittest-bittest64.md)||intrin.h|unsigned char _bittest64 (\__int64 const * a,\__int64 b).|
|[_bittestandcomplement](../intrinsics/bittestandcomplement-bittestandcomplement64.md)||intrin.h|nepodepsané char _bittestandcomplement (dlouho * dlouho a, b).|
...
|[_bittestandreset](../intrinsics/bittestandreset-bittestandreset64.md)||intrin.h|nepodepsané char _bittestandreset (dlouho * dlouho a, b).|
...
|[_bittestandset](../intrinsics/bittestandset-bittestandset64.md)||intrin.h|nepodepsané char _bittestandset (dlouho * dlouho a, b).|
|[_bittestandset64](../intrinsics/bittestandset-bittestandset64.md)||intrin.h|unsigned char _bittestandset64 (\__int64 * a,\__int64 b).|
|_blcfill_u32|ABM [1]|ammintrin.h|nepodepsané int _blcfill_u32(unsigned int)|
|_blcfill_u64|ABM [1]|ammintrin.h|nepodepsané __int64 _blcfill_u64 (bez znaménka \__int64)|
|_blci_u32|ABM [1]|ammintrin.h|nepodepsané int _blci_u32(unsigned int)|
|_blci_u64|ABM [1]|ammintrin.h|nepodepsané __int64 _blci_u64 (bez znaménka \__int64)|
|_blcic_u32|ABM [1]|ammintrin.h|nepodepsané int _blcic_u32(unsigned int)|
|_blcic_u64|ABM [1]|ammintrin.h|nepodepsané __int64 _blcic_u64 (bez znaménka \__int64)|
|_blcmsk_u32|ABM [1]|ammintrin.h|nepodepsané int _blcmsk_u32(unsigned int)|
|_blcmsk_u64|ABM [1]|ammintrin.h|nepodepsané __int64 _blcmsk_u64 (bez znaménka \__int64)|
|_blcs_u32|ABM [1]|ammintrin.h|nepodepsané int _blcs_u32(unsigned int)|
|_blcs_u64|ABM [1]|ammintrin.h|nepodepsané __int64 _blcs_u64 (bez znaménka \__int64)|
|_blsfill_u32|ABM [1]|ammintrin.h|nepodepsané int _blsfill_u32(unsigned int)|
|_blsfill_u64|ABM [1]|ammintrin.h|nepodepsané __int64 _blsfill_u64 (bez znaménka \__int64)|
|[_blsi_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsi_u32)|BMI|ammintrin.h, immintrin.h|nepodepsané int _blsi_u32(unsigned int)|
|[_blsi_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsi_u64)|BMI|ammintrin.h, immintrin.h|nepodepsané __int64 _blsi_u64 (bez znaménka \__int64)|
|_blsic_u32|ABM [1]|ammintrin.h|nepodepsané int _blsic_u32(unsigned int)|
|_blsic_u64|ABM [1]|ammintrin.h|nepodepsané __int64 _blsic_u64 (bez znaménka \__int64)|
|[_blsmsk_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsmsk_u32)|BMI|ammintrin.h, immintrin.h|nepodepsané int _blsmsk_u32(unsigned int)|
|[_blsmsk_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsmsk_u64)|BMI|ammintrin.h, immintrin.h|nepodepsané __int64 _blsmsk_u64 (bez znaménka \__int64)|
|[_blsr_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsr_u32)|BMI|ammintrin.h, immintrin.h|nepodepsané int _blsr_u32(unsigned int)|
|[_blsr_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsr_u64)|BMI|ammintrin.h, immintrin.h|nepodepsané __int64 _blsr_u64 (bez znaménka \__int64)|
|[_bzhi_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bzhi_u32)|BMI [2]|immintrin.h|nepodepsané int _bzhi_u32 (bez znaménka int, int bez znaménka)|
|[_bzhi_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bzhi_u64)|BMI [2]|immintrin.h|nepodepsané __int64 _bzhi_u64 (bez znaménka \__int64, nepodepsané int)|
...
|[__emulu](../intrinsics/emul-emulu.md)||intrin.h|nepodepsané __int64 [pascal/cdecl]\__emulu (bez znaménka int, int bez znaménka)|
...
|[__getcallerseflags](../intrinsics/getcallerseflags.md)||intrin.h|(bez znaménka int __getcallerseflags())|
|[__halt](../intrinsics/halt.md)||intrin.h|void __halt(void)|
|[__inbyte](../intrinsics/inbyte.md)||intrin.h|unsigned char __inbyte (bez znaménka krátké Port)|
|[__inbytestring](../intrinsics/inbytestring.md)||intrin.h|void __inbytestring (bez znaménka krátké Port, nepodepsané char * vyrovnávací paměti, nepodepsané dlouho počet)|
...
|[__indword](../intrinsics/indword.md)||intrin.h|nepodepsané dlouho __indword (bez znaménka krátké Port)|
|[__indwordstring](../intrinsics/indwordstring.md)||intrin.h|void __indwordstring (bez znaménka krátké Port, nepodepsané dlouho * vyrovnávací paměti, nepodepsané dlouho počet)|
|[__int2c](../intrinsics/int2c.md)||intrin.h|void __int2c(void)|
|[_InterlockedAnd](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedAnd (dlouho volatile *, long)|
|[_InterlockedAnd_HLEAcquire](../intrinsics/interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedAnd_HLEAcquire (dlouho volatile *, long)|
|[_InterlockedAnd_HLERelease](../intrinsics/interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedAnd_HLERelease (dlouho volatile *, long)|
|[_InterlockedAnd_np](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedAnd_np (dlouho *, long)|
|[_InterlockedAnd16](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|krátký _InterlockedAnd16 (krátký volatile *, krátké)|
|[_InterlockedAnd16_np](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|krátký _InterlockedAnd16_np (krátké *, krátké)|
...
|[_interlockedbittestandreset](../intrinsics/interlockedbittestandreset-intrinsic-functions.md)||intrin.h|nepodepsané char _interlockedbittestandreset (dlouho * dlouho a, b).|
|[_interlockedbittestandreset_HLEAcquire](../intrinsics/interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|nepodepsané char _interlockedbittestandreset_HLEAcquire (dlouho * dlouho a, b).|
|[_interlockedbittestandreset_HLERelease](../intrinsics/interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|nepodepsané char _interlockedbittestandreset_HLERelease (dlouho * dlouho a, b).|
...
|[_interlockedbittestandset](../intrinsics/interlockedbittestandset-intrinsic-functions.md)||intrin.h|nepodepsané char _interlockedbittestandset (dlouho * dlouho a, b).|
|[_interlockedbittestandset_HLEAcquire](../intrinsics/interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|nepodepsané char _interlockedbittestandset_HLEAcquire (dlouho * dlouho a, b).|
|[_interlockedbittestandset_HLERelease](../intrinsics/interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|nepodepsané char _interlockedbittestandset_HLERelease (dlouho * dlouho a, b).|
...
|[_InterlockedCompareExchange](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedCompareExchange (dlouho volatile * dlouhý, dlouhé)|
|[_InterlockedCompareExchange_HLEAcquire](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedCompareExchange_HLEAcquire (dlouho volatile * dlouhý, dlouhé)|
|[_InterlockedCompareExchange_HLERelease](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedCompareExchange_HLERelease (dlouho volatile * dlouhý, dlouhé)|
|[_InterlockedCompareExchange_np](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedCompareExchange_np (dlouho * dlouhý, dlouhé)|
...
|[_InterlockedCompareExchange16](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|krátký _InterlockedCompareExchange16 (krátký volatile * operand porovnávání krátká cíl, krátké Exchange)|
|[_InterlockedCompareExchange16_np](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|krátký _InterlockedCompareExchange16_np (krátký volatile * operand porovnávání krátká cíl, krátké Exchange)|
...
|[_InterlockedCompareExchange8](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|Char – _InterlockedCompareExchange8 (char volatile * cíl, char systému Exchange, char operand porovnávání)|
...
|[_InterlockedDecrement](../intrinsics/interlockeddecrement-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedDecrement(long volatile *)|
|[_InterlockedDecrement16](../intrinsics/interlockeddecrement-intrinsic-functions.md)||intrin.h|krátký _InterlockedDecrement16 (krátký volatile * Sčítanec)|
...
|[_InterlockedExchange](../intrinsics/interlockedexchange-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedExchange (dlouho volatile *, long)|
|[_InterlockedExchange_HLEAcquire](../intrinsics/interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedExchange_HLEAcquire (dlouho volatile *, long)|
|[_InterlockedExchange_HLERelease](../intrinsics/interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedExchange_HLERelease (dlouho volatile *, long)|
|[_InterlockedExchange16](../intrinsics/interlockedexchange-intrinsic-functions.md)||intrin.h|krátký _InterlockedExchange16 (krátký volatile *, krátké)|
...
|[_InterlockedExchangeAdd](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedExchangeAdd (dlouho volatile *, long)|
|[_InterlockedExchangeAdd_HLEAcquire](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedExchangeAdd_HLEAcquire (dlouho volatile *, long)|
|[_InterlockedExchangeAdd_HLERelease](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedExchangeAdd_HLERelease (dlouho volatile *, long)|
|[_InterlockedExchangeAdd16](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)||intrin.h|krátký _InterlockedExchangeAdd16 (krátký volatile *, krátké)|
...
|[_InterlockedIncrement](../intrinsics/interlockedincrement-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedIncrement(long volatile *)|
|[_InterlockedIncrement16](../intrinsics/interlockedincrement-intrinsic-functions.md)||intrin.h|krátký _InterlockedIncrement16 (krátký volatile * Sčítanec)|
...
|[_InterlockedOr](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedOr (dlouho volatile *, long)|
|[_InterlockedOr_HLEAcquire](../intrinsics/interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedOr_HLEAcquire (dlouho volatile *, long)|
|[_InterlockedOr_HLERelease](../intrinsics/interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedOr_HLERelease (dlouho volatile *, long)|
|[_InterlockedOr_np](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedOr_np (dlouho *, long)|
|[_InterlockedOr16](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|krátký _InterlockedOr16 (krátký volatile *, krátké)|
|[_InterlockedOr16_np](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|krátký _InterlockedOr16_np (krátké *, krátké)|
...
|[_InterlockedXor](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedXor (dlouho volatile *, long)|
|[_InterlockedXor_HLEAcquire](../intrinsics/interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedXor_HLEAcquire (dlouho volatile *, long)|
|[_InterlockedXor_HLERelease](../intrinsics/interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|dlouhé _InterlockedXor_HLERelease (dlouho volatile *, long)|
|[_InterlockedXor_np](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|dlouhé _InterlockedXor_np (dlouho *, long)|
|[_InterlockedXor16](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|krátký _InterlockedXor16 (krátký volatile *, krátké)|
|[_InterlockedXor16_np](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|krátký _InterlockedXor16_np (krátké *, krátké)|
...
|[_invpcid](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_invpcid)|INVPCID [2]|immintrin.h|void _invpcid (bez znaménka int, void *)|
|[__inword](../intrinsics/inword.md)||intrin.h|nepodepsané krátké __inword (bez znaménka krátké Port)|
|[__inwordstring](../intrinsics/inwordstring.md)||intrin.h|void __inwordstring (bez znaménka krátké Port, nepodepsané prostě * vyrovnávací paměti, nepodepsané dlouho počet)|
|_lgdt||intrin.h|void _lgdt(void*)|
|[__lidt](../intrinsics/lidt.md)||intrin.h|void __lidt(void*)|
|[__ll_lshift](../intrinsics/ll-lshift.md)||intrin.h|nepodepsané __int64 [pascal/cdecl] \__ll_lshift (bez znaménka \__int64, int)|
...
|_load_be_u16<br /><br /> [_loadbe_i16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i16&expand=3071)|MOVBE|immintrin.h|nepodepsané krátké _load_be_u16 (void const *);<br /><br /> krátký _loadbe_i16 (void const\*); [3]|
|_load_be_u32<br /><br /> [_loadbe_i32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i32&expand=3072)|MOVBE|immintrin.h|nepodepsané int _load_be_u32 (void const *);<br /><br /> int _loadbe_i32 (void const\*); [3]|
|_load_be_u64<br /><br /> [_loadbe_i64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i64&expand=3073)|MOVBE|immintrin.h|__int64 _load_be_u64 bez znaménka (void const *);<br /><br /> \__int64 _loadbe_i64 (void const\*); [3]|
|__lwpins32|LWP [1]|ammintrin.h|nepodepsané char __lwpins32 (bez znaménka int, unsigned int, int bez znaménka)|
|__lwpins64|LWP [1]|ammintrin.h|nepodepsané char __lwpins64 (bez znaménka \_nepodepsané _int64, nepodepsané int, int)|
|__lwpval32|LWP [1]|ammintrin.h|void __lwpval32 (bez znaménka int, unsigned int, int bez znaménka)|
|__lwpval64|LWP [1]|ammintrin.h|void __lwpval64 (bez znaménka \_nepodepsané _int64, nepodepsané int, int)|
|[__lzcnt](../intrinsics/lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|nepodepsané int __lzcnt(unsigned int)|
|[_lzcnt_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_lzcnt_u32)|BMI|ammintrin.h, immintrin.h|nepodepsané int _lzcnt_u32(unsigned int)|
|[_lzcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_lzcnt_u64)|BMI|ammintrin.h, immintrin.h|nepodepsané __int64 _lzcnt_u64 (bez znaménka \__int64)|
|[__lzcnt16](../intrinsics/lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|krátký __lzcnt16(unsigned short) bez znaménka|
|[__lzcnt64](../intrinsics/lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|nepodepsané __int64 \__lzcnt64 (bez znaménka \__int64)|
...
|[_mm_crc32_u16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u16)|SSE42|intrin.h|nepodepsané int _mm_crc32_u16 (bez znaménka int, nepodepsané prostě)|
|[_mm_crc32_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u32)|SSE42|intrin.h|nepodepsané int _mm_crc32_u32 (bez znaménka int, int bez znaménka)|
|[_mm_crc32_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u64)|SSE42|intrin.h|nepodepsané __int64 _mm_crc32_u64 (bez znaménka \__int64, nepodepsané \__int64)|
|[_mm_crc32_u8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u8)|SSE42|intrin.h|nepodepsané int _mm_crc32_u8 (bez znaménka int, unsigned char)|
...
|[_mm_getcsr](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_getcsr)|SSE|intrin.h|nepodepsané int _mm_getcsr(void)|
...
|[_mm_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_i32gather_epi32 (int const * základ,\__m128i index, const int škálování)|
|[_mm_i32gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_epi64)|AVX2 [2]|immintrin.h|__m128i _mm_i32gather_epi64 (\__int64 const * základní,\__m128i index, const int škálování)|
|[_mm_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_i32gather_pd (dvojité const * základ,\__m128i index, const int škálování)|
|[_mm_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_i32gather_ps (float const * základ,\__m128i index, const int škálování)|
|[_mm_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_i64gather_epi32 (int const * základ,\__m128i index, const int škálování)|
|[_mm_i64gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_epi64)|AVX2 [2]|immintrin.h|__m128i _mm_i64gather_epi64 (\__int64 const * základní,\__m128i index, const int škálování)|
|[_mm_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_i64gather_pd (dvojité const * základ,\__m128i index, const int škálování)|
|[_mm_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_i64gather_ps (float const * základ,\__m128i index, const int škálování)|
...
|[_mm_loaddup_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_loaddup_pd)|SSE3|intrin.h|__m128d _mm_loaddup_pd (dvojité const *)|
...
|[_mm_mask_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i32gather_epi32 (\__m128i src, int const * základní,\__m128i index,\__m128i maska, const int škálování)|
|[_mm_mask_i32gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_epi64)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i32gather_epi64 (\__m128i src\__int64 const * základní,\__m128i index,\__m128i maska, const int škálování)|
|[_mm_mask_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_mask_i32gather_pd (\__m128d src, double const * základní,\__m128i index,\__m128d maska, const int škálování)|
|[_mm_mask_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_mask_i32gather_ps (\__m128 src, float const * základní,\__m128i index,\__m128 maska, const int škálování)|
|[_mm_mask_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i64gather_epi32 (\__m128i src, int const * základní,\__m128i index,\__m128i maska, const int škálování)|
|[_mm_mask_i64gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_epi64)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i64gather_epi64 (\__m128i src\__int64 const * základní,\__m128i index,\__m128i maska, const int škálování)|
|[_mm_mask_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_mask_i64gather_pd (\__m128d src, double const * základní,\__m128i index,\__m128d maska, const int škálování)|
|[_mm_mask_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_mask_i64gather_ps (\__m128 src, float const * základní,\__m128i index,\__m128 maska, const int škálování)|
...
|[_mm_maskload_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskload_pd)|AVX [2]|immintrin.h|__m128d _mm_maskload_pd (dvojité const *,\__m128i)|
...
|[_mm_maskstore_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskstore_pd)|AVX [2]|immintrin.h|void _mm_maskstore_pd (dvojitou *,\__m128i,\__m128d)|
...
|[_mm_monitor](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_monitor)|SSE3|intrin.h|void _mm_monitor (const void *, nepodepsané int, int bez znaménka)|
...
|[_mm_mwait](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mwait)|SSE3|intrin.h|void _mm_mwait (bez znaménka int, int bez znaménka)|
...
|[_mm_popcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_popcnt_u64)|POPCNT|intrin.h|__int64 _mm_popcnt_u64 (bez znaménka \__int64)|
...
|[_mm_shuffle_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_shuffle_ps)|SSE|intrin.h|__m128 _mm_shuffle_ps (\__m128,\__m128, nepodepsané int)|
...
|[_mm_store_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_store_pd)|SSE2|intrin.h|void _mm_store_pd (dvojitou *\__m128d)|
...
|[_mm_store_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_store_sd)|SSE2|intrin.h|void _mm_store_sd (dvojitou *\__m128d)|
...
|[_mm_stream_sd](../intrinsics/mm-stream-sd.md)|SSE4a|intrin.h|void _mm_stream_sd (dvojitou *\__m128d)|
...
|[_mm256_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_i32gather_epi32 (int const * základ,\__m256i index, const int škálování)|
|[_mm256_i32gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_epi64)|AVX2 [2]|immintrin.h|__m256i _mm256_i32gather_epi64 (\__int64 const * základní,\__m128i index, const int škálování)|
|[_mm256_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_i32gather_pd (dvojité const * základ,\__m128i index, const int škálování)|
|[_mm256_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_ps)|AVX2 [2]|immintrin.h|__m256 _mm256_i32gather_ps (float const * základ,\__m256i index, const int škálování)|
|[_mm256_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_i64gather_epi32 (int const * základ,\__m256i index, const int škálování)|
|[_mm256_i64gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_epi64)|AVX2 [2]|immintrin.h|__m256i _mm256_i64gather_epi64 (\__int64 const * základní,\__m256i index, const int škálování)|
|[_mm256_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_i64gather_pd (dvojité const * základ,\__m256i index, const int škálování)|
|[_mm256_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm256_i64gather_ps (float const * základ,\__m256i index, const int škálování)|
...
|[_mm256_mask_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_mask_i32gather_epi32 (\__m256i src, int const * základní,\__m256i index,\__m256i maska, const int škálování)|
|[_mm256_mask_i32gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_epi64)|AVX2 [2]|immintrin.h|__m256i _mm256_mask_i32gather_epi64 (\__m256i src\__int64 const * základní,\__m128i index,\__m256i maska, const int škálování)|
|[_mm256_mask_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_mask_i32gather_pd (\__m256d src, double const * základní,\__m128i index,\__m256d maska, const int škálování)|
|[_mm256_mask_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_ps)|AVX2 [2]|immintrin.h|__m256 _mm256_mask_i32gather_ps (\__m256 src, float const * základní,\__m256i index,\__m256 maska, const int škálování)|
|[_mm256_mask_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm256_mask_i64gather_epi32 (\__m128i src, int const * základní,\__m256i index,\__m128i maska, const int škálování)|
|[_mm256_mask_i64gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_epi64)|AVX2 [2]|immintrin.h|__m256i _mm256_mask_i64gather_epi64 (\__m256i src\__int64 const * základní,\__m256i index,\__m256i maska, const int škálování)|
|[_mm256_mask_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_mask_i64gather_pd (\__m256d src, double const * základní,\__m256i index,\__m256d maska, const int škálování)|
|[_mm256_mask_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm256_mask_i64gather_ps (\__m128 src, float const * základní,\__m256i index,\__m128 maska, const int škálování)|
...
|[_mm256_maskload_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskload_pd)|AVX [2]|immintrin.h|__m256d _mm256_maskload_pd (dvojité const *,\__m256i)|
...
|[_mm256_maskstore_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskstore_pd)|AVX [2]|immintrin.h|void _mm256_maskstore_pd (dvojitou *,\__m256i,\__m256d)|
...
|[_mm256_set_epi64x](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_set_epi64x)|AVX [2]|immintrin.h|__m256i _mm256_set_epi64x (dlouho dlouhý, dlouho dlouhé, dlouho dlouhý, dlouho dlouho)|
...
|[_mm256_setr_epi64x](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_setr_epi64x)|AVX [2]|immintrin.h|__m256i _mm256_setr_epi64x (dlouho dlouhý, dlouho dlouhé, dlouho dlouhý, dlouho dlouho)|
...
|[_mm256_store_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_store_pd)|AVX [2]|immintrin.h|void _mm256_store_pd (dvojitou *,\__m256d)|
...
|[_mm256_storeu_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_storeu_pd)|AVX [2]|immintrin.h|void _mm256_storeu_pd (dvojitou *,\__m256d)|
...
|[_mm256_stream_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_stream_pd)|AVX [2]|immintrin.h|void __mm256_stream_pd (dvojitou *,\__m256d)|
...
|[__movsb](../intrinsics/movsb.md)||intrin.h|VOID __movsb (IN PBYTE, v bajtech const *, size_t – IN)|
...
|[__movsw](../intrinsics/movsw.md)||intrin.h|VOID __movsw (pword – IN, IN slova const *, size_t – IN)|
|[_mul128](../intrinsics/mul128.md)||intrin.h|__int64 _mul128 (\__int64 násobitel\__int64 násobenec\__int64 * highproduct)|
|[__mulh](../intrinsics/mulh.md)||intrin.h|__int64 \__mulh (\__int64,\__int64)|
|_mulx_u32|BMI [2]|immintrin.h|nepodepsané int _mulx_u32 (bez znaménka int, int bez znaménka, nepodepsané int *)|
|_mulx_u64|BMI [2]|immintrin.h|nepodepsané __int64 _mulx_u64 (bez znaménka \__int64, nepodepsané \__int64, nepodepsané \__int64 *)|
...
|[__outbyte](../intrinsics/outbyte.md)||intrin.h|void __outbyte (bez znaménka krátké Port, bez znaménka char dat)|
|[__outbytestring](../intrinsics/outbytestring.md)||intrin.h|void __outbytestring (bez znaménka krátké Port, nepodepsané char * vyrovnávací paměti, nepodepsané dlouho počet)|
|[__outdword](../intrinsics/outdword.md)||intrin.h|void __outdword (bez znaménka krátké Port, nepodepsané long – datový)|
|[__outdwordstring](../intrinsics/outdwordstring.md)||intrin.h|void __outdwordstring (bez znaménka krátké Port, nepodepsané dlouho * vyrovnávací paměti, nepodepsané dlouho počet)|
|[__outword](../intrinsics/outword.md)||intrin.h|void __outword (bez znaménka krátké Port, nepodepsané short – datový)|
|[__outwordstring](../intrinsics/outwordstring.md)||intrin.h|void __outwordstring (bez znaménka krátké Port, nepodepsané prostě * vyrovnávací paměti, nepodepsané dlouho počet)|
|[_pdep_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pdep_u32)|BMI [2]|immintrin.h|nepodepsané int _pdep_u32 (bez znaménka int, int bez znaménka)|
|[_pdep_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pdep_u64)|BMI [2]|immintrin.h|nepodepsané __int64 _pdep_u64 (bez znaménka \__int64, nepodepsané \__int64)|
|[_pext_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pext_u32)|BMI [2]|immintrin.h|nepodepsané int _pext_u32 (bez znaménka int, int bez znaménka)|
|[_pext_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pext_u64)|BMI [2]|immintrin.h|nepodepsané __int64 _pext_u64 (bez znaménka \__int64, nepodepsané \__int64)|
|[__popcnt](../intrinsics/popcnt16-popcnt-popcnt64.md)|POPCNT|intrin.h|nepodepsané int __popcnt(unsigned int)|
|[__popcnt16](../intrinsics/popcnt16-popcnt-popcnt64.md)|POPCNT|intrin.h|krátký __popcnt16(unsigned short) bez znaménka|
|[__popcnt64](../intrinsics/popcnt16-popcnt-popcnt64.md)|POPCNT|intrin.h|nepodepsané __int64 \__popcnt64 (bez znaménka \__int64)|
...
|[_rdrand64_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand64_step)|RDRAND [2]|immintrin.h|int _rdrand64_step (bez znaménka \__int64 *)|
...
|[_rdseed64_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdseed64_step)|RDSEED [2]|immintrin.h|int _rdseed64_step (bez znaménka \__int64 *)|
|[__rdtsc](../intrinsics/rdtsc.md)||intrin.h|nepodepsané __int64 \__rdtsc(void)|
|[__rdtscp](../intrinsics/rdtscp.md)|RDTSCP|intrin.h|nepodepsané __int64 \__rdtscp (bez znaménka int *)|
|[_ReadBarrier](../intrinsics/readbarrier.md)||intrin.h|void _ReadBarrier(void)|
|[__readcr0](../intrinsics/readcr0.md)||intrin.h|nepodepsané __int64 \__readcr0(void)|
|[__readcr2](../intrinsics/readcr2.md)||intrin.h|nepodepsané __int64 \__readcr2(void)|
|[__readcr3](../intrinsics/readcr3.md)||intrin.h|nepodepsané __int64 \__readcr3(void)|
|[__readcr4](../intrinsics/readcr4.md)||intrin.h|nepodepsané __int64 \__readcr4(void)|
|[__readcr8](../intrinsics/readcr8.md)||intrin.h|nepodepsané __int64 \__readcr8(void)|
|[__readdr](../intrinsics/readdr.md)||intrin.h|nepodepsané __int64 \__readdr(unsigned)|
|[__readeflags](../intrinsics/readeflags.md)||intrin.h|nepodepsané __int64 \__readeflags(void)|
|[_readfsbase_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_readfsbase_u32)|FSGSBASE [2]|immintrin.h|nepodepsané int _readfsbase_u32(void)|
...
|[_readgsbase_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_readgsbase_u32)|FSGSBASE [2]|immintrin.h|nepodepsané int _readgsbase_u32(void)|
|[_readgsbase_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_readgsbase_u64)|FSGSBASE [2]|immintrin.h|nepodepsané __int64 _readgsbase_u64(void)|
|[__readgsbyte](../intrinsics/readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|unsigned char __readgsbyte (bez znaménka dlouho posun)|
|[__readgsdword](../intrinsics/readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|nepodepsané dlouho __readgsdword (bez znaménka dlouho posun)|
|[__readgsqword](../intrinsics/readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|nepodepsané __int64 \__readgsqword (bez znaménka dlouho posun)|
|[__readgsword](../intrinsics/readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|nepodepsané krátké __readgsword (bez znaménka dlouho posun)|
|[__readmsr](../intrinsics/readmsr.md)||intrin.h|nepodepsané __int64 \__readmsr (dlouho bez znaménka)|
|[__readpmc](../intrinsics/readpmc.md)||intrin.h|nepodepsané __int64 \__readpmc(unsigned long a)|
...
|_rorx_u32|BMI [2]|immintrin.h|nepodepsané int _rorx_u32 (bez znaménka int, const int bez znaménka)|
|_rorx_u64|BMI [2]|immintrin.h|nepodepsané __int64 _rorx_u64 (bez znaménka \__int64 const int bez znaménka)|
|[_rotl16](../intrinsics/rotl8-rotl16.md)||intrin.h|nepodepsané krátké _rotl16 (bez znaménka krátké hodnoty, unsigned char shift)|
|[_rotl8](../intrinsics/rotl8-rotl16.md)||intrin.h|nepodepsané char _rotl8 (hodnota unsigned char, unsigned char shift)|
|[_rotr16](../intrinsics/rotr8-rotr16.md)||intrin.h|nepodepsané krátké _rotr16 (bez znaménka krátké hodnoty, unsigned char shift)|
|[_rotr8](../intrinsics/rotr8-rotr16.md)||intrin.h|nepodepsané char _rotr8 (hodnota unsigned char, unsigned char shift)|
|_rsm||intrin.h|void _rsm(void)|
|_sarx_i32|BMI [2]|immintrin.h|int _sarx_i32 (int, int bez znaménka)|
|_sarx_i64|BMI [2]|immintrin.h|__int64 _sarx_i64 (\__int64, nepodepsané int)|
|[__segmentlimit](../intrinsics/segmentlimit.md)||intrin.h|nepodepsané dlouho __segmentlimit(unsigned long a)|
|_sgdt||intrin.h|void _sgdt(void*)|
|[__shiftleft128](../intrinsics/shiftleft128.md)||intrin.h|nepodepsané __int64 \__shiftleft128 (bez znaménka \__int64 LowPart, nepodepsané \__int64 HighPart nepodepsané char Shift)|
|[__shiftright128](../intrinsics/shiftright128.md)||intrin.h|nepodepsané __int64 \__shiftright128 (bez znaménka \__int64 LowPart, nepodepsané \__int64 HighPart nepodepsané char Shift)|
|_shlx_u32|BMI [2]|immintrin.h|nepodepsané int _shlx_u32 (bez znaménka int, int bez znaménka)|
|_shlx_u64|BMI [2]|immintrin.h|nepodepsané __int64 _shlx_u64 (bez znaménka \__int64, nepodepsané int)|
|_shrx_u32|BMI [2]|immintrin.h|nepodepsané int _shrx_u32 (bez znaménka int, int bez znaménka)|
|_shrx_u64|BMI [2]|immintrin.h|nepodepsané __int64 _shrx_u64 (bez znaménka \__int64, nepodepsané int)|
...
|_store_be_u16<br /><br /> [_storebe_i16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i16&expand=5141)|MOVBE|immintrin.h|void _store_be_u16 (void *, prostě bez znaménka);<br /><br /> void _storebe_i16 (void \*, krátké); [3]|
|_store_be_u32<br /><br /> [_storebe_i32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i32&expand=5142)|MOVBE|immintrin.h|void _store_be_u32 (void *, nepodepsané int);<br /><br /> void _storebe_i32 (void \*, int); [3]|
|_store_be_u64<br /><br /> [_storebe_i64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i64&expand=5143)|MOVBE|immintrin.h|void _store_be_u64 (void * bez znaménka \__int64);<br /><br /> void _storebe_i64 (void \*, \__int64); [3]|
|_Store_HLERelease|HLE [2]|immintrin.h|void _Store_HLERelease (dlouho volatile *, long)|
...
|[__stosb](../intrinsics/stosb.md)||intrin.h|void __stosb (SIZE_T v PBYTE IN, v bajtech)|
|[__stosd](../intrinsics/stosd.md)||intrin.h|void __stosd (IN IN PDWORD, IN DWORD size_t –)|
|[__stosq](../intrinsics/stosq.md)||intrin.h|void __stosq (IN IN PDWORD64, IN DWORD64 size_t –)|
|[__stosw](../intrinsics/stosw.md)||intrin.h|void __stosw (SIZE_T v pword – IN, slovo IN)|
|_subborrow_u16||intrin.h|nepodepsané char _subborrow_u16 (bez znaménka char b_in, nepodepsané krátké src1, nepodepsané krátké src2 nepodepsané prostě * rozdílové)|
|[_subborrow_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u32)||intrin.h|nepodepsané char _subborrow_u32 (bez znaménka char b_in, src1 nepodepsané int, src2 nepodepsané int, nepodepsané int * rozdílové)|
|[_subborrow_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u64)||intrin.h|nepodepsané char _subborrow_u64 (bez znaménka b_in char, nepodepsané \__int64 src1, nepodepsané \__int64 src2, nepodepsané \__int64 * rozdílové)|
|_subborrow_u8||intrin.h|nepodepsané char _subborrow_u8 (bez znaménka char b_in, src1 unsigned char, src2 unsigned char, unsigned char * rozdílové)|
...
|_t1mskc_u32|ABM [1]|ammintrin.h|nepodepsané int _t1mskc_u32(unsigned int)|
|_t1mskc_u64|ABM [1]|ammintrin.h|nepodepsané __int64 _t1mskc_u64 (bez znaménka \__int64)|
|[_tzcnt_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_tzcnt_u32)|BMI|ammintrin.h, immintrin.h|nepodepsané int _tzcnt_u32(unsigned int)|
|[_tzcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_tzcnt_u64)|BMI|ammintrin.h, immintrin.h|nepodepsané __int64 _tzcnt_u64 (bez znaménka \__int64)|
|_tzmsk_u32|ABM [1]|ammintrin.h|nepodepsané int _tzmsk_u32(unsigned int)|
|_tzmsk_u64|ABM [1]|ammintrin.h|nepodepsané __int64 _tzmsk_u64 (bez znaménka \__int64)|
|[__ud2](../intrinsics/ud2.md)||intrin.h|void __ud2(void)|
|[__ull_rshift](../intrinsics/ull-rshift.md)||intrin.h|nepodepsané __int64 [pascal/cdecl] \__ull_rshift (bez znaménka \__int64, int)|
|[_umul128](../intrinsics/umul128.md)||intrin.h|nepodepsané __int64 _umul128 (bez znaménka \__int64 násobitel, nepodepsané \__int64 násobenec, nepodepsané \__int64 * highproduct)|
|[__umulh](../intrinsics/umulh.md)||intrin.h|nepodepsané __int64 \__umulh (bez znaménka \__int64, nepodepsané \__int64)|
|[__vmx_off](../intrinsics/vmx-off.md)||intrin.h|void __vmx_off(void)|
|[__vmx_on](../intrinsics/vmx-on.md)||intrin.h|nepodepsané char __vmx_on (bez znaménka \__int64 *)|
|[__vmx_vmclear](../intrinsics/vmx-vmclear.md)||intrin.h|nepodepsané char __vmx_vmclear (bez znaménka \__int64 *)|
|[__vmx_vmlaunch](../intrinsics/vmx-vmlaunch.md)||intrin.h|unsigned char __vmx_vmlaunch(void)|
|[__vmx_vmptrld](../intrinsics/vmx-vmptrld.md)||intrin.h|nepodepsané char __vmx_vmptrld (bez znaménka \__int64 *)|
|[__vmx_vmptrst](../intrinsics/vmx-vmptrst.md)||intrin.h|void __vmx_vmptrst (bez znaménka \__int64 *)|
...
|[__writecr0](../intrinsics/writecr0.md)||intrin.h|void __writecr0 (bez znaménka \__int64)|
|[__writecr3](../intrinsics/writecr3.md)||intrin.h|void __writecr3 (bez znaménka \__int64)|
|[__writecr4](../intrinsics/writecr4.md)||intrin.h|void __writecr4 (bez znaménka \__int64)|
|[__writecr8](../intrinsics/writecr8.md)||intrin.h|void __writecr8 (bez znaménka \__int64)|
|[__writedr](../intrinsics/writedr.md)||intrin.h|void __writedr (bez znaménka, nepodepsané \__int64)|
|[__writeeflags](../intrinsics/writeeflags.md)||intrin.h|void __writeeflags (bez znaménka \__int64)|
...
|[_writefsbase_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writefsbase_u64)|FSGSBASE [2]|immintrin.h|void _writefsbase_u64 (bez znaménka \__int64)|
...
|[_writegsbase_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writegsbase_u64)|FSGSBASE [2]|immintrin.h|void _writegsbase_u64 (bez znaménka \__int64)|
|[__writegsbyte](../intrinsics/writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsbyte (bez znaménka dlouho posunutí bez znaménka znakový dat)|
|[__writegsdword](../intrinsics/writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsdword (bez znaménka dlouho posunutí bez znaménka dat long)|
|[__writegsqword](../intrinsics/writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsqword (bez znaménka Offset dlouho, nepodepsané \__int64 Data)|
|[__writegsword](../intrinsics/writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsword (bez znaménka dlouho posunutí bez znaménka krátké Data)|
|[__writemsr](../intrinsics/writemsr.md)||intrin.h|void __writemsr (bez znaménka dlouho, nepodepsané \__int64)|
...
|[_xbegin](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xbegin)|RTM [2]|immintrin.h|_xbegin(void) bez znaménka|
|[_xend](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xend)|RTM [2]|immintrin.h|void _xend(void)|
|[_xgetbv](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xgetbv)|XSAVE [2]|immintrin.h|nepodepsané __int64 _xgetbv(unsigned int)|
|[_xrstor](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xrstor)|XSAVE [2]|immintrin.h|void _xrstor (void const *, nepodepsané \__int64)|
|[_xrstor64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xrstor64)|XSAVE [2]|immintrin.h|void _xrstor64 (void const *, nepodepsané \__int64)|
|[_xsave](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave)|XSAVE [2]|immintrin.h|void _xsave (void *, nepodepsané \__int64)|
|[_xsave64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave64)|XSAVE [2]|immintrin.h|void _xsave64 (void *, nepodepsané \__int64)|
|[_xsaveopt](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsaveopt)|XSAVEOPT [2]|immintrin.h|void _xsaveopt (void *, nepodepsané \__int64)|
|[_xsaveopt64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsaveopt64)|XSAVEOPT [2]|immintrin.h|void _xsaveopt64 (void *, nepodepsané \__int64)|
...
[x86 vnitřní funkce](../intrinsics/x86-intrinsics-list.md)    