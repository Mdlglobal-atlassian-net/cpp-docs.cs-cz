...
ms.locfileid: "74163492"
---
# <a name="x86-intrinsics-list"></a>x86 – seznam vnitřních funkcí

Tento dokument obsahuje seznam vnitřních objektů, které jazyk MicrosoftC++ C/kompilátor podporuje při cílení na platformu x86.
...
|[__addfsdword](addfsbyte-addfsword-addfsdword.md)||intrin. h|void __addfsdword (bez znaménka Long, bez znaménka)|
...
|[_mm_set_pi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_set_pi16)|MMX|intrin. h|__m64 _mm_set_pi16 (krátká, krátká, krátká, krátká)|
...
|[_mm_set1_pi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_set1_pi16)|MMX|intrin. h|__m64 _mm_set1_pi16 (krátký)|
...
|[_mm_setr_pi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_setr_pi16)|MMX|intrin. h|__m64 _mm_setr_pi16 (krátká, krátká, krátká, krátká)|
...
|[__readcr0](readcr0.md)||intrin. h|Long __readcr0 bez znaménka (void)|
|[__readcr2](readcr2.md)||intrin. h|Long __readcr2 bez znaménka (void)|
|[__readcr3](readcr3.md)||intrin. h|Long __readcr3 bez znaménka (void)|
|[__readcr4](readcr4.md)||intrin. h|Long __readcr4 bez znaménka (void)|
|[__readcr8](readcr8.md)||intrin. h|Long __readcr8 bez znaménka (void)|
|[__readdr](readdr.md)||intrin. h|Nepodepsaný __readdr (bez znaménka)|
|[__readeflags](readeflags.md)||intrin. h|Nepodepsaná __readeflags (void)|
|[__readfsbyte](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin. h|Nepodepsaný znak __readfsbyte (unsigned long)|
|[__readfsdword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin. h|Long __readfsdword bez znaménka (unsigned long)|
|[__readfsword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin. h|krátký __readfsword bez znaménka (unsigned long)|
...
|[__writedr](writedr.md)||intrin. h|void __writedr (bez znaménka, bez znaménka)|
|[__writeeflags](writeeflags.md)||intrin. h|void __writeeflags (bez znaménka)|
...
|[__writefsdword](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin. h|void __writefsdword (bez znaménka Long, bez znaménka)|
...
[vnitřní objekty x64 (amd64)](x64-amd64-intrinsics-list.md)
