...
ms.locfileid: "59982392"
---
# <a name="x86-intrinsics-list"></a>x86 – seznam vnitřních objektů

Tento dokument obsahuje seznam vnitřních objektů, které Microsoft C /C++ kompilátor podporuje při x86 cílí.
...
|[__addfsbyte](addfsbyte-addfsword-addfsdword.md)||intrin.h|void __addfsbyte (unsigned char bez znaménka, dlouhé)|
|[__addfsdword](addfsbyte-addfsword-addfsdword.md)||intrin.h|void __addfsdword (long long bez znaménka, bez znaménka)|
|[__addfsword](addfsbyte-addfsword-addfsdword.md)||intrin.h|void __addfsword (unsigned short long bez znaménka)|
...
|[_InterlockedAddLargeStatistic](interlockedaddlargestatistic.md)||intrin.h|dlouhé _InterlockedAddLargeStatistic (\__int64 volatile \*, long)|
...
|[_m_pinsrw](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_pinsrw)|SSE|intrin.h|__m64 _m_pinsrw (\_výrazů _m64, int, int)|
...
|[_m_psllqi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_psllqi)|MMX|intrin.h|__m64 _m_psllqi (\_výrazů _m64, int)|
...
|[_m_psradi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_psradi)|MMX|intrin.h|__m64 _m_psradi (\_výrazů _m64, int)|
...
|[_m_psrawi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_psrawi)|MMX|intrin.h|__m64 _m_psrawi (\_výrazů _m64, int)|
...
|[_m_psrldi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_psrldi)|MMX|intrin.h|__m64 _m_psrldi (\_výrazů _m64, int)|
...
|[_m_psrlwi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_psrlwi)|MMX|intrin.h|__m64 _m_psrlwi (\_výrazů _m64, int)|
...
|[_m_punpckhwd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_punpckhwd)|MMX|intrin.h|__m64 _m_punpckhwd (\_výrazů _m64, \_výrazů _m64)|
|[_m_punpcklbw](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_punpcklbw)|MMX|intrin.h|__m64 _m_punpcklbw (\_výrazů _m64, \_výrazů _m64)|
...
|[_m_punpcklwd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_punpcklwd)|MMX|intrin.h|__m64 _m_punpcklwd (\_výrazů _m64, \_výrazů _m64)|
...
|[_mm_alignr_pi8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_alignr_pi8)|SSSE3|intrin.h|__m64 _mm_alignr_pi8 (\_výrazů _m64, \_výrazů _m64, int)|
...
|[__readdr](readdr.md)||intrin.h|bez znaménka __readdr(unsigned)|
|[__readeflags](readeflags.md)||intrin.h|bez znaménka __readeflags(void)|
...
|[__writefsbyte](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsbyte (unsigned char bez znaménka, dlouhé)|
|[__writefsdword](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsdword (long long bez znaménka, bez znaménka)|
|[__writefsword](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsword (unsigned short long bez znaménka)|
...
[x64 (amd64) vnitřní objekty](x64-amd64-intrinsics-list.md)
