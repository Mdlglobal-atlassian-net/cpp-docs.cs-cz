---
title: x86 – seznam vnitřních objektů | Dokumentace Microsoftu
ms.custom: ''
ms.date: 06/01/2018
ms.technology:
- cpp-tools
...
|[__addfsbyte](../intrinsics/addfsbyte-addfsword-addfsdword.md)||intrin.h|void __addfsbyte (unsigned char bez znaménka, dlouhé)|
|[__addfsdword](../intrinsics/addfsbyte-addfsword-addfsdword.md)||intrin.h|void __addfsdword (long long bez znaménka, bez znaménka)|
|[__addfsword](../intrinsics/addfsbyte-addfsword-addfsdword.md)||intrin.h|void __addfsword (unsigned short long bez znaménka)|
...
|[_m_maskmovq](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_maskmovq)|SSE|intrin.h|void _m_maskmovq (\_výrazů _m64,\_výrazů _m64, char\*)|
...
|[_m_pand](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_pand)|MMX|intrin.h|__m64 _m_pand (\_výrazů _m64,\_výrazů _m64)|
...
|[_m_pextrw](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_pextrw)|SSE|intrin.h|int _m_pextrw (\_výrazů _m64, int)|
...
|[_m_pshufw](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_pshufw)|SSE|intrin.h|__m64 _m_pshufw (\_výrazů _m64, int)|
...
|[_m_pslldi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_pslldi)|MMX|intrin.h|__m64 _m_pslldi (\_výrazů _m64, int)|
...
|[_m_psllwi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_psllwi)|MMX|intrin.h|__m64 _m_psllwi (\_výrazů _m64, int)|
...
|[_mm_stream_pi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_stream_pi)|SSE|intrin.h|void _mm_stream_pi (\_výrazů _m64\*,\_výrazů _m64)|
...
|[__readdr](../intrinsics/readdr.md)||intrin.h|bez znaménka __readdr(unsigned)|
|[__readeflags](../intrinsics/readeflags.md)||intrin.h|bez znaménka __readeflags(void)|
|[__readfsbyte](../intrinsics/readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|unsigned char __readfsbyte (unsigned long posunu)|
|[__readfsdword](../intrinsics/readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|unsigned long __readfsdword (unsigned long posunu)|
|[__readfsword](../intrinsics/readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|unsigned short __readfsword (unsigned long posunu)|
...
|[__writefsbyte](../intrinsics/writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsbyte (bez znaménka dlouho posunu, unsigned char Data)|
|[__writefsdword](../intrinsics/writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsdword (bez znaménka dlouho posunu, unsigned long – datový)|
|[__writefsword](../intrinsics/writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsword (bez znaménka dlouho posunu, unsigned short – datový)|
