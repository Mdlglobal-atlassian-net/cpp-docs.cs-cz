...
description: Seznam vnitřních částí ARM64 podporovaný kompilátorem Microsoft C++.
f1_keywords:
- __break
- __addx18byte
- __addx18word
...
||8|16|32|64|128|P|
|-|-------|--------|--------|--------|-------|-------|
|Přidat|Žádný|Žádný|Do bloku|Do bloku|Žádný|Žádný|
|And|Do bloku|Do bloku|Do bloku|Do bloku|Žádný|Žádný|
|Compareexchange|Do bloku|Do bloku|Do bloku|Do bloku|Do bloku|Do bloku|
|Snižovat|Žádný|Do bloku|Do bloku|Do bloku|Žádný|Žádný|
|Výměna|Do bloku|Do bloku|Do bloku|Do bloku|Žádný|Do bloku|
|ExchangeAdd|Do bloku|Do bloku|Do bloku|Do bloku|Žádný|Žádný|
|Přírůstek|Žádný|Do bloku|Do bloku|Do bloku|Žádný|Žádný|
|Nebo|Do bloku|Do bloku|Do bloku|Do bloku|Žádný|Žádný|
|Xor|Do bloku|Do bloku|Do bloku|Do bloku|Žádný|Žádný|
