...
ms.locfileid: "33101276"
---
# <a name="irowsetinfoimplgetproperties"></a>IRowsetInfoImpl::GetProperties
Vrátí aktuální nastavení vlastnosti v **DBPROPSET_ROWSET** skupiny.  
...
#### <a name="parameters"></a>Parametry  
 V tématu [IRowsetInfo::GetProperties](https://msdn.microsoft.com/en-us/library/ms719611.aspx) v *referenční příručka programátora prostředí OLE DB*.  
