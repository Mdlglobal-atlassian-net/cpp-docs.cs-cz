...
ms.locfileid: "33092750"
---
# <a name="columnnameps"></a>COLUMN_NAME_PS
Představuje vazbu na sadě řádků konkrétní sloupec v dané sadě řádků. Podobně jako [COLUMN_NAME](../../data/oledb/column-name.md)kromě toho, že tento makro také trvá přesnost a měřítko.  
