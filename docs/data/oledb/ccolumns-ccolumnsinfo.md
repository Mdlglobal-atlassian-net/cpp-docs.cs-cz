...
ms.locfileid: "33090780"
---
# <a name="ccolumns-ccolumnsinfo"></a>CColumns, CColumnsInfo
Call – třída definice typedef **CColumns** k implementaci jeho – třída parametru **CColumnsInfo**.  
...
## <a name="remarks"></a>Poznámky  
 ...
 Následující tabulka uvádí členy třídy dat a jejich odpovídající OLE DB sloupce. V tématu [řádků sloupců](https://msdn.microsoft.com/en-us/library/ms723052.aspx) v *referenční příručka programátora technologie OLE DB* Další informace o schématu a sloupců.  
