...
ms.locfileid: "33098261"
---
# <a name="columnnamepsstatus"></a>COLUMN_NAME_PS_STATUS
Představuje vazbu na sadě řádků konkrétní sloupec v dané sadě řádků. Podobně jako [COLUMN_NAME](../../data/oledb/column-name.md)kromě toho, že tento makro také trvá přesnost, měřítko a sloupec Stav.  
