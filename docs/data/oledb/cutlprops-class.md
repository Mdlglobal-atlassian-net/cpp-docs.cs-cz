---
title: CUtlProps – třída | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
 ...
 *pDBProp*  
 ID vlastnosti a nová hodnota v [DBPROP](https://msdn.microsoft.com/library/ms717970.aspx) struktury.  
