...
Místech data zdroje podle uvolnění interním prostředkům, například podporu vlastnost objektu v neinicializovaném stavu.  
...
## <a name="remarks"></a>Poznámky  
 V tématu [IDBInitialize::Uninitialize](https://msdn.microsoft.com/en-us/library/ms719648.aspx) v *referenční příručka programátora prostředí OLE DB*.  
