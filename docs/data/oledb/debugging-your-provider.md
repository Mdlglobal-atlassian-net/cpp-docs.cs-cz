...
- Můžete použít různé nástroje, které jsou součástí Visual C++.

## <a name="to-use-debugging"></a>Chcete-li použít ladění

1. Otevřete projekt zprostředkovatele.

1. Na **projekty** nabídky, klikněte na tlačítko **vlastnosti**.

1. V **stránky vlastností** dialogové okno, klikněte na tlačítko **ladění** kartu.

1. Vyberte možnosti jako povinné, klikněte na tlačítko **OK**.
