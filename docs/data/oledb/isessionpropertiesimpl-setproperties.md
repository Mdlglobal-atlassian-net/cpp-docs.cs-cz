...
#### <a name="parameters"></a>Parametry  
 V tématu [ISessionProperties::SetProperties](https://msdn.microsoft.com/en-us/library/ms714405.aspx) v *referenční příručka programátora prostředí OLE DB*.  
