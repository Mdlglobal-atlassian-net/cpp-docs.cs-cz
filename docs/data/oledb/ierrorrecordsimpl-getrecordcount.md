...
Vrátí počet záznamů v objektu záznamů technologie OLE DB.  
...
#### <a name="parameters"></a>Parametry  
 V tématu [IErrorRecords::GetRecordCount](https://msdn.microsoft.com/en-us/library/ms722724.aspx) v *referenční příručka programátora prostředí OLE DB*.  
