...
-   [Příjem oznámení](../../data/oledb/receiving-notifications.md)  
 ...
 Příklad vytvoření a implementace příjemce technologie OLE DB, naleznete v části [vytvoření jednoduchého příjemce](../../data/oledb/creating-an-ole-db-consumer.md).  
