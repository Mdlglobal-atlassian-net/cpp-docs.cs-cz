...
#### <a name="parameters"></a>Parametry  
 V tématu [IAccessor::ReleaseAccessor](https://msdn.microsoft.com/en-us/library/ms719717.aspx) v *referenční příručka programátora prostředí OLE DB*.  
