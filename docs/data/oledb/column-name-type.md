...
ms.locfileid: "33091199"
---
# <a name="columnnametype"></a>COLUMN_NAME_TYPE
Představuje vazbu na sadě řádků konkrétní sloupec v dané sadě řádků. Podobně jako [COLUMN_NAME](../../data/oledb/column-name.md)kromě toho, že tento makro také trvá datového typu.  
