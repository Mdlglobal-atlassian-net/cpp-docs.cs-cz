---
title: IRowsetLocateImpl – třída | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "50059399"
---
# <a name="irowsetlocateimpl-class"></a>IRowsetLocateImpl – třída

Implementuje rozhraní OLE DB [IRowsetLocate](/previous-versions/windows/desktop/ms721190) rozhraní, která načte libovolné řádky ze sady řádků.
...
*BookmarkKeyType*<br/>
Typ záložky, jako je například DLOUHO nebo řetězec. Běžné záložky musí mít délku minimálně o dva bajty. (Single bajty délka je vyhrazený pro OLE DB [standardní záložky](/previous-versions/windows/desktop/ms712954)`DBBMK_FIRST`, `DBBMK_LAST`, a `DBBMK_INVALID`.)
...
Informace o implementaci podpora záložek, naleznete v tématu [podporu zprostředkovatele pro záložky](../../data/oledb/provider-support-for-bookmarks.md) v *průvodce Visual C++ programátor* a [záložky](/previous-versions/windows/desktop/ms709728) v *Referenční informace pro OLE DB programátory* v sadu SDK platformy.
...
Zobrazit [IRowsetLocate::Compare](/previous-versions/windows/desktop/ms709539) v *referenční informace pro OLE DB programátory*.

### <a name="remarks"></a>Poznámky

Některé z záložky může být standardní definované technologie OLE DB [standardní záložku](/previous-versions/windows/desktop/ms712954) (`DBBMK_FIRST`, `DBBMK_LAST`, nebo `DBBMK_INVALID`). Hodnota vrácená v `pComparison` označuje vztah mezi dvěma záložek:
...
Zobrazit [IRowsetLocate::GetRowsAt](/previous-versions/windows/desktop/ms723031) v *referenční informace pro OLE DB programátory*.

### <a name="remarks"></a>Poznámky

Chcete-li místo toho načtěte z pozice kurzoru, použijte [IRowset::GetRowsAt](/previous-versions/windows/desktop/ms723031).
...
*hReserved*<br/>
[in] Odpovídá *hChapter* parametr [IRowsetLocate::GetRowsByBookmark](/previous-versions/windows/desktop/ms725420).

Další parametry, naleznete v tématu [IRowsetLocate::GetRowsByBookmark](/previous-versions/windows/desktop/ms725420) v *OLE DB referenční informace pro programátory*.

### <a name="remarks"></a>Poznámky

Záložky lze hodnotu definujete nebo OLE DB [standardní záložky](/previous-versions/windows/desktop/ms712954) (`DBBMK_FIRST` nebo `DBBMK_LAST`). nedojde ke změně pozice kurzoru.
...
*hReserved*<br/>
[in] Odpovídá *hChapter* parametr [IRowsetLocate::Hash](/previous-versions/windows/desktop/ms709697).

Další parametry, naleznete v tématu [IRowsetLocate::Hash](/previous-versions/windows/desktop/ms709697) v *OLE DB referenční informace pro programátory*.
...
[Záložky](/previous-versions/windows/desktop/ms709728)