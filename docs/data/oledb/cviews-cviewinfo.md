...
Call – třída definice typedef **CViews** k implementaci jeho – třída parametru **CViewInfo**.  
...
## <a name="remarks"></a>Poznámky  
 ...
 Tato třída identifikuje tabulky v zobrazení tabulek, které jsou definované v katalogu a vlastníkem daného uživatele, jsou závislé.  
  
 Následující tabulka uvádí členy třídy dat a jejich odpovídající OLE DB sloupce. V tématu [zobrazení řádků](https://msdn.microsoft.com/en-us/library/ms723122.aspx) v *referenční příručka programátora technologie OLE DB* Další informace o schématu a sloupců.  
