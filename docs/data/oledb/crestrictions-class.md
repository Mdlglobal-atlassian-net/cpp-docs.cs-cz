...
Zobrazit [IDBSchemaRowset](https://docs.microsoft.com/previous-versions/windows/desktop/ms713686(v=vs.85)) informace o definovaných omezení na jednotlivých řádků schématu.
