...
#### <a name="parameters"></a>Parametry  
 V tématu [IRowset::ReleaseRows](https://msdn.microsoft.com/en-us/library/ms719771.aspx) v *referenční příručka programátora prostředí OLE DB*.  
