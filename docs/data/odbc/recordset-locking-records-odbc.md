...
2.  Při změně odpovídající pole z aktuální záznam.  
  
3.  Ukončení operace – a obvykle potvrďte aktualizaci – voláním [aktualizovat](../../mfc/reference/crecordset-class.md#update) členskou funkci.  
