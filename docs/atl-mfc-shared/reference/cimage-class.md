...
|[Služby CImage ve:: CreateEx](#createex)|Vytvoří rastrový obrázek oddílu DIB (s dalšími parametry) a připojí ho k dříve vytvořenému `CImage` objektu.|
|[Služby CImage ve::D estroy](#destroy)|Odpojí rastrový obrázek od `CImage` objektu a odstraní rastrový obrázek.|
|[Služby CImage ve::D etach](#detach)|Odpojí rastrový obrázek od `CImage` objektu.|
...
|[Služby CImage ve:: GetDC](#getdc)|Načte kontext zařízení, ve kterém je vybraný aktuální rastrový obrázek.|
|[Služby CImage ve:: GetExporterFilterString](#getexporterfilterstring)|Najde dostupné formáty obrázků a jejich popisy.|
|[Služby CImage ve:: GetHeight](#getheight)|Načte výšku aktuálního obrázku v pixelech.|
|[Služby CImage ve:: GetImporterFilterString](#getimporterfilterstring)|Najde dostupné formáty obrázků a jejich popisy.|
|[Služby CImage ve:: GetMaxColorTableEntries](#getmaxcolortableentries)|Načte maximální počet položek v tabulce barev.|
|[Služby CImage ve:: getrozteč](#getpitch)|Načte rozteč aktuálního obrázku v bajtech.|
|[Služby CImage ve:: GetPixel](#getpixel)|Načte barvu pixelu určenou *x* a *y*.|
...
|[Služby CImage ve:: IsDIBSection](#isdibsection)|Určuje, zda je připojen rastrový obrázek oddíl DIB.|
|[Služby CImage ve::-Indexed](#isindexed)|Označuje, že barvy rastrového obrázku jsou namapovány na indexovanou paletu.|
|[Služby CImage ve:: IsNull](#isnull)|Určuje, zda je zdrojová bitmapa momentálně načtena.|
...
|[Služby CImage ve:: SetPixelIndexed](#setpixelindexed)|Nastaví pixel na zadaných souřadnicích na barvu v zadaném indexu palety.|
|[Služby CImage ve:: SetPixelRGB](#setpixelrgb)|Nastaví pixel na zadaných souřadnicích na zadanou červenou, zelenou, modrou (RGB) hodnotu.|
...
> [!NOTE]
> V aplikaci Visual Studio .NET 2003 tato třída udržuje počet vytvořených `CImage` objektů. Pokaždé, když je počet převede na `GdiplusShutdown` 0, funkce je automaticky volána k uvolnění prostředků používaných rozhraním GDI+. Tím zajistíte, `CImage` že všechny objekty vytvořené přímo nebo nepřímo pomocí knihoven DLL jsou vždy zničeny správně a `GdiplusShutdown` které `DllMain`nejsou volány z.
...
Při použití `CImage` v projektu knihovny MFC si všimněte, které členské funkce v projektu očekávají ukazatel na objekt [CBitmap –](../../mfc/reference/cbitmap-class.md) . Pokud chcete `CImage` použít s takovou funkcí, jako je například [CMenu –:: AppendMenu](../../mfc/reference/cmenu-class.md#appendmenu), použijte [CBitmap –:: FromHandle](../../mfc/reference/cbitmap-class.md#fromhandle), předejte ji `CImage` HBITMAP a použijte vrácenou `CBitmap*`hodnotu.
...
## <a name="cimagealphablend"></a><a name="alphablend"></a>Služby CImage ve:: AlphaBlend
...
*bBlendOp*<br/>
Funkce rozkládání alfa pro zdrojové a cílové rastrové obrázky, globální hodnotu alfa, která se má použít pro celou zdrojovou bitmapu, a informace o formátu zdrojové bitmapy. Funkce Blendu zdroje a cíle jsou v současné době omezeny na AC_SRC_OVER.

*pointDest*<br/>
Odkaz na strukturu [bodu](/windows/win32/api/windef/ns-windef-point) , která identifikuje levý horní roh cílového obdélníku v logických jednotkách.
...
*rectDest*<br/>
Odkaz na strukturu [Rect](/windows/win32/api/windef/ns-windef-rect) , která identifikuje cíl.
...
## <a name="cimageattach"></a><a name="attach"></a>Služby CImage ve:: Attach
...
*eOrientation*<br/>
Určuje orientaci rastrového obrázku. Může to být jedna z následujících:
...
## <a name="cimagebitblt"></a><a name="bitblt"></a>Služby CImage ve:: BitBlt
...
*pointDest*<br/>
Struktura [bodu](/windows/win32/api/windef/ns-windef-point) označující levý horní roh cílového obdélníku.
...
*rectDest*<br/>
Struktura [Rect](/windows/win32/api/windef/ns-windef-rect) indikující cílový obdélník.
...
## <a name="cimagecimage"></a><a name="cimage"></a>Služby CImage ve:: služby CImage ve
...
**Poznámka:** V aplikaci Visual Studio Tato třída udržuje počet vytvořených `CImage` objektů. Pokaždé, když je počet převede na `GdiplusShutdown` 0, funkce je automaticky volána k uvolnění prostředků používaných rozhraním GDI+. Tím zajistíte, `CImage` že všechny objekty vytvořené přímo nebo nepřímo pomocí knihoven DLL jsou vždy zničeny správně a které `GdiplusShutdown` nejsou volány z DllMain.

Použití globálních `CImage` objektů v knihovně DLL se nedoporučuje. Pokud potřebujete použít globální `CImage` objekt v knihovně DLL, zavolejte [služby CImage ve:: ReleaseGDIPlus](#releasegdiplus) , aby byly explicitně vydány prostředky využívané rozhraním GDI+.

## <a name="cimagecreate"></a><a name="create"></a>Služby CImage ve:: Create

Vytvoří `CImage` rastrový obrázek a připojí ho k dříve vytvořenému `CImage` objektu.
...
## <a name="cimagecreateex"></a><a name="createex"></a>Služby CImage ve:: CreateEx
...
## <a name="cimagedestroy"></a><a name="destroy"></a>Služby CImage ve::D estroy
...
## <a name="cimagedetach"></a><a name="detach"></a>Služby CImage ve::D etach
...
## <a name="cimagedraw"></a><a name="draw"></a>Služby CImage ve: nezpracované:D
...
## <a name="cimagegetbits"></a><a name="getbits"></a>Služby CImage ve:: getbitů
...
## <a name="cimagegetbpp"></a><a name="getbpp"></a>Služby CImage ve:: GetBPP
...
Bity na pixel jsou obvykle 1, 4, 8, 16, 24 nebo 32. Další informace `biBitCount` o této hodnotě najdete v tématu věnovaném členu [BITMAPINFOHEADER](/windows/win32/api/wingdi/ns-wingdi-bitmapinfoheader) v Windows SDK.

## <a name="cimagegetcolortable"></a><a name="getcolortable"></a>Služby CImage ve:: GetColor – k
...
## <a name="cimagegetdc"></a><a name="getdc"></a>Služby CImage ve:: GetDC
...
## <a name="cimagegetexporterfilterstring"></a><a name="getexporterfilterstring"></a>Služby CImage ve:: GetExporterFilterString
...
Pokud předáte tento řetězec objektu knihovny MFC `CFileDialog` , použijte výchozí oddělovač ' &#124; '. Použijte oddělovač null \ 0, pokud tento řetězec předáte do dialogového okna společné uložení souboru.

## <a name="cimagegetheight"></a><a name="getheight"></a>Služby CImage ve:: GetHeight
...
## <a name="cimagegetimporterfilterstring"></a><a name="getimporterfilterstring"></a>Služby CImage ve:: GetImporterFilterString
...
Pokud předáte tento řetězec objektu knihovny MFC `CFileDialog` , použijte výchozí oddělovač ' &#124; '. Použijte oddělovač null \ 0, pokud tento řetězec předáte do dialogového okna společné **otevření souboru** .

## <a name="cimagegetmaxcolortableentries"></a><a name="getmaxcolortableentries"></a>Služby CImage ve:: GetMaxColorTableEntries
...
## <a name="cimagegetpitch"></a><a name="getpitch"></a>Služby CImage ve:: getrozteč
...
## <a name="cimagegetpixel"></a><a name="getpixel"></a>Služby CImage ve:: GetPixel
...
## <a name="cimagegetpixeladdress"></a><a name="getpixeladdress"></a>Služby CImage ve:: GetPixelAddress
...
## <a name="cimagegettransparentcolor"></a><a name="gettransparentcolor"></a>Služby CImage ve:: GetTransparentColor
...
## <a name="cimagegetwidth"></a><a name="getwidth"></a>Služby CImage ve:: getwidth
...
## <a name="cimageisdibsection"></a><a name="isdibsection"></a>Služby CImage ve:: IsDIBSection
...
## <a name="cimageisindexed"></a><a name="isindexed"></a>Služby CImage ve::-Indexed
...
## <a name="cimageisnull"></a><a name="isnull"></a>Služby CImage ve:: IsNull
...
## <a name="cimageistransparencysupported"></a><a name="istransparencysupported"></a>Služby CImage ve:: IsTransparencySupported
...
## <a name="cimageload"></a><a name="load"></a>Služby CImage ve:: Load
...
## <a name="cimageloadfromresource"></a><a name="loadfromresource"></a>Služby CImage ve:: LoadFromResource
...
## <a name="cimagemaskblt"></a><a name="maskblt"></a>Služby CImage ve:: MaskBlt
...
## <a name="cimageoperator-hbitmap"></a><a name="operator_hbitmap"></a>Služby CImage ve:: operator HBITMAP

Tento operátor použijte k získání připojené obslužné rutiny Windows GDI `CImage` objektu. Tento operátor je operátor přetypování, který podporuje přímé použití objektu HBITMAP.

## <a name="cimageplgblt"></a><a name="plgblt"></a>Služby CImage ve::P lgBlt
...
*rectSrc*<br/>
Odkaz na strukturu [Rect](/windows/win32/api/windef/ns-windef-rect) , která určuje souřadnice zdrojového obdélníku.

*pointMask*<br/>
Struktura [bodu](/windows/win32/api/windef/ns-windef-point) označující levý horní roh rastrového obrázku masky.
...
## <a name="cimagereleasedc"></a><a name="releasedc"></a>Služby CImage ve:: ReleaseDC
...
## <a name="cimagereleasegdiplus"></a><a name="releasegdiplus"></a>Služby CImage ve:: ReleaseGDIPlus
...
## <a name="cimagesave"></a><a name="save"></a>Služby CImage ve:: Save
...
*guidFileType*<br/>
Typ souboru, ve kterém má být obrázek uložen. Může to být jedna z následujících:
...
## <a name="cimagesetcolortable"></a><a name="setcolortable"></a>Služby CImage ve:: SetColorTable
...
## <a name="cimagesetpixel"></a><a name="setpixel"></a>Služby CImage ve:: funkce SetPixel
...
## <a name="cimagesetpixelindexed"></a><a name="setpixelindexed"></a>Služby CImage ve:: SetPixelIndexed
...
## <a name="cimagesetpixelrgb"></a><a name="setpixelrgb"></a>Služby CImage ve:: SetPixelRGB
...
## <a name="cimagesettransparentcolor"></a><a name="settransparentcolor"></a>Služby CImage ve:: SetTransparentColor
...
## <a name="cimagestretchblt"></a><a name="stretchblt"></a>Služby CImage ve:: StretchBlt
...
## <a name="cimagetransparentblt"></a><a name="transparentblt"></a>Služby CImage ve:: TransparentBlt
...
*crTransparent*<br/>
Barva ve zdrojové bitmapě, která má být považována za průhlednou. Ve výchozím nastavení CLR_INVALID, což značí, že se má použít barva aktuálně nastavená jako průhledná barva obrázku.
