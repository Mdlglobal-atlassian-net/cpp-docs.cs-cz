---
title: Přidání nebo odstranění prostředku řetězce (C++) | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "44314037"
---
# <a name="adding-or-deleting-a-string-resource-c"></a>Přidání nebo odstranění prostředku řetězce (C++)
