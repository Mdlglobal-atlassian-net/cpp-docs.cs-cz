...
Zobrazit [referenční třídy a struktury](../cppcx/ref-classes-and-structs-c-cx.md) a [hodnotové třídy a struktury](http://msdn.microsoft.com/library/windows/apps/hh699861.aspx).
