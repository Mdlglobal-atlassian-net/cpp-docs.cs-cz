---
title: Kreslení čar nebo uzavřených obrázků (Editor obrázků pro ikony) | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1. Na [panelu nástrojů editoru obrázků](../windows/toolbar-image-editor-for-icons.md) (nebo z **Image** nabídce **nástroje** příkaz), klikněte na tlačítko **řádku** nástroj.
...
3. Umístěte ukazatel myši na řádku počáteční bod.

4. Přetáhněte do koncového bodu čáry.

### <a name="to-draw-a-closed-figure"></a>Chcete-li nakreslit uzavřený útvar

1. Na **Editor obrázků** nástrojů (nebo z **Image** nabídce **nástroje** příkaz), klikněte na tlačítko **kreslení obrázku uzavřeno** nástroj.
...
3. Přesuňte ukazatel na jeden z rohů obdélníkovou oblast, ve kterém chcete nakreslit obrázek.

4. Přetažením ukazatele šikmo protilehlého rohu.
