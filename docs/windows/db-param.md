---
title: db_param – | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
**db_param –** se používá ve spojení s oběma [db_table](../windows/db-table.md) nebo [db_command](../windows/db-command.md) atributy.
