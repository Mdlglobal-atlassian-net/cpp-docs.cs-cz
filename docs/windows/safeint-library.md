...
ms.locfileid: "50561314"
---
# <a name="safeint-library"></a>SafeInt – knihovna

**SafeInt** knihovny pomáhá zabránit přetečení celého čísla, které může dojít při použití matematických operací. Nejnovější verzi této knihovny se nachází v [ https://github.com/dcleblanc/SafeInt ](https://github.com/dcleblanc/SafeInt).
