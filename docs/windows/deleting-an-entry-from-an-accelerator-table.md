---
title: Odstranění záznamu z tabulky akcelerátorů (C++) | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "44315116"
---
# <a name="deleting-an-entry-from-an-accelerator-table-c"></a>Odstranění záznamu z tabulky akcelerátorů (C++)
