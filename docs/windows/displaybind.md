---
title: displaybind | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
Podívejte se na příklad pro [umožňujících vazbu](../windows/bindable.md) příklad, jak používat **displaybind**.
