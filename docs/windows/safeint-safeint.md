...
### <a name="parameters"></a>Parametry  
 ...
 U  
 Typ dat uložených v **SafeInt**. To může být typu logická hodnota, znak nebo celé číslo. Pokud je typ integer, může být podepsané nebo nepodepsané a mít délku 8 až 64 bitů.  
