---
title: SafeIntException – třída | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33895772"
---
# <a name="safeintexception-class"></a>SafeIntException – třída
`SafeInt` Třídy používá `SafeIntException` Chcete-li určit, proč matematickém operaci nelze dokončit.  
