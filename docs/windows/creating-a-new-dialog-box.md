...
1. V [zobrazení prostředků](/windows/how-to-create-a-resource-script-file#create-resources), klikněte pravým tlačítkem na váš *.rc* a vyberte možnost **přidat prostředek**.
