...
První konstruktor je výchozí konstruktor, který vkládacím vytvoří prázdný objekt. Druhý konstruktor Určuje [__nullptr](../nullptr-cpp-component-extensions.md), které explicitně vytvoří prázdný objekt.
