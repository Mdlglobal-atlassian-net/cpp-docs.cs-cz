---
title: Dialogové okno nástroje text (C++) (Editor obrázků pro ikony) | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "44313441"
---
# <a name="text-tool-dialog-box-c-image-editor-for-icons"></a>Dialogové okno nástroje text (C++) (Editor obrázků pro ikony)
...
Otevře [dialogové okno písmo textového nástroje](../windows/text-tool-font-dialog-box-image-editor-for-icons.md), ve kterém můžete změnit písmo, styl nebo velikost písma kurzoru. Změny se použijí pro text zobrazený v **Text** oblasti.
