---
title: Zarovnání ovládacích prvků v dialogovém okně (C++)
ms.date: 11/04/2016
helpviewer_keywords:
- controls [C++], aligning
...
ms.locfileid: "50537512"
---
# <a name="centering-controls-in-a-dialog-box-c"></a>Zarovnání ovládacích prvků v dialogovém okně (C++)
