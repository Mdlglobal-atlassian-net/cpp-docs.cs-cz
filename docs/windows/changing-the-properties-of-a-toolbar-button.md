---
title: "Změna vlastností tlačítka panelu nástrojů | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="changing-the-properties-of-a-toolbar-button"></a>Změna vlastností tlačítka panelu nástrojů
...
2.  Zadejte nové ID v **ID** vlastnost [vlastnosti – okno](/visualstudio/ide/reference/properties-window), nebo pomocí rozevíracího seznamu vyberte novou **ID**.  
