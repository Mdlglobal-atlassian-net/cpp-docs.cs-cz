---
title: Otevření editoru prostředků pro daný Symbol (C++) | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "46385479"
---
# <a name="opening-the-resource-editor-for-a-given-symbol-c"></a>Otevření editoru prostředků pro daný Symbol (C++)
...
2. V **používá** , vyberte typ prostředku, který vás zajímá.

3. Klikněte na tlačítko **zobrazit použití** tlačítko.
