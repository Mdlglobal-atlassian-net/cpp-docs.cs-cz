---
title: Odstranění tlačítka panelu nástrojů (C++) | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "44318051"
---
# <a name="deleting-a-toolbar-button-c"></a>Odstranění tlačítka panelu nástrojů (C++)
