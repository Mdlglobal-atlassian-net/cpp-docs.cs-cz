---
title: "Přidání více ovládacích prvků | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
1.  Stiskněte **CTRL** klíče, vyberte ovládací prvek v [okno sady nástrojů](/visualstudio/ide/reference/toolbox).  
  
2.  Verze **CTRL** klíče a kliknutím na dialogové tolikrát, kolikrát chcete přidat konkrétní ovládací prvek.  
  
3.  Stiskněte klávesu **ESC** zastavit umístění ovládacích prvků.  
