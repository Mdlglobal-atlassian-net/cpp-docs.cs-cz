...
ms.locfileid: "59026393"
---
# <a name="array-attributes"></a>Atributy pole

Následující atributy se vztahují na pole nebo `SAFEARRAY`s.
...
|[odkazy řetězců](string-cpp.md)|Označuje, že jednorozměrné pole **char**, **wchar_t**, `byte` (nebo obdobných) pole nebo ukazatel na takové pole musí být považované za řetězec.|
