---
title: Panel nástrojů (C++ Editor obrázků pro ikony) | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
[Zobrazení nebo skrytí panelu nástrojů](displaying-or-hiding-the-toolbar-image-editor-for-icons.md)<br/>
