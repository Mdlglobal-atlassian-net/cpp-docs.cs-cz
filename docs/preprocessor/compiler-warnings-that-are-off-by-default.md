...
| [C4191](../error-messages/compiler-warnings/compiler-warning-level-3-c4191.md) (úroveň 3)|'*Operator*': nezabezpečený převod z '*type_of_expression*' na '*type_required*'|
...
|[C4264](../error-messages/compiler-warnings/compiler-warning-level-1-c4264.md) (úroveň 1)|'*virtual_function*': není k dispozici žádné přepsání pro virtuální členskou funkci ze základní*třídy ' class*'; funkce je skrytá.|
...
|[C4437](../error-messages/compiler-warnings/compiler-warning-level-4-c4437.md) (úroveň 4)|v některých kontextech může selhat dynamic_cast z virtuální základní třídy*Class1*na*Class2*.|
...
|[C4746](../error-messages/compiler-warnings/compiler-warning-c4746.md)|nestálý přístup k*výrazu*podléhá/volatile:\<iso&#124;MS > nastavení; Zvažte použití vnitřních funkcí __iso_volatile_load/Store|
...
|[C4820](../error-messages/compiler-warnings/compiler-warning-level-4-c4820.md) (úroveň 4)|odsazení*bajtů v*bajtech přidané po sestavení '*MEMBER_NAME*'|
...
|[C4868](../error-messages/compiler-warnings/compiler-warning-c4868.md) (úroveň 4)|kompilátor_File_(*Line_Number*) nemůže v seznamu inicializace v závorkách vyhovět pořadí vyhodnocování zleva doprava.|
