---
title: Tabulka shody jazyka Microsoft C++
...
ms.locfileid: "83630465"
---
# <a name="microsoft-c-language-conformance-table"></a>Tabulka shody jazyka Microsoft C++

Soulad s normami pro kompilátor Microsoft C++ v aplikaci Visual Studio (MSVC) je Nedokončená práce. Zde je souhrn našeho jazyka ISO standard C++ a shody knihoven podle verze sady Visual Studio. Každý kompilátor a název funkce standardní knihovny odkazují na dokument návrhu ISO standard C++, který popisuje funkci, pokud je k dispozici v době publikování. Ve sloupci **podporováno** se zobrazí verze sady Visual Studio, ve které se poprvé zobrazuje podpora funkce.

Podrobnosti o vylepšeních dodržování MSVC sady Visual Studio 2017 nebo Visual Studio 2019 najdete v tématu [vylepšení shody C++ v aplikaci Visual Studio](cpp-conformance-improvements.md). Seznam dalších změn naleznete v tématu [co je nového pro Visual C++ v aplikaci Visual Studio](what-s-new-for-visual-cpp-in-visual-studio.md). Změny shody v dřívějších verzích najdete v článku [Visual C++ historii změn](../porting/visual-cpp-change-history-2003-2015.md) a [Visual C++ novinky 2003 až 2015](../porting/visual-cpp-what-s-new-2003-through-2015.md). Aktuální novinky od týmu C++ najdete na [blogu týmu c++](https://devblogs.microsoft.com/cppblog/).

> [!NOTE]
> Mezi Visual Studio 2015, Visual Studio 2017 a Visual Studio 2019 neexistují žádné binární změny. Další informace naleznete v tématu [binární kompatibilita C++ mezi Visual Studio 2015, 2017 a 2019](../porting/binary-compat-2015-2017.md) .
...
| &nbsp;&nbsp;[`N1653 C99 preprocessor`](https://wg21.link/N1653) | Částečný <sup> [C](#note_C)</sup> |
...
| &nbsp;&nbsp;[`P0929R2 Checking for abstract class types`](https://wg21.link/P0929R2) | Ne |
| &nbsp;&nbsp;[`P0962R2 Relaxing the range-for loop customization point finding rules`](https://wg21.link/p0962r1) | Ne |
| &nbsp;&nbsp;[`P0859R0 CWG 1581: When are constexpr member functions defined`](https://wg21.link/p0859r0) | Ne |
| &nbsp;&nbsp;[`P1009R2 Array size deduction in new-expressions`](https://wg21.link/P1009R2) | Ne |
...
| &nbsp;&nbsp;[`P0641R2 const mismatch with defaulted copy constructor`](https://wg21.link/P0641R2) | Částečné |
| &nbsp;&nbsp;[`P0912R5 Coroutines`](https://wg21.link/P0912R5) | Částečné |
| &nbsp;&nbsp;[`P1103R3 Modules`](https://wg21.link/P1103R3) | Částečné |
| &nbsp;&nbsp;[`P1141R2 Yet another approach for constrained declarations`](https://wg21.link/P1141R2) | Částečné |
| &nbsp;&nbsp;[`P0315R4 Allowing lambdas in unevaluated contexts`](https://wg21.link/P0315R4) | Ne |
| &nbsp;&nbsp;[`P0388R4 Permit conversions to arrays of unknown bound`](https://wg21.link/P0388R4) | Ne |
| &nbsp;&nbsp;[`P0466R5 Layout-compatibility and Pointer-interconvertibility Traits`](https://wg21.link/P0466R5) | Ne |
| &nbsp;&nbsp;[`P0634R3 Down with typename!`](https://wg21.link/P0634R3) | Ne |
| &nbsp;&nbsp;[`P0722R3 Efficient sized delete for variable sized classes`](https://wg21.link/P0722R3) | Ne |
| &nbsp;&nbsp;[`P0735R1 Interaction of memory_order_consume with release sequences`](https://wg21.link/P0735R1) | Ne |
| &nbsp;&nbsp;[`P0784R7 More constexpr containers`](https://wg21.link/P0784R7) | Ne |
| &nbsp;&nbsp;[`P0840R2 [[no_unique_address]] attribute`](https://wg21.link/P0840R2) | Ne |
| &nbsp;&nbsp;[`P0848R3 Conditionally trivial special member functions`](https://wg21.link/P0848R3) | Ne |
| &nbsp;&nbsp;[`P0960R3 Allow initializing aggregates from a parenthesized list of values`](https://wg21.link/P0960R3) | Ne |
| &nbsp;&nbsp;[`P1064R0 Allowing virtual function calls in constant expressions`](https://wg21.link/P1064R0) | Ne |
| &nbsp;&nbsp;[`P1073R3 Immediate functions`](https://wg21.link/P1073R3) | Ne |
| &nbsp;&nbsp;[`P1094R2 Nested inline namespaces`](https://wg21.link/P1094R2) | Ne |
| &nbsp;&nbsp;[`P1143R2 constinit`](https://wg21.link/P1143R2) | Ne |
| &nbsp;&nbsp;[`P1152R4 Deprecating volatile`](https://wg21.link/P1152R4) | Ne |
| &nbsp;&nbsp;[`P1236R1 Signed integers are two's complement`](https://wg21.link/P1236R1) | Ne |
| &nbsp;&nbsp;[`P1327R1 Allowing dynamic_cast, polymorphic typeid in constant expressions`](https://wg21.link/P1327R1) | Ne |
| &nbsp;&nbsp;[`P1331R2 Permitting trivial default initialization in constexpr contexts`](https://wg21.link/P1331R2) | Ne |
| &nbsp;&nbsp;[`P1353R0 Missing feature-test macros`](https://wg21.link/P1353R0) | Ne |
| &nbsp;&nbsp;[`P1358R0 2310: Type completeness and derived-to-base pointer conversions`](https://wg21.link/P1358R0) | Ne |
| &nbsp;&nbsp;[`P1381R1 Reference capture of structured bindings`](https://wg21.link/P1381R1) | Ne |
| &nbsp;&nbsp;[`P1452R2 On the non-uniform semantics of return-type-requirements`](https://wg21.link/P1452R2) | Ne |
| &nbsp;&nbsp;[`P1616R1 Using unconstrained TTPs with constrained templates`](https://wg21.link/P1616R1) | Ne |
| &nbsp;&nbsp;[`P1668R1 Permitting unevaluated inline assembly in constexpr functions`](https://wg21.link/P1668R1) | Ne |
| &nbsp;&nbsp;[`P1766R1 Mitigating minor modules maladies`](https://wg21.link/P1766R1) | Ne |
| &nbsp;&nbsp;[`P1811R0 Relaxing redefinition restrictions for re-exportation robustness`](https://wg21.link/P1811R0) | Ne |
| &nbsp;&nbsp;[`P1814R0 CTAD for alias templates`](https://wg21.link/P1814R0) | Ne |
| &nbsp;&nbsp;[`P1816R0 CTAD for aggregates`](https://wg21.link/P1816R0) | Ne |
| &nbsp;&nbsp;[`P1874R1 Dynamic Initialization Order of Non-Local Variables in Modules`](https://wg21.link/P1874R1) | Ne |
| &nbsp;&nbsp;[`P1971R0 Core Changes for NB Comments at the Nov 2019 (Belfast) meeting`](https://wg21.link/P1971R0) | Ne |
| &nbsp;&nbsp;[`P1971R0 US052: Non-executed return statements in coroutines`](https://wg21.link/P1971R0) | Ne |
| &nbsp;&nbsp;[`P1972R0 US105 Check satisfaction of constraints for non-templates when forming pointer to function`](https://wg21.link/P1972R0) | Ne |
| &nbsp;&nbsp;[`P1975R0 Fixing the wording of parenthesized aggregate-initialization`](https://wg21.link/P1975R0) | Ne |
| &nbsp;&nbsp;[`P1979R0 Resolution to US086`](https://wg21.link/P1979R0) | Ne |
| &nbsp;&nbsp;[`P1980R0 CA096: Declaration matching for non-dependent requires-clauses`](https://wg21.link/P1980R0) | Ne |
| &nbsp;&nbsp;[`P2085R0 Consistent defaulted comparisons`](https://wg21.link/P2085R0) | Ne |
| &nbsp;&nbsp;[`P2103R0 US033: Allow "import" inside linkage-specifications`](https://wg21.link/P2103R0) | Ne |
| &nbsp;&nbsp;[`P2107R0 US064: Copy semantics of coroutine parameters`](https://wg21.link/P2107R0) | Ne |
...
| &nbsp;&nbsp;[`P0053R7 <syncstream>`](https://wg21.link/p0053r7)<br/>&nbsp;&nbsp;[`P0753R2 osyncstream Manipulators`](https://wg21.link/p0753r2) | Ne |
| &nbsp;&nbsp;[`P0339R6 polymorphic_allocator<>`](https://wg21.link/P0339R6) | Ne |
| &nbsp;&nbsp;[`P0355R7 <chrono> Calendars And Time Zones`](https://wg21.link/p0355r7) | Ne |
| &nbsp;&nbsp;[`P0415R1 constexpr For <complex> (Again)`](https://wg21.link/p0415r1) | Ne |
| &nbsp;&nbsp;[`P0475R1 Guaranteed Copy Elision For Piecewise Construction`](https://wg21.link/P0475R1) | Ne |
| &nbsp;&nbsp;[`P0476R2 <bit> bit_cast`](https://wg21.link/P0476R2) | Ne |
| &nbsp;&nbsp;[`P0528R3 Atomic Compare-And-Exchange With Padding Bits`](https://wg21.link/P0528R3) | Ne |
| &nbsp;&nbsp;[`P0591R4 Utility Functions For Uses-Allocator Construction`](https://wg21.link/P0591R4) | Ne |
| &nbsp;&nbsp;[`P0608R3 Improving variant's Converting Constructor/Assignment`](https://wg21.link/P0608R3) | Ne |
| &nbsp;&nbsp;[`P0653R2 to_address()`](https://wg21.link/p0653r2) | Ne |
| &nbsp;&nbsp;[`P0655R1 visit<R>()`](https://wg21.link/P0655R1) | Ne |
| &nbsp;&nbsp;[`P0674R1 make_shared() For Arrays`](https://wg21.link/p0674r1) | Ne |
| &nbsp;&nbsp;[`P0718R2 atomic<shared_ptr<T>>, atomic<weak_ptr<T>>`](https://wg21.link/p0718r2) | Ne |
| &nbsp;&nbsp;[`P0768R1 Library Support For The Spaceship Comparison Operator <=>`](https://wg21.link/p0768r1) | Ne |
| &nbsp;&nbsp;[`P0811R3 midpoint(), lerp()`](https://wg21.link/P0811R3) | Ne |
| &nbsp;&nbsp;[`P0896R4 <ranges\>`](https://wg21.link/P0896R4) | Ne |
| &nbsp;&nbsp;[`P0912R5 Library Support For Coroutines`](https://wg21.link/P0912R5) | Ne |
| &nbsp;&nbsp;[`P0920R2 Precalculated Hash Value Lookup`](https://wg21.link/P0920R2) | Ne |
| &nbsp;&nbsp;[`P1001R2 execution::unseq`](https://wg21.link/P1001R2) | Ne |
| &nbsp;&nbsp;[`P1007R3 assume_aligned()`](https://wg21.link/P1007R3) | Ne |
| &nbsp;&nbsp;[`P1020R1 Smart Pointer Creation With Default Initialization`](https://wg21.link/P1020R1) | Ne |
| &nbsp;&nbsp;[`P1023R0 constexpr For std::array Comparisons`](https://wg21.link/P1023R0) | Ne |
| &nbsp;&nbsp;[`P1032R1 Miscellaneous constexpr`](https://wg21.link/P1032R1) | Ne |
| &nbsp;&nbsp;[`P1285R0 Improving Completeness Requirements For Type Traits`](https://wg21.link/P1285R0) | Ne |
...
| &nbsp;&nbsp;[`N4190 Removing auto_ptr, random_shuffle(), And Old <functional> Stuff`](https://wg21.link/n4190) | VS 2015 <sup> [Zbýv](#note_rem)</sup> |
...
| &nbsp;&nbsp;[`P0003R5 Removing Dynamic Exception Specifications`](https://wg21.link/p0003r5) | VS 2017 15,5 <sup> [17](#note_17)</sup> |
| &nbsp;&nbsp;[`P0004R1 Removing Deprecated Iostreams Aliases`](https://wg21.link/p0004r1) | VS 2015,2 <sup> [Zbýv](#note_rem)</sup> |
...
__VS 2019 16,6__ označuje funkce podporované v sadě Visual Studio 2019 verze 16,6.

### <a name="notes"></a>Poznámky

<a name="note_A"></a>__V__ [`/std:c++14`](../build/reference/std-specify-language-standard-version.md) režimu jsou dynamické specifikace výjimek nadále neimplementovány a `throw()` jsou stále považovány za synonymum pro `__declspec(nothrow)` . V jazyce C++ 17 byly specifikace dynamických výjimek většinou odebrané pomocí P0003R5, přičemž jeden vestige: `throw()` je zastaralý a musí se chovat jako synonymum pro `noexcept` . V [`/std:c++17`](../build/reference/std-specify-language-standard-version.md) režimu MSVC nyní odpovídá standardu tím `throw()` , že poskytuje stejné chování jako `noexcept` , to znamená vynucování prostřednictvím ukončení.

Možnost kompilátoru [`/Zc:noexceptTypes`](../build/reference/zc-noexcepttypes.md) požaduje naše staré chování `__declspec(nothrow)` . Pravděpodobně `throw()` bude odstraněn v c++ 20. Pro usnadnění migrace kódu v reakci na tyto změny v rámci Standard a naší implementace byly do a přidány upozornění nového kompilátoru pro chyby specifikace výjimky [`/std:c++17`](../build/reference/std-specify-language-standard-version.md) [`/permissive-`](../build/reference/permissive-standards-conformance.md) .

<a name="note_B"></a>__B__ v režimu podporovaném [`/permissive-`](../build/reference/permissive-standards-conformance.md) v aplikaci Visual Studio 2017 verze 15,7. Další informace najdete v článku [Podpora vyhledávání názvů se dvěma fázemi se dodává do MSVC](https://devblogs.microsoft.com/cppblog/two-phase-name-lookup-support-comes-to-msvc/).
...
<a name="note_D"></a>__D__ je podporován v rámci [`/std:c++14`](../build/reference/std-specify-language-standard-version.md) s Suppressible upozorněním [`C4984`](../error-messages/compiler-warnings/compiler-warning-c4984.md) .

<a name="note_E"></a>__Jedná se__ o zcela novou implementaci, která je nekompatibilní s předchozí `std::experimental` verzí, kterou vyžaduje podpora symlink, opravy chyb a změny v chování vyžadovaném standardem. V současné době, včetně \< systému souborů> poskytuje nové `std::filesystem` a předchozí `std::experimental::filesystem` , včetně \< experimentální/FileSystem> poskytuje pouze starou experimentální implementaci. Experimentální implementace bude ODEBRÁNA v další vydaných vydáních knihovny ABI.

<a name="note_G"></a>__G__ podporované vnitřním kompilátorem

<a name="note_14"></a>__14__ tyto funkce c++ 17 a 20 jsou vždycky povolené, i když [`/std:c++14`](../build/reference/std-specify-language-standard-version.md) je zadaná (výchozí). Důvodem je, že funkce byla implementována před zavedením možností **/STD** nebo vzhledem k tomu, že podmíněná implementace byla nepřáníně složitá.

<a name="note_17"></a>__17__ tyto funkce jsou povoleny pomocí [`/std:c++17`](../build/reference/std-specify-language-standard-version.md) [`/std:c++latest`](../build/reference/std-specify-language-standard-version.md) Možnosti kompilátoru (nebo).

<a name="note_20"></a>__20__ tyto funkce jsou povolené [`/std:c++latest`](../build/reference/std-specify-language-standard-version.md) možností kompilátoru. Po dokončení implementace C++ 20 bude přidána nová možnost kompilátoru **/std: c++ 20** , v rámci které budou tyto funkce také k dispozici.

<a name="note_byte"></a>__bajt__ `std::byte` je povolená nástrojem [`/std:c++17`](../build/reference/std-specify-language-standard-version.md) (nebo [`/std:c++latest`](../build/reference/std-specify-language-standard-version.md) ), ale protože může v některých případech kolidovat s hlavičkou Windows SDK, má jemně odstupňované makro. Může být zakázáno definováním `_HAS_STD_BYTE` as `0` .

<a name="note_C11"></a>__C11__ Univerzální CRT implementoval součásti C11 standardní knihovny, které jsou vyžadovány v C++ 17, s výjimkou `strftime()` alternativních specifikátorů převodu C99 E/O, C11 `fopen()` exkluzivního režimu a C11 `aligned_alloc()` . Druhý z nich není pravděpodobně implementován, protože C11 určený `aligned_alloc()` způsobem, který je nekompatibilní s implementací společnosti Microsoft `free()` : konkrétně, která `free()` musí být schopna zpracovat vysoce zarovnané přidělení.

<a name="note_rem"></a>__rem__ Funkce odebrané při [`/std:c++17`](../build/reference/std-specify-language-standard-version.md) [`/std:c++latest`](../build/reference/std-specify-language-standard-version.md) Určení možnosti kompilátoru (nebo). Tyto funkce se dají znovu povolit, aby se usnadnil přechod na novější jazykové režimy pomocí těchto maker: `_HAS_AUTO_PTR_ETC` , `_HAS_FUNCTION_ALLOCATOR_SUPPORT` , `_HAS_OLD_IOSTREAMS_MEMBERS` a `_HAS_UNEXPECTED` .

<a name="note_charconv"></a>__charconv__ `from_chars()` a `to_chars()` jsou k dispozici pro celá čísla. Časová osa pro plovoucí desetinnou čárku a plovoucí desetinnou čárku `from_chars()` `to_chars()` je následující:

- VS 2017 15,7: integer `from_chars()` a `to_chars()` .
- VS 2017 15,8: plovoucí desetinná `from_chars()` čárka
- VS 2017 15,9: přetížení s plovoucí desetinnou čárkou `to_chars()` pro nejkratší desetinné číslo.
- VS 2019 16,0: přetížení s plovoucí desetinnou čárkou `to_chars()` pro nejkratší hexadecimální a přesnost Hex.
- VS 2019 16,2: přetížení s plovoucí desetinnou čárkou `to_chars()` pro pevnou přesnost a vědeckou přesnost.
- VS 2019 16,4: přetížení plovoucí desetinné čárky `to_chars()` pro přesnost na úrovni Obecné.

<a name ="note_parallel"></a>__paralelní__ Knihovna paralelních algoritmů c++ 17 je dokončená. Hodnota dokončit neznamená, že každý algoritmus je v každém případě paralelně paralelní. Nejdůležitější algoritmy byly paralelní a signatury zásad spouštění jsou k dispozici i v případě, že se algoritmy neparalelismuují. Hlavní interní hlavička naší implementace yvals_core. h obsahuje následující "poznámky o paralelních algoritmech": jazyk C++ umožňuje implementaci paralelních algoritmů jako volání na sériové algoritmy. Tato implementace parallelizes několik běžných volání algoritmů, ale ne všechny.
...
[Vylepšení shody C++ v aplikaci Visual Studio](cpp-conformance-improvements.md)\
[Co je nového pro Visual C++ v aplikaci Visual Studio](what-s-new-for-visual-cpp-in-visual-studio.md)\
[Visual C++ historii změn 2003 až 2015](../porting/visual-cpp-change-history-2003-2015.md)\
