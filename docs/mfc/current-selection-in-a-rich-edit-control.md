...
Můžete vyhledat řetězec v ovládacím prvku Rich Edit pomocí členské funkce [hledán FindText](../mfc/reference/cricheditctrl-class.md#findtext) , kterou struktura [FINDTEXTEX](/windows/win32/api/richedit/ns-richedit-findtextexw) použitá s touto funkcí určuje rozsah textu, který se má hledat, a řetězec, který chcete vyhledat. Můžete také zadat takové možnosti, jako by hledání rozlišuje velká a malá písmena.
