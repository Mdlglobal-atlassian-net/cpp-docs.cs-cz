---
title: 'MFC – ovládací prvky ActiveX: Vykreslování ovládacího prvku ActiveX | Dokumentace Microsoftu'
ms.custom: ''
ms.date: 09/12/2018
ms.technology:
- cpp-mfc
...
##  <a name="_core_the_painting_process_of_an_activex_control"></a> Proces vykreslování ovládacího prvku ActiveX  
 Když – ovládací prvky ActiveX jsou primárně zobrazen nebo se měl překreslit, řídí se podobně jako ostatní aplikace vyvinuté pomocí knihovny MFC, jeden zásadním Malování proces: ovládací prvky ActiveX může být aktivní nebo neaktivní stav.  
...
2.  V **vložte nový ovládací prvek** pole, vyberte ovládací prvek a klikněte na tlačítko **OK**.  
  
     Ovládací prvek se zobrazí v kontejneru testů.  
  
3.  Na **ovládací prvek** nabídky, klikněte na tlačítko **nakreslit metasoubor**.  
