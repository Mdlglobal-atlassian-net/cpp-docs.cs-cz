...
### [Výjimky: Zachytávání a odstraňování výjimek](exceptions-catching-and-deleting-exceptions.md)
...
### [Výjimky: OLE – výjimky](exceptions-ole-exceptions.md)
...
### [Správa paměti: Přidělení rámce](memory-management-frame-allocation.md)
### [Správa paměti: Velikost haldy](memory-management-heap-allocation.md)
...
#### [Příklad zahrnutí aktivního dokumentu: Pořadač Office](example-of-active-document-containment-office-binder.md)
...
##### [Automatizační servery: Problémy životnosti objektů](automation-servers-object-lifetime-issues.md)
...
#### [OLE – pozadí: Implementace v prostředí MFC](ole-background-mfc-implementation.md)
...
#### [Kontejnery: Rozšířené funkce](containers-advanced-features.md)
...
#### [Přetažení: Implementace zdroje přetažení](drag-and-drop-implementing-a-drop-source.md)
...
#### [Nabídky a prostředky: Slučování nabídek](menus-and-resources-menu-merging.md)
...
#### [Servery: Implementace místních oken rámců](servers-implementing-in-place-frame-windows.md)
...
### [Serializace: Serializace a zpracování databázového vstupu a výstupu](serialization-serialization-vs-database-input-output.md)
...
##### [MFC – ovládací prvky ActiveX: Přidání vlastních vlastností](mfc-activex-controls-adding-custom-properties.md)
...
##### [MFC – ovládací prvky ActiveX: Licencování ovládacího prvku ActiveX](mfc-activex-controls-licensing-an-activex-control.md)
...
##### [MFC – ovládací prvky ActiveX: Vytvoření podtřídy ovládacího prvku Windows](mfc-activex-controls-subclassing-a-windows-control.md)
...
##### [Kontejnery ovládacích prvků ActiveX: Ruční povolení uzavření ovládacího prvku ActiveX](activex-control-containers-manually-enabling-activex-control-containment.md)
##### [Kontejnery ovládacích prvků ActiveX: Vložení ovládacího prvku do kontejnerové aplikace ovládacího prvku](inserting-a-control-into-a-control-container-application.md)
...
##### [Kontejnery ovládacích prvků ActiveX: Ošetření událostí ovládacího prvku ActiveX](activex-control-containers-handling-events-from-an-activex-control.md)
##### [Kontejnery ovládacích prvků ActiveX: Zobrazení a úpravy vlastností ovládacích prvků](activex-control-containers-viewing-and-modifying-control-properties.md)
##### [Kontejnery ovládacích prvků ActiveX: Programování ovládacích prvků ActiveX v kontejneru ovládacího prvku ActiveX](programming-activex-controls-in-a-activex-control-container.md)
##### [Kontejnery ovládacích prvků ActiveX: Použití ovládacích prvků v kontejneru bez dialogových oken](activex-control-containers-using-controls-in-a-non-dialog-container.md)
...
#### [Schránka: Použití schránky Windows](clipboard-using-the-windows-clipboard.md)
...
#### [Příklad: Zobrazení dialogového okna pomocí příkazu nabídky](example-displaying-a-dialog-box-via-a-menu-command.md)
...
#### [Postupy: Načtení prostředku pásu karet z aplikace knihovny MFC](how-to-load-a-ribbon-resource-from-an-mfc-application.md)
#### [Návod: Vytvoření jednoduché aplikace pásu karet pomocí knihovny MFC](walkthrough-creating-a-ribbon-application-by-using-mfc.md)
...
#### [Windows Sockets: Podrobnosti](windows-sockets-background.md)
#### [Windows Sockets: Sokety datového proudu](windows-sockets-stream-sockets.md)
#### [Windows Sockets: Sokety datagramu](windows-sockets-datagram-sockets.md)
...
## [TN017: Likvidace objektů oken](tn017-destroying-window-objects.md)
...
## [TN029: Okna s rozdělovačem](tn029-splitter-windows.md)
## [TN030: Přizpůsobení tisku a náhledu před tiskem](tn030-customizing-printing-and-print-preview.md)
## [TN031: Ovládací panely](tn031-control-bars.md)
## [TN032: Mechanismus výjimek MFC](tn032-mfc-exception-mechanism.md)
## [TN033: DLL verze knihovny MFC](tn033-dll-version-of-mfc.md)
## [TN035: Použití více zdrojových souborů a hlavičkových souborů v jazyce Visual C++](tn035-using-multiple-resource-files-and-header-files-with-visual-cpp.md)
...
## [TN064: Práce s vlákny podle modelu apartment v ovládacích prvcích ActiveX](tn064-apartment-model-threading-in-activex-controls.md)
