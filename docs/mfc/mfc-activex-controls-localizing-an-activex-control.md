---
title: 'MFC – ovládací prvky ActiveX: Lokalizace ovládacího prvku ActiveX | Dokumentace Microsoftu'
ms.custom: ''
ms.date: 09/12/2018
ms.technology:
- cpp-mfc
...
2.  V případě potřeby vyberte jednotku a adresář, chcete-li zobrazit.  
  
3.  V **soubory typu** vyberte **všechny soubory (\*.\*)** .  
  
4.  V seznamu souboru dvakrát klikněte. Soubor IDL, který chcete vložit do projektu.  
  
5.  Klikněte na tlačítko **otevřít** když jste přidali všechny nezbytné. Soubory IDL.  
