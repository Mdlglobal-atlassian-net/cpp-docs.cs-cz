---
title: 'Snímače: Implementace snímačů ve vašich aplikacích OLE'
ms.date: 11/04/2016
helpviewer_keywords:
- trackers [MFC]
...
Tento článek obsahuje také použití styly s snímače. Kromě toho je několik odkazů na ukázky MFC OLE [OCLIENT](../overview/visual-cpp-samples.md).
