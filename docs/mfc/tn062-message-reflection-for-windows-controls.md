---
title: 'TN062: Reflexe zprávy pro ovládací prvky Windows'
ms.date: 06/28/2018
f1_keywords:
...
## <a name="handling-reflected-messages-an-example-of-a-reusable-control"></a>Zpracování Reflektovaných zpráv: Příklad opakovaně použitelné ovládací prvek
