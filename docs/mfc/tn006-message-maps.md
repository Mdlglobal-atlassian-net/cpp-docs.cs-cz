...
-   Soukromé pole `AFX_MSGMAP_ENTRY` položky názvem `_messageEntries`.  
  
-   S chráněným `AFX_MSGMAP` strukturu s názvem `messageMap` odkazující `_messageEntries` pole.  
