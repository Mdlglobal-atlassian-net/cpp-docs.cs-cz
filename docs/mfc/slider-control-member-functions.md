...
Aplikace může volat jezdec členské funkce ovládacího prvku k načtení informací o ovládacího prvku jezdec ([CSliderCtrl](../mfc/reference/csliderctrl-class.md)) a chcete-li změnit jeho vlastnosti.  
 ...
 Aplikace můžete použít styl TBS_AUTOTICKS tak, aby měl osové značky ovládacího prvku posuvník nezobrazí automaticky. Pokud aplikace potřebuje k řízení polohy nebo četnost značek, ale počet členské funkce můžete použít.  
