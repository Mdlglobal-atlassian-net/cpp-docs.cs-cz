---
title: 'MFC – ovládací prvky ActiveX: Licencování ovládacího prvku ActiveX | Dokumentace Microsoftu'
ms.custom: ''
ms.date: 09/12/2018
ms.technology:
- cpp-mfc
...
Ověření licencovaného ovládacího prvku ActiveX během vývoje.  
 ...
 ![Licencované ovládací prvek ActiveX ověřit při spuštění](../mfc/media/vc374d2.gif "vc374d2")  
