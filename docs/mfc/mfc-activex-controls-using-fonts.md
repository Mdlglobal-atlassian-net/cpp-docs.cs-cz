...
4.  V místní nabídce klikněte na tlačítko **přidat** a potom klikněte na tlačítko **přidat vlastnost**.  
  
     Otevře se Průvodce přidáním vlastnosti.  
  
5.  V **název vlastnosti** klikněte **písmo**.  
...
5.  V **název vlastnosti** klikněte **titulek**.  
...
5.  V **název vlastnosti** zadejte název pro vlastnost. V tomto příkladu použijte **HeadingFont**.  
  
6.  Pro **typ implementace**, klikněte na tlačítko **metody Get/Set**.  
  
7.  V **typ vlastnosti** vyberte **IDispatch** <strong>\*</strong> pro vlastnosti typu.  
...
###  <a name="_core_processing_font_notifications"></a> Zpracování oznámení písma  
 ...
 ![Implementace rozhraní více objektů písma](../mfc/media/vc373q1.gif "vc373q1")  
...
## <a name="see-also"></a>Viz také  
 ...
 [MFC – ovládací prvky ActiveX: Použití obrázků v ovládacím prvku ActiveX](../mfc/mfc-activex-controls-using-pictures-in-an-activex-control.md)   
