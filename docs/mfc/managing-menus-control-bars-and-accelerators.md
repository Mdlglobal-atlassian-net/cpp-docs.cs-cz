...
## <a name="managing-menus"></a>Správa nabídek  
 Účastní se aktualizace položky uživatelského rozhraní pomocí mechanismu on_update_command_ui – popsané v okně s rámečkem [postup aktualizace objektů uživatelského rozhraní](../mfc/how-to-update-user-interface-objects.md). Tlačítka na panely nástrojů a dalších ovládací pruhy jsou aktualizovány během nečinné smyčky. Položky nabídky v rozevíracích nabídek v řádku nabídek se aktualizují těsně před rozbalení nabídky.  
 ...
 [CMDIFrameWnd](../mfc/reference/cmdiframewnd-class.md) poskytuje výchozí implementaci pro standardní příkazy v zobrazené nabídce okna pro aplikace MDI. Konkrétně je implementováno příkaz nové okno (id_window_new –) k vytvoření nových oken s rámečkem a zobrazení v aktuálním dokumentu. Je nutné přepsat tyto implementace, pouze pokud je potřeba upravit vlastní nastavení.  
