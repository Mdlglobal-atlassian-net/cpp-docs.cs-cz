---
title: 'Příklad: Zobrazení dialogového okna pomocí příkazu nabídky | Dokumentace Microsoftu'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
1. Upravte DisplayDialogView.cpp:
...
- Q251059: Postupy: Zadejte vlastní název třídy okna pro dialogového okna knihovny MFC
