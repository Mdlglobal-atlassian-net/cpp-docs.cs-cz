...
Následující příklad ukazuje, jak získat odkaz na `CPaneContainerManager` objektu. Tento fragment kódu je součástí [nastavit velikost podokna ukázka](../../overview/visual-cpp-samples.md).
