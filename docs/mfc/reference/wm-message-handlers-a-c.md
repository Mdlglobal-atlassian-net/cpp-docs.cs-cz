---
title: 'Wm_ – obslužné rutiny zpráv: A – C | Dokumentace Microsoftu'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|---------------|------------------------|
|ON_WM_ACTIVATE()|afx_msg void [při aktivaci](../../mfc/reference/cwnd-class.md#onactivate)(UINT, CWnd\*, BOOL);|
