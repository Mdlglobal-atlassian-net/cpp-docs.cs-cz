---
title: Třída CMFCVisualManagerOffice2007
ms.date: 11/04/2016
f1_keywords:
...
ms.locfileid: "81319915"
---
# <a name="cmfcvisualmanageroffice2007-class"></a>Třída CMFCVisualManagerOffice2007

`CMFCVisualManagerOffice2007`Poskytuje aplikaci vzhled sady Microsoft Office 2007.
...
|`CMFCVisualManagerOffice2007::GetStyle`|Vrátí aktuální barevné schéma `CMFCVisualManagerOffice2007` grafického uživatelského rozhraní, které zase napodobuje grafické rozhraní sady Microsoft Office 2007.|
...
|[CMFCVisualManagerOffice2007::Oddělovač ondrawbutton](#ondrawbuttonseparator)||
...
|[CMFCVisualManagerOffice2007::Kategorie OnDrawRibbonCategory](#ondrawribboncategory)||
...
|[CMFCVisualManagerOffice2007::OnDrawRibbonDefaultPaneButtonIndicatorIndicator](#ondrawribbondefaultpanebuttonindicator)||
...
|[CMFCVisualManagerOffice2007::OnDrawRibbonMainPanelButtonButtonBorder](#ondrawribbonmainpanelbuttonborder)||
...
|[CMFCVisualManagerOffice2007::OnDrawRibbonStavbarPane](#ondrawribbonstatusbarpane)||
...
|[CMFCVisualManagerOffice2007::Oddělovač ondraw](#ondrawseparator)||
...
|[CMFCVisualManagerOffice2007::OnHighlightRarelyUsedItems](#onhighlightrarelyusedmenuitems)||
...
|`CMFCVisualManagerOffice2007::SetStyle`|Nastaví barevné schéma `CMFCVisualManagerOffice2007` grafického uživatelského rozhraní.|

## <a name="remarks"></a>Poznámky

Slouží `CMFCVisualManagerOffice2007` ke změně vizuálního vzhledu aplikace tak, aby se podobal apodoba sady Microsoft Office 2007. Tento vizuální manažer vyžaduje, abyste styl nastavili před jeho použitím. Před předáním tohoto `CMFCVisualManager::SetDefaultManager`vizuálního správce je `CMFCVisualManagerOffice2007::SetStyle`nutné volat statickou funkci .

## <a name="example"></a>Příklad

Následující příklad ukazuje, jak používat vizuální správce Office 2007. Tento fragment kódu je součástí [ukázky ukázky upozornění](../../overview/visual-cpp-samples.md)na ploše .
...
**Záhlaví:** afxvisualmanageroffice2007.h
...
## <a name="cmfcvisualmanageroffice2007ondrawbuttonseparator"></a><a name="ondrawbuttonseparator"></a>CMFCVisualManagerOffice2007::Oddělovač ondrawbutton
...
## <a name="cmfcvisualmanageroffice2007ondrawribboncategory"></a><a name="ondrawribboncategory"></a>CMFCVisualManagerOffice2007::Kategorie OnDrawRibbonCategory
...
## <a name="cmfcvisualmanageroffice2007ondrawribbondefaultpanebuttonindicator"></a><a name="ondrawribbondefaultpanebuttonindicator"></a>CMFCVisualManagerOffice2007::OnDrawRibbonDefaultPaneButtonIndicatorIndicator
...
## <a name="cmfcvisualmanageroffice2007ondrawribbonmainpanelbuttonborder"></a><a name="ondrawribbonmainpanelbuttonborder"></a>CMFCVisualManagerOffice2007::OnDrawRibbonMainPanelButtonButtonBorder
...
## <a name="cmfcvisualmanageroffice2007ondrawribbonstatusbarpane"></a><a name="ondrawribbonstatusbarpane"></a>CMFCVisualManagerOffice2007::OnDrawRibbonStavbarPane
...
## <a name="cmfcvisualmanageroffice2007ondrawseparator"></a><a name="ondrawseparator"></a>CMFCVisualManagerOffice2007::Oddělovač ondraw
...
## <a name="cmfcvisualmanageroffice2007onhighlightrarelyusedmenuitems"></a><a name="onhighlightrarelyusedmenuitems"></a>CMFCVisualManagerOffice2007::OnHighlightRarelyUsedItems
