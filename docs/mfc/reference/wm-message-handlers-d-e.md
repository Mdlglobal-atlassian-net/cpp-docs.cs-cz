---
title: 'Obslužné rutiny zpráv WM_: D - E'
ms.date: 11/04/2016
f1_keywords:
- ON_WM_ERASEBKGND
- ON_WM_DEVICECHANGE
...
ms.locfileid: "68449979"
---
# <a name="wm-message-handlers-d---e"></a>Obslužné rutiny zpráv WM_: D - E

Následující položky mapy na levé straně odpovídají prototypům funkcí na pravé straně:
...
|ON_WM_DEVMODECHANGE()|afx_msg void [OnDevModeChange](../../mfc/reference/cwnd-class.md#ondevmodechange)(typem LPStr);|
