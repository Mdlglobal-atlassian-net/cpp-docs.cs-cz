...
|Název|Popis|  
|----------|-----------------|  
|[CMFCRibbonBar::ActivateContextCategory](#activatecontextcategory)|Aktivuje kontextu kategorii, která je již zobrazen.|  
|[CMFCRibbonBar::AddCategory](#addcategory)|Přidá novou kategorii pásu karet na pásu karet.|  
|[CMFCRibbonBar::AddContextCategory](#addcontextcategory)|Přidá kategorii kontextu.|  
|[CMFCRibbonBar::AddMainCategory](#addmaincategory)|Přidá novou kategorii hlavní pásu karet.|  
|[CMFCRibbonBar::AddPrintPreviewCategory](#addprintpreviewcategory)||  
|[CMFCRibbonBar::AddQATOnlyCategory](#addqatonlycategory)||  
|[CMFCRibbonBar::AddToTabs](#addtotabs)|Přidá prvek pásu karet na pravé straně panelu pásu karet.|  
|[CMFCRibbonBar::CreateEx](#createex)|Vytvoří ovládacích pruhů a připojí jej k [CPane](../../mfc/reference/cpane-class.md) objektu. (Přepisuje [CPane::CreateEx](../../mfc/reference/cpane-class.md#createex).)|  
|[CMFCRibbonBar::Create](#create)|Vytvoří ovládací panel pásu karet a připojí jej na pásu karet na řádek.|  
...
|[CMFCRibbonBar::EnableKeyTips](#enablekeytips)|Povolit nebo zakázat klíče tipy pro ovládací prvek pásu karet.|  
|[CMFCRibbonBar::EnablePrintPreview](#enableprintpreview)|Povolit **Náhled** kartě.|  
|[CMFCRibbonBar::EnableToolTips](#enabletooltips)|Povolí nebo zakáže popisy popisy tlačítek a popisu tlačítka na panelu pásu karet.|  
|[CMFCRibbonBar::FindByData](#findbydata)|Hledání prvku pásu karet pomocí dat, která určuje uživatele.|  
|[CMFCRibbonBar::FindByID](#findbyid)|Vyhledá na pásu karet element, který má zadaný příkaz id.|  
|[CMFCRibbonBar::FindCategoryIndexByData](#findcategoryindexbydata)|Vyhledá index kategorii pásu karet, která obsahuje uživatelská data.|  
...
|[CMFCRibbonBar::GetCaptionHeight](#getcaptionheight)|Vrátí popisek výšku. (Přepisuje [CBasePane::GetCaptionHeight](../../mfc/reference/cbasepane-class.md#getcaptionheight).)|  
|[CMFCRibbonBar::GetCategory](#getcategory)|Získá ukazatele do kategorií nacházející se v zadaném indexu.|  
...
|[CMFCRibbonBar::GetContextName](#getcontextname)|Načte název kategorie popisek kontext, který určíte pomocí ID.|  
|[CMFCRibbonBar::GetDroppedDown](#getdroppeddown)||  
|[CMFCRibbonBar::GetElementsByID](#getelementsbyid)|Získá pole, které obsahuje odkazy na všechny prvky pásu karet, které mají zadané ID.|  
|[CMFCRibbonBar::GetApplicationButton](#getapplicationbutton)|Získá ukazatel na tlačítko pásu karet.|  
|[CMFCRibbonBar::GetFocused](#getfocused)|Vrátí element cílených.|  
...
|[CMFCRibbonBar::GetMainCategory](#getmaincategory)|Vrací ukazatel na pásu karet kategorii, která je aktuálně vybrané.|  
|[CMFCRibbonBar::GetQATCommandsLocation](#getqatcommandslocation)||  
|[CMFCRibbonBar::GetQATDroppedDown](#getqatdroppeddown)||  
|[CMFCRibbonBar::GetQuickAccessCommands](#getquickaccesscommands)|Doplní seznam, který obsahuje ID příkazů všechny elementy, které se zobrazují na panelu nástrojů Rychlý přístup.|  
...
|[CMFCRibbonBar::HideAllContextCategories](#hideallcontextcategories)|Skryje všechny kategorie, které jsou aktivní a jsou viditelné.|  
|[CMFCRibbonBar::HideKeyTips](#hidekeytips)||  
|[CMFCRibbonBar::HitTest](#hittest)|Vyhledá ukazatel na pásu karet elementu, který se nachází v zadané bod v souřadnice klienta na pásu karet panelu.|  
|[CMFCRibbonBar::IsKeyTipEnabled](#iskeytipenabled)|Určuje, zda je povoleno popisy tlačítek.|  
|[CMFCRibbonBar::IsMainRibbonBar](#ismainribbonbar)||  
|[CMFCRibbonBar::IsPrintPreviewEnabled](#isprintpreviewenabled)|Určuje, zda **Náhled** karta je povoleno.|  
|[CMFCRibbonBar::IsQATEmpty](#isqatempty)||  
|[CMFCRibbonBar::IsQuickAccessToolbarOnTop](#isquickaccesstoolbarontop)|Určuje, jestli je výše na pásu karet panelu umístění panelu nástrojů Rychlý přístup.|  
|[CMFCRibbonBar::IsReplaceFrameCaption](#isreplaceframecaption)|Určuje, zda nahrazuje titulek hlavní rámečku panelu pásu karet, nebo je přidán pod titulek rámce.|  
|[CMFCRibbonBar::IsShowGroupBorder](#isshowgroupborder)||  
|[CMFCRibbonBar::IsToolTipDescrEnabled](#istooltipdescrenabled)|Určuje, zda je povoleno popisy popisku.|  
|[CMFCRibbonBar::IsToolTipEnabled](#istooltipenabled)|Určuje, zda je povoleno popisy tlačítek pro pás karet panelu.|  
|[CMFCRibbonBar::IsTransparentCaption](#istransparentcaption)||  
|[CMFCRibbonBar::IsWindows7Look](#iswindows7look)|Označuje, zda má na pásu karet Windows 7 styl vzhledu (tlačítko malá obdélníková aplikace).|  
|[CMFCRibbonBar::LoadFromResource](#loadfromresource)|Přetíženo. Načte panelu pásu karet z prostředků aplikace.|  
...
|[CMFCRibbonBar::OnSetAccData](#onsetaccdata)|(Přepisuje [CBasePane::OnSetAccData](../../mfc/reference/cbasepane-class.md#onsetaccdata).)|  
...
|[CMFCRibbonBar::PreTranslateMessage](#pretranslatemessage)|(Přepisuje `CBasePane::PreTranslateMessage`.)|  
|[CMFCRibbonBar::RecalcLayout](#recalclayout)|(Přepisuje [CPane::RecalcLayout](../../mfc/reference/cpane-class.md#recalclayout).)|  
|[CMFCRibbonBar::RemoveAllCategories](#removeallcategories)|Odebere všechny kategorie pásu karet z panelu pásu karet.|  
|[CMFCRibbonBar::RemoveAllFromTabs](#removeallfromtabs)|Odebere všechny prvky pásu karet z oblast karty.|  
|[CMFCRibbonBar::RemoveCategory](#removecategory)|Odebere kategorii pásu karet, která se nachází v zadaném indexu.|  
|[CMFCRibbonBar::SaveToXMLBuffer](#savetoxmlbuffer)|Na pásu karet panelu uloží do vyrovnávací paměti.|  
|[CMFCRibbonBar::SaveToXMLFile](#savetoxmlfile)|Na pásu karet panelu uloží do souboru XML.|  
|[CMFCRibbonBar::SetActiveCategory](#setactivecategory)|Nastaví kategorii zadaný pásu karet na aktivní.|  
|[CMFCRibbonBar::SetActiveMDIChild](#setactivemdichild)||  
|[CMFCRibbonBar::SetElementKeys](#setelementkeys)|Nastaví zadaný popisy tlačítek pro všechny elementy pásu karet, které mají zadaný příkaz ID.|  
|[CMFCRibbonBar::SetApplicationButton](#setapplicationbutton)|Přiřadí aplikace pásu karet tlačítko panelu pásu karet.|  
|[CMFCRibbonBar::SetKeyboardNavigationLevel](#setkeyboardnavigationlevel)||  
|[CMFCRibbonBar::SetMaximizeMode](#setmaximizemode)||  
|[CMFCRibbonBar::SetQuickAccessCommands](#setquickaccesscommands)|Přidá jeden či více elementů pásu karet na panelu nástrojů Rychlý přístup.|  
|[CMFCRibbonBar::SetQuickAccessDefaultState](#setquickaccessdefaultstate)|Určuje výchozí stav pro panel nástrojů Rychlý přístup.|  
|[CMFCRibbonBar::SetQuickAccessToolbarOnTop](#setquickaccesstoolbarontop)|Umisťuje rychlý přístup k panelu nástrojů (QAT) nad nebo pod panelem pásu karet.|  
|[CMFCRibbonBar::SetTooltipFixedWidth](#settooltipfixedwidth)||  
|[CMFCRibbonBar::SetWindows7Look](#setwindows7look)|Povolí nebo zakáže pásu karet Windows 7 styl vzhledu (tlačítko malá obdélníková aplikace)|  
|[CMFCRibbonBar::ShowCategory](#showcategory)|Zobrazí nebo skryje kategorie zadaný pásu karet.|  
...
|[CMFCRibbonBar::ToggleMimimizeState](#togglemimimizestate)|Přepíná na pásu karet pruh mezi stavy minimalizovaném okně a maximalizovaném okně...|  
|[CMFCRibbonBar::TranslateChar](#translatechar)||  
  
## <a name="remarks"></a>Poznámky  
 Microsoft představil na pásu karet Office Fluent současně vydání Microsoft Office 2007. Tento panel pásu karet není právě nový ovládací prvek. Reprezentuje novým paradigmatům uživatelské rozhraní. Na pásu karet je podokno, které obsahuje sadu karet názvem kategorie. Každá kategorie je logicky rozdělení na pásu karet panelů a jednotlivé panely může obsahovat různé ovládací prvky a příkazová tlačítka.  
  
 Prvky, které se zobrazují v rozbalte panelu pásu karet a smlouvy pro co nejlepší využití dostupného místa. Například pokud panely pásu karet není dostatek místa k zobrazení jeho prvky, stane se tlačítka s nabídkou, která zobrazuje podřízených položek v místní nabídce. Na pásu karet panelu chová jako statické ovládacích pruhů (ne plovoucí) a v horní části rámeček lze ukotvit.  
  
 Můžete použít `CMFCRibbonStatusBar` třídu pro implementaci stavového řádku podobné použít v Office 2007. Pás karet kategorie obsahuje (a zobrazí) skupinu [pásu karet panelů](../../mfc/reference/cmfcribbonpanel-class.md). Jednotlivé panely pásu karet obsahuje jeden či více elementů pásu karet, které jsou odvozeny od [CMFCRibbonBaseElement](../../mfc/reference/cmfcribbonbaseelement-class.md).  
  
 Informace o tom, jak přidat do existující aplikace knihovny MFC panel pásu karet najdete v tématu [návod: aktualizace aplikace MFC Klikyháky](../../mfc/walkthrough-updating-the-mfc-scribble-application-part-1.md).  
...
### <a name="return-value"></a>Návratová hodnota  
 Ukazatel na novou kategorii pásu karet, pokud metoda byla úspěšná. v opačném `NULL`.  
  
### <a name="remarks"></a>Poznámky  
 Pokud *pRTI* parametr není `NULL`, nové kategorie pásu karet je vytvořený dynamicky pomocí run-time třída.  
  
### <a name="example"></a>Příklad  
 Následující příklad ukazuje, jak používat `AddCategory` metoda v `CMFCRibbonBar` třídy.  
...
### <a name="return-value"></a>Návratová hodnota  
 Ukazatel na nově vytvořený kategorie nebo `NULL` Pokud `CreateObject` metodu *pRTI* nelze vytvořit Zadaná kategorie.  
  
### <a name="remarks"></a>Poznámky  
 Pomocí této funkce můžete přidat kategorii kontextu. Kontext kategorie jsou zvláštní typ kategorii, která můžete zobrazit nebo skrýt v době běhu v závislosti na aktuálním kontextu aplikací. Například pokud uživatel vybere objekt, můžete zobrazit speciální karet s kontextu kategorií, které se používá ke změně konkrétní vybraný objekt.  
  
 Barva kategorie kontext může být jedna z následujících hodnot:  
...
### <a name="return-value"></a>Návratová hodnota  
 Ukazatel na novou kategorii hlavní pásu karet, pokud metoda byla úspěšná. v opačném `NULL`.  
  
### <a name="remarks"></a>Poznámky  
 Pokud hlavní pásu karet kategorie již existuje, je odstraněn.  
  
### <a name="example"></a>Příklad  
 Následující příklad ukazuje, jak používat `AddMainCategory` metoda v `CMFCRibbonBar` třídy.  
...
### <a name="return-value"></a>Návratová hodnota  
 Ukazatel na novou kategorii, pokud metoda byla úspěšná. v opačném `NULL`.  
...
### <a name="example"></a>Příklad  
 Následující příklad ukazuje, jak používat `Create` metodu `CMFCRibbonBar` třídy.  
...
### <a name="remarks"></a>Poznámky  
 Element pásu karet je libovolný ovládací prvek pásu karet, který lze přidat na pásu karet, jako je tlačítko pásu karet, nebo kategorii pásu karet nebo jezdce pásu karet.  
...
### <a name="return-value"></a>Návratová hodnota  
 Ukazatel na pásu karet active kategorie; nebo `NULL` Pokud je aktivní žádné kategorie.  
  
### <a name="remarks"></a>Poznámky  
 Kategorie je aktivní, pokud je fokus. Ve výchozím nastavení je aktivní kategorie na prvním místě na levé straně panelu pásu karet.  
...
### <a name="return-value"></a>Návratová hodnota  
 Výška v pixelech oblasti popisek pruhu pásu karet.  
...
### <a name="return-value"></a>Návratová hodnota  
 Pás karet elementu, který je nyní otevřeno; nebo `NULL` Pokud žádný element pásu karet nyní otevřeno.  
...
### <a name="return-value"></a>Návratová hodnota  
 Příznaky, které označují, kolik z panelu pásu karet je viditelná.  
  
### <a name="remarks"></a>Poznámky  
 Následující tabulka uvádí možné kombinace příznaků pro návratovou hodnotu:  
  
 `AFX_RIBBONBAR_HIDE_ELEMENTS`  
 Na pásu karet panelu je minimalizován svisle a jsou viditelné pouze kategorie karty, hlavní tlačítko a nástrojů Rychlý přístup.  
...
### <a name="return-value"></a>Návratová hodnota  
 Aktuální úroveň navigace jako uživatel stiskem tlačítka popisy tlačítek, které jsou obsaženy na panelu pásu karet. Následující tabulka uvádí možné vrácené hodnoty:  
  
 -1  
 Popisy tlačítek se nezobrazují.  
  
 0  
 Zobrazí se popisy tlačítek.  
  
 1  
 Uživatel má stisknutí zobrazených keytip.  
...
### <a name="return-value"></a>Návratová hodnota  
 Aktuální objekt navigační klávesnice na pásu karet panelu; v opačném případě `NULL` Pokud žádný objekt aktuálně zobrazí popisy tlačítek.  
...
### <a name="return-value"></a>Návratová hodnota  
 Nadřazený objekt navigace klávesnice na pásu karet panelu; v opačném případě `NULL`.  
...
### <a name="return-value"></a>Návratová hodnota  
 Obdélník zobrazení pro část příkazy panelu nástrojů Rychlý přístup.  
...
### <a name="return-value"></a>Návratová hodnota  
 Ukazatel na pásu karet elementu na panelu nástrojů Rychlý přístup, který má svůj místní nabídky vyřadit.  
...
### <a name="return-value"></a>Návratová hodnota  
 Procento velikost snížení Šířka zobrazení karet kategorie.  
...
### <a name="return-value"></a>Návratová hodnota  
 Velká velikost popisku šířku v pixelech.  
...
### <a name="return-value"></a>Návratová hodnota  
 Regulární velikost popisku šířku v pixelech.  
...
### <a name="return-value"></a>Návratová hodnota  
 Počet viditelné kategorie na panelu pásu karet.  
...
### <a name="return-value"></a>Návratová hodnota  
 S_OK v případě úspěšného; S_FALSE nebo jinak hodnota FALSE.  
...
### <a name="remarks"></a>Poznámky  
 Na pásu karet tlačítko aplikace je velké zaokrouhlené tlačítko nacházející se v levém horním rohu ovládacího prvku pásu karet.  
  
### <a name="example"></a>Příklad  
 Následující příklad ukazuje, jak používat `SetApplicationButton` metoda v `CMFCRibbonBar` třídy.  
...
### <a name="remarks"></a>Poznámky  
 Stav panelu nástrojů Rychlý přístup zahrnuje seznam příkazů a jejich přehled.  
  
### <a name="example"></a>Příklad  
 Následující příklad ukazuje, jak používat `SetQuickAccessDefaultState` metoda v `CMFCRibbonBar` třídy.  
...
### <a name="remarks"></a>Poznámky  
 Chyby v pravopisu v název metody se o známý problém.  
...
### <a name="parameters"></a>Parametry  
 *uiXMLResID*  
 Určuje prostředek řetězec ID XML s informacemi o panelu pásu karet.  
  
 *lpszResType*  
 Určuje typ prostředku v *uiXMLResID*.  
  
 *hInstance*  
 Zpracování v modulu, jehož spustitelný soubor obsahuje prostředek. Pokud *hInstance* je `NULL`, systém načte prostředek z modul, který byl použit k vytvoření aktuálním procesu.  
