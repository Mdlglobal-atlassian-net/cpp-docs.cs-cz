...
### <a name="see-also"></a>Viz také  
 [Izolace knihovny MFC běžné ovládací prvky knihovny](../isolation-of-the-mfc-common-controls-library.md) [AFX_COMCTL32_IF_EXISTS2](#afx_comctl32_if_exists2)
...
### <a name="see-also"></a>Viz také  
 [Izolace knihovny MFC běžné ovládací prvky knihovny](../isolation-of-the-mfc-common-controls-library.md) [AFX_COMCTL32_IF_EXISTS](#afx_comctl32_if_exists)
