...
Následující příklad ukazuje použití metody otevřít a číst `CSettingsStore` třídy. Tento fragment kódu je součástí [nástroj Tip demonstrační ukázka](../../overview/visual-cpp-samples.md).
