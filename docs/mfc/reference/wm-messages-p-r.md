---
title: 'Wm_ – zprávy: P – R | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
ms.locfileid: "33379551"
---
# <a name="wm-messages-p---r"></a>WM_ – zprávy: P–R
...
|ON_WM_PAINTCLIPBOARD()|afx_msg void [OnPaintClipboard](../../mfc/reference/cwnd-class.md#onpaintclipboard)(CWnd *, POPISOVAČ);|  
...
|ON_WM_POWERBROADCAST()|afx_msg Celé_číslo [OnPowerBroadcast](../../mfc/reference/cwnd-class.md#onpowerbroadcast)(UINT, UINT);|  
