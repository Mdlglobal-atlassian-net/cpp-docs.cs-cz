---
title: Průvodce aplikací knihovny MFC | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
- [Pokročilé funkce, Průvodce aplikací MFC](../../mfc/reference/advanced-features-mfc-application-wizard.md)
   ...
   - Projekt podporuje **Explorer** ukotvené podokno, **interaktivnímu** ukotvené podokno a **vlastnosti** ukotvené podokno.
