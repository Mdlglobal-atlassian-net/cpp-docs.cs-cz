---
title: Ctypedptrarray – třída | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|Název|Popis|
|----------|-----------------|
|[[] Č. CTypedPtrArray::operator](#operator_at)|Nastaví nebo získá prvek na zadaném indexu.|
