...
Následující příklad ukazuje, jak vytvořit objekt `CMFCShellTreeCtrl` třídy. Tento fragment kódu je součástí [ukázka Průzkumníka](../../overview/visual-cpp-samples.md).
