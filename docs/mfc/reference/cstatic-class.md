---
title: Cstatic – třída | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
*lpDrawItemStruct*<br/>
Ukazatel [drawitemstruct –](../../mfc/reference/drawitemstruct-structure.md) struktury. Struktura obsahuje informace o položka, která má být vykreslena a typ kresby vyžaduje.
