...
- **Kontextová nápověda (HTML)**
   ...
   Zobrazit [Nápověda HTML: Kontextová nápověda pro vaše programy](../../mfc/html-help-context-sensitive-help-for-your-programs.md) a [soubory nápovědy (Nápověda jazyka HTML)](../../build/reference/help-files-html-help.md) Další informace.
