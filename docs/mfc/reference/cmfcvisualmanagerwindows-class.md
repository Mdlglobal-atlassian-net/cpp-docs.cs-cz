...
|Název|Popis|
|----------|-----------------|
|[CMFCVisualManagerWindows::AlwaysHighlight3DTabs](#alwayshighlight3dtabs)|Rozhraní framework volá tuto metodu k určení, zda 3D karty by měly být vždy zvýrazněny v aplikaci. (Přepíše [CMFCVisualManager::AlwaysHighlight3DTabs](../../mfc/reference/cmfcvisualmanager-class.md#alwayshighlight3dtabs).)|
...
|[CMFCVisualManagerWindows::GetButtonExtraBorder](#getbuttonextraborder)|Rozhraní Framework volá tuto metodu při nakreslí tlačítko panelu nástrojů. (Přepíše [CMFCVisualManager::GetButtonExtraBorder](../../mfc/reference/cmfcvisualmanager-class.md#getbuttonextraborder).)|
...
|[CMFCVisualManagerWindows::GetHighlightedMenuItemTextColor](#gethighlightedmenuitemtextcolor)|(Přepíše `CMFCVisualManagerOfficeXP::GetHighlightedMenuItemTextColor`.)|
|[CMFCVisualManagerWindows::GetPopupMenuGap](#getpopupmenugap)|(Přepíše `CMFCVisualManagerOfficeXP::GetPopupMenuGap`.)|
|[CMFCVisualManagerWindows::GetToolbarButtonTextColor](#gettoolbarbuttontextcolor)|(Přepíše `CMFCVisualManagerOfficeXP::GetToolbarButtonTextColor`.)|
|[CMFCVisualManagerWindows::IsDefaultWinXPPopupButton](#isdefaultwinxppopupbutton)|(Přepíše [CMFCVisualManager::IsDefaultWinXPPopupButton](../../mfc/reference/cmfcvisualmanager-class.md#isdefaultwinxppopupbutton).)|
|[CMFCVisualManagerWindowsWindows::isHighlightWholeItem](#ishighlightwholemenuitem)|(Přepíše `CMFCVisualManagerOfficeXP::IsHighlightWholeMenuItem`.)|
|[CMFCVisualManagerWindows::Nabídky IsOfficeStyle](#isofficestylemenus)||
|[CMFCVisualManagerWindows::IsOfficeXPStyleMenus](#isofficexpstylemenus)|Označuje, zda správce vizuálů implementuje nabídky ve stylu sady Office XP. (Přepíše [CMFCVisualManager::IsOfficeXPStyleMenus](../../mfc/reference/cmfcvisualmanager-class.md#isofficexpstylemenus).)|
|[CMFCVisualManagerWindows::IsWindowsThemingPodporováno](#iswindowsthemingsupported)|(Přepíše `CMFCVisualManager::IsWindowsThemingSupported`.)|
|[CMFCVisualManagerWindows::IsWinXPThemeK dispozici](#iswinxpthemeavailable)|Označuje, zda je motiv systému Windows k dispozici.|
|[CMFCVisualManagerWindows::OnDrawBarGripper](#ondrawbargripper)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawBarGripper`.)|
|[CMFCVisualManagerWindows::OnDrawBrowseButton](#ondrawbrowsebutton)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawBrowseButton`.)|
|[CMFCVisualManagerWindows::OnDrawButtonBorder](#ondrawbuttonborder)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawButtonBorder`.)|
|[CMFCVisualManagerWindows::Oddělovač ondrawbutton](#ondrawbuttonseparator)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawButtonSeparator`.)|
...
|[CMFCVisualManagerWindows::OnDrawHeaderCtrlBorder](#ondrawheaderctrlborder)|Framework volá tuto metodu, když nakreslí ohraničení kolem instance [třídy CMFCHeaderCtrl](../../mfc/reference/cmfcheaderctrl-class.md). (Přepíše [CMFCVisualManager::OnDrawHeaderCtrlBorder](../../mfc/reference/cmfcvisualmanager-class.md#ondrawheaderctrlborder).)|
|[CMFCVisualManagerWindowsWindows::OnDrawHeaderCtrlSortArrow](#ondrawheaderctrlsortarrow)|Rozhraní Framework volá tuto funkci, když nakreslí šipku řazení ovládacího prvku záhlaví. (Přepíše [CMFCVisualManager::OnDrawHeaderCtrlSortArrow](../../mfc/reference/cmfcvisualmanager-class.md#ondrawheaderctrlsortarrow).)|
|[CMFCVisualManagerWindowsWindows::OnDrawMenuBorder](#ondrawmenuborder)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawMenuBorder`.)|
|[CMFCVisualManagerWindowsWindows::OnDrawMenuSystemButton](#ondrawmenusystembutton)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawMenuSystemButton`.)|
...
|[CMFCVisualManagerWindows::OnDrawOutlookPageButtonBorder](#ondrawoutlookpagebuttonborder)|Volat rámci při nakreslí ohraničení tlačítka stránky aplikace Outlook. (Přepíše [CMFCVisualManager::OnDrawOutlookPageButtonBorder](../../mfc/reference/cmfcvisualmanager-class.md#ondrawoutlookpagebuttonborder).)|
...
|[CMFCVisualManagerWindows::OnDrawScrollButtons](#ondrawscrollbuttons)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawScrollButtons`.)|
|[CMFCVisualManagerWindows::Oddělovač ondraw](#ondrawseparator)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawSeparator`.)|
|[CMFCVisualManagerWindows::OnDrawSpinButtons](#ondrawspinbuttons)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawSpinButtons`.)|
|[CMFCVisualManagerWindows::OnDrawStatusBarPaneBorder](#ondrawstatusbarpaneborder)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawStatusBarPaneBorder`.)|
|[CMFCVisualManagerWindows::OnDrawStavový panelPrůběh](#ondrawstatusbarprogress)|Rámec volá tuto metodu při nakreslí indikátor průběhu na [CMFCStatusBar](../../mfc/reference/cmfcstatusbar-class.md) objektu. (Přepíše [CMFCVisualManager::OnDrawStatusBarProgress](../../mfc/reference/cmfcvisualmanager-class.md#ondrawstatusbarprogress).)|
|[CMFCVisualManagerWindows::OnDrawStatusBarSizeBox](#ondrawstatusbarsizebox)|Rozhraní Framework volá tuto metodu při nakreslí velikost pole pro [CMFCStatusBar](../../mfc/reference/cmfcstatusbar-class.md). (Přepíše [CMFCVisualManager::OnDrawStatusBarSizeBox](../../mfc/reference/cmfcvisualmanager-class.md#ondrawstatusbarsizebox).)|
|[CMFCVisualManagerWindows::OnDrawTab](#ondrawtab)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawTab`.)|
|[CMFCVisualManagerWindows::OnDrawTabCloseButton](#ondrawtabclosebutton)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawTabCloseButton`.)|
|[CMFCVisualManagerWindows::OnDrawTabsButtonBorder](#ondrawtabsbuttonborder)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawTabsButtonBorder`.)|
|[CMFCVisualManagerWindows::OnDrawTask](#ondrawtask)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawTask`.)|
|[CMFCVisualManagerWindows::OnDrawTasksGroupAreaBorder](#ondrawtasksgroupareaborder)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawTasksGroupAreaBorder`.)|
|[CMFCVisualManagerWindows::OnDrawTasksGroupCaption](#ondrawtasksgroupcaption)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawTasksGroupCaption`.)|
|[CMFCVisualManagerWindows::OnDrawTearOffcaption](#ondrawtearoffcaption)|(Přepíše `CMFCVisualManagerOfficeXP::OnDrawTearOffCaption`.)|
|[CMFCVisualManagerWindows::OnErasePopupWindowButton](#onerasepopupwindowbutton)|(Přepíše `CMFCVisualManagerOfficeXP::OnErasePopupWindowButton`.)|
|[CMFCVisualManagerWindows::OnEraseTabsArea](#onerasetabsarea)|(Přepíše `CMFCVisualManagerOfficeXP::OnEraseTabsArea`.)|
|[CMFCVisualManagerWindows::OnEraseTabsButton](#onerasetabsbutton)|(Přepíše `CMFCVisualManagerOfficeXP::OnEraseTabsButton`.)|
|[CMFCVisualManagerWindows::OnEraseTabsFrame](#onerasetabsframe)|Rozhraní Framework volá tuto metodu, když vymaže rámec na [CMFCBaseTabCtrl třídy](../../mfc/reference/cmfcbasetabctrl-class.md). (Přepíše [CMFCVisualManager::OnEraseTabsFrame](../../mfc/reference/cmfcvisualmanager-class.md#onerasetabsframe).)|
|[CMFCVisualManagerWindows::OnFillBarBackground](#onfillbarbackground)|(Přepíše `CMFCVisualManagerOfficeXP::OnFillBarBackground`.)|
...
|[CMFCVisualManagerWindows::OnFillOutlookPageButton](#onfilloutlookpagebutton)|Framework volá tuto metodu, když vyplní vnitřek tlačítka stránky aplikace Outlook. (Přepíše [CMFCVisualManager::OnFillOutlookPageButton](../../mfc/reference/cmfcvisualmanager-class.md#onfilloutlookpagebutton).)|
...
|[CMFCVisualManagerWindows::OnFillTasksPaneBackground](#onfilltaskspanebackground)|Rozhraní Framework volá tuto metodu při vyplnění pozadí ovládacího prvku [CMFCTasksPane.](../../mfc/reference/cmfctaskspane-class.md) (Přepíše [CMFCVisualManager::OnFillTasksPaneBackground](../../mfc/reference/cmfcvisualmanager-class.md#onfilltaskspanebackground).)|
|[CMFCVisualManagerWindows::OnHighlightItem](#onhighlightmenuitem)|(Přepíše `CMFCVisualManagerOfficeXP::OnHighlightMenuItem`.)|
|[CMFCVisualManagerWindows::OnHighlightRarelyUsedItems](#onhighlightrarelyusedmenuitems)|(Přepíše `CMFCVisualManagerOfficeXP::OnHighlightRarelyUsedMenuItems`.)|
|[CMFCVisualManagerWindows::OnUpdateSystemColors](#onupdatesystemcolors)|(Přepíše `CMFCVisualManagerOfficeXP::OnUpdateSystemColors`.)|
...
|Název|Popis|
|----------|-----------------|
|[CMFCVisualManagerWindows::m_b3DTabsXPTheme](#m_b3dtabsxptheme)|Určuje, zda se v motivu systému Windows XP zobrazí 3D karty.|

## <a name="remarks"></a>Poznámky

Pomocí `CMFCVisualManagerWindows` třídy můžete změnit vzhled aplikace a napodobovat aktuální motiv v počítači, ve kterém je aplikace spuštěna.

Motiv systému Windows však nemusí být k dispozici, pokud je aplikace spuštěna ve verzi systému Windows starší než Windows XP nebo pokud jsou motivy zakázány, protože uživatel používá **klasické** zobrazení. Pokud není k dispozici žádný motiv, aplikace používá výchozí vizuální manažer definovaný v [CMFCVisualManager](../../mfc/reference/cmfcvisualmanager-class.md).

## <a name="example"></a>Příklad

Následující příklad ukazuje, jak `CMFCVisualManagerWindows`používat . Tento fragment kódu je součástí [ukázky ukázky upozornění](../../overview/visual-cpp-samples.md)na ploše .
...
## <a name="cmfcvisualmanagerwindowsishighlightwholemenuitem"></a><a name="ishighlightwholemenuitem"></a>CMFCVisualManagerWindowsWindows::isHighlightWholeItem
...
## <a name="cmfcvisualmanagerwindowsisofficestylemenus"></a><a name="isofficestylemenus"></a>CMFCVisualManagerWindows::Nabídky IsOfficeStyle
...
## <a name="cmfcvisualmanagerwindowsiswindowsthemingsupported"></a><a name="iswindowsthemingsupported"></a>CMFCVisualManagerWindows::IsWindowsThemingPodporováno
...
## <a name="cmfcvisualmanagerwindowsiswinxpthemeavailable"></a><a name="iswinxpthemeavailable"></a>CMFCVisualManagerWindows::IsWinXPThemeK dispozici
...
Nenulová, pokud je motiv k dispozici; jinak 0.

### <a name="remarks"></a>Poznámky

Tato metoda je platná pro všechny motivy systému Windows XP a novější.

`IsWinXPThemeAvailable`je shodná `CMFCVisualManagerWindows::IsWindowsThemingAvailable` `IsWinXPThemeAvailable` s výjimkou, že je statickou metodou. Proto vytvoří dočasný vizuální správce, pokud neexistuje.

`IsWinXPThemeAvailable`vždy vrátí 0s pro verze systému Windows starší než Windows XP.

## <a name="cmfcvisualmanagerwindowsm_b3dtabsxptheme"></a><a name="m_b3dtabsxptheme"></a>CMFCVisualManagerWindows::m_b3DTabsXPTheme

Logický parametr, který určuje, zda vizuální správce zobrazí 3D karty.
...
## <a name="cmfcvisualmanagerwindowsondrawbuttonseparator"></a><a name="ondrawbuttonseparator"></a>CMFCVisualManagerWindows::Oddělovač ondrawbutton
...
## <a name="cmfcvisualmanagerwindowsondrawheaderctrlsortarrow"></a><a name="ondrawheaderctrlsortarrow"></a>CMFCVisualManagerWindowsWindows::OnDrawHeaderCtrlSortArrow
...
## <a name="cmfcvisualmanagerwindowsondrawmenuborder"></a><a name="ondrawmenuborder"></a>CMFCVisualManagerWindowsWindows::OnDrawMenuBorder
...
## <a name="cmfcvisualmanagerwindowsondrawmenusystembutton"></a><a name="ondrawmenusystembutton"></a>CMFCVisualManagerWindowsWindows::OnDrawMenuSystemButton
...
## <a name="cmfcvisualmanagerwindowsondrawseparator"></a><a name="ondrawseparator"></a>CMFCVisualManagerWindows::Oddělovač ondraw
...
## <a name="cmfcvisualmanagerwindowsondrawstatusbarprogress"></a><a name="ondrawstatusbarprogress"></a>CMFCVisualManagerWindows::OnDrawStavový panelPrůběh
...
[v] *nProgressCurr*<br/>
[v] *clrBar*<br/>
[v] *clrProgressBarDest*<br/>
[v] *clrProgressText*<br/>
[v] *bProgressText*<br/>
...
## <a name="cmfcvisualmanagerwindowsonhighlightmenuitem"></a><a name="onhighlightmenuitem"></a>CMFCVisualManagerWindows::OnHighlightItem
...
## <a name="cmfcvisualmanagerwindowsonhighlightrarelyusedmenuitems"></a><a name="onhighlightrarelyusedmenuitems"></a>CMFCVisualManagerWindows::OnHighlightRarelyUsedItems
