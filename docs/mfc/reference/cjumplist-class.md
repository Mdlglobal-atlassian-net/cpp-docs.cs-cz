...
|[CJumpList::~CJumpList](#_dtorcjumplist)|Odstraní `CJumpList` objektu.|
...
Určuje argumenty příkazového řádku ke spustitelnému souboru určeném *strTargetExecutablePath*.
