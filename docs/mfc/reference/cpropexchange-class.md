 ...
 *pFontDesc*  
 Ukazatel [FONTDESC](http://msdn.microsoft.com/library/windows/desktop/ms692782) struktury obsahující hodnoty pro inicializaci výchozí stav vlastností písma při *pFontDispAmbient* má hodnotu NULL.  
