---
title: 'Wm_ – obslužné rutiny zpráv: F – K | Dokumentace Microsoftu'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|ON_WM_KEYDOWN()|afx_msg void [Stisknutiklavesy](../../mfc/reference/cwnd-class.md#onkeydown)(UINT, UINT, UINT);|
