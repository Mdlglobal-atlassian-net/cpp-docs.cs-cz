---
title: Csmartdockinginfo – třída | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
### <a name="parameters"></a>Parametry  
 [out] *parametry*  
 Objekt typu `CSmartDockingInfo` , které se vyplní aktuální inteligentního dokování parametry.  
