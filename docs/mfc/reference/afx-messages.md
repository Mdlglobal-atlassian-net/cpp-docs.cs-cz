...
|AFX_WM_ACCGETOBJECT|Nepoužívá se.|Nepoužívá se.|Není k dispozici.|Není k dispozici.|
...
|AFX_WM_CHECKEMPTYMINIFRAME|Pouze pro interní použití.|Není k dispozici.|Není k dispozici.|Není k dispozici.|
...
|AFX_WM_GETDRAGBOUNDS|Pouze pro interní použití.|Není k dispozici.|Není k dispozici.|Není k dispozici.|
...
|AFX_WM_ON_CANCELTABMOVE|Pouze pro interní použití.|Není k dispozici.|Není k dispozici.||
...
|AFX_WM_ON_DRAGCOMPLETE|Pouze pro interní použití.|Není k dispozici.|Není k dispozici.|Není k dispozici.|
...
|AFX_WM_ON_MOVETABCOMPLETE|Pouze pro interní použití.|Není k dispozici.|Není k dispozici.|Není k dispozici.|
...
|AFX_WM_ON_TABGROUPMOUSEMOVE|Pouze pro interní použití.|Není k dispozici.|Není k dispozici.|Není k dispozici.|
