---
title: 'Wm_ – zprávy: S | Dokumentace Microsoftu'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|(ON_WM_SETFOCUS)|afx_msg void [když se objekt](../../mfc/reference/cwnd-class.md#onsetfocus)(CWnd *);|
...
|(ON_WM_SIZE)|afx_msg void [upravuje místně](../../mfc/reference/cwnd-class.md#onsize)(UINT, int, int);|
