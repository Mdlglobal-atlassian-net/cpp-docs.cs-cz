...
2.  V podokně šablony vyberte **třídy knihovny MFC** a stiskněte klávesu **přidat** tlačítko.  
  
3.  Definovat nastavení pro novou třídu v [Průvodce třídami MFC](../../mfc/reference/mfc-add-class-wizard.md) dialogové okno.  
  
4.  Klikněte na tlačítko **Dokončit** zavřete průvodce a zobrazit novou třídu v zobrazení tříd. Můžete také zobrazit soubory vytvářené průvodcem v **Průzkumníka řešení**.  
