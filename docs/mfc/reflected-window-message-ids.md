...
ms.locfileid: "69511381"
---
# <a name="reflected-window-message-ids"></a>Identifikátory reflektovaných zpráv oken

Rychlý způsob, jak vytvořit ovládací prvek ActiveX nebo jiný specializovaný ovládací prvek, je podtřídou okna. Další informace naleznete v tématu [ovládací prvky ActiveX knihovny MFC: Roztřídění ovládacího prvku](../mfc/mfc-activex-controls-subclassing-a-windows-control.md)Windows

Chcete-li zabránit kontejneru ovládacího prvku, aby přijímal zprávy okna odesílané podtřídou Windows Control, vytvoří [COleControl –](../mfc/reference/colecontrol-class.md) okno "reflektor" pro zachycení určitých zpráv okna a jejich odeslání zpět do ovládacího prvku. Ovládací prvek, ve svém okně postup, může následně zpracovat tyto zrcadlené zprávy provedením akcí vhodných pro ovládací prvek ActiveX.

V následující tabulce jsou uvedeny zachycené zprávy a odpovídající zprávy, které okno reflektor odesílá.

|Zpráva odeslaná ovládacím prvkem|Zpráva odrážející ovládací prvek|
|---------------------------------|--------------------------------------|
...
> [!NOTE]
>  Pokud ovládací prvek běží v systému Win32, může se zobrazit několik typů zpráv WM_CTLCOLOR\* . Další informace najdete v tématu WM_CTLCOLORBTN, WM_CTLCOLORDLG, WM_CTLCOLOREDIT, WM_CTLCOLORLISTBOX, WM_CTLCOLORMSGBOX, WM_CTLCOLORSCROLLBAR, WM_CTLCOLORSTATIC.
