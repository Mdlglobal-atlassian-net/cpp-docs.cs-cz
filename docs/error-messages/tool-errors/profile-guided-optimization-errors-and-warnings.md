...
ms.locfileid: "64856087"
---
# <a name="profile-guided-optimization-errors-and-warnings-pgxxxx"></a>Na základě profilu – optimalizace chyby a upozornění (PGxxxx)

Tato část se odkaz na chyby vygenerované nástrojem nástroje Profile-Guided optimalizace (PGO). PGO chyby a upozornění mít formát _služba ._protokol PG*xxxx*, kde *xxxx* je čtyřmístné číslo.

[!INCLUDE[error-boilerplate](../../error-messages/includes/error-boilerplate.md)]

## <a name="pgo-errors"></a>Chyby PGO

[Chyba optimalizace na základě profilu PG0165](../../error-messages/tool-errors/profile-guided-optimization-error-pg0165.md)

## <a name="pgo-warnings"></a>Upozornění PGO

[Upozornění na základě profilu – optimalizace na základě PG1039](../../error-messages/tool-errors/profile-guided-optimization-warning-pg1039.md) \
