...
ms.locfileid: "74756339"
---
# <a name="compiler-error-c3652"></a>Chyba kompilátoru C3652

override: funkce, která explicitně Přepisuje, musí být virtuální.

Funkce, která explicitně Přepisuje, musí být virtuální. Další informace najdete v tématu [Explicitní přepsání](../../extensions/explicit-overrides-cpp-component-extensions.md).
