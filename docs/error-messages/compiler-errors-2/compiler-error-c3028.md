---
title: C3028 Chyba kompilátoru | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33246751"
---
# <a name="compiler-error-c3028"></a>C3028 chyby kompilátoru
"člen": pouze členové proměnnou nebo statických dat lze použít v klauzuli sdílení dat  
  
 Symbol než data proměnnou nebo statický člen byl předán v klauzuli snížení.  
