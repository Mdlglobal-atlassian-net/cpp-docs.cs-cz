...
ms.locfileid: "74735865"
---
# <a name="compiler-error-c3028"></a>Chyba kompilátoru C3028

' member ': v klauzuli data-Sharing lze použít pouze proměnnou nebo statický datový člen

Klauzuli Reduction byl předán jiný symbol než proměnná nebo statický datový člen.
