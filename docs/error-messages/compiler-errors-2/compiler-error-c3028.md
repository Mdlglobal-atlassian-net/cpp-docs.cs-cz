---
title: Chyba kompilátoru C3028 | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46067191"
---
# <a name="compiler-error-c3028"></a>Chyba kompilátoru C3028

'member': Proměnná nebo statický datový člen lze použít v klauzuli data-sharing

Symbol jiný než proměnná nebo statický datový člen byl předán v klauzuli reduction.

Následující ukázka generuje C3028:
