...
|[Chyba kompilátoru C3202](compiler-error-c3202.md)|"*identifikátor*': Neplatný výchozí argument, očekávala se šablona třídy|
|[Chyba kompilátoru C3203](compiler-error-c3203.md)|"*identifikátor*": nespecializovaná třídy šablony nebo generické nelze použít jako šablony/obecný argument pro parametr šablony/generické:*parametr*", očekával se skutečný typ.|
|[Chyba kompilátoru C3204](compiler-error-c3204.md)|"*funkce*" nejde volat z bloku catch.|
|[Chyba kompilátoru C3205](compiler-error-c3205.md)|Seznam argumentů šablony pro parametr šablony "*identifikátor*' nebyla nalezena|
|[Chyba kompilátoru C3206](compiler-error-c3206.md)|"*funkce*': Neplatný šablony/obecný argument pro"*šablony*", chybí seznam argumentů šablony nebo generické třídy šablony/obecných"*typ*"|
|[Chyba kompilátoru C3207](compiler-error-c3207.md)|"*funkce*': Neplatný argument šablony pro"*parametr*", očekávala se šablony tříd|
|[Chyba kompilátoru C3208](compiler-error-c3208.md)|"*funkce*": seznam parametrů šablony pro šablonu tříd "*šablony*"neodpovídá seznamu parametrů šablony pro parametr šablony"*parametr*"|
|[Chyba kompilátoru C3209](compiler-error-c3209.md)|"*typ*': Obecná třída musí být třída spravovaného/WinRT|
|[Chyba kompilátoru C3210](compiler-error-c3210.md)|"*identifikátor*': deklarace přístupu může používat jedině pro člena základní třídy.|
|[Chyba kompilátoru C3211](compiler-error-c3211.md)|"*funkce*': explicitní specializace používá syntaxi částečné specializace, místo toho použijte <> šablony|
|[Chyba kompilátoru C3212](compiler-error-c3212.md)|"*funkce*': explicitní specializace členu šablony musí být členem explicitní specializace|
|[Chyba kompilátoru C3213](compiler-error-c3213.md)|Základní třída*třídy*'je méně dostupný než'*derived_class*.|
|[Chyba kompilátoru C3214](compiler-error-c3214.md)|"*argument*': Neplatný argument typu pro obecný parametr"*parametr*"z obecného"*typ*", nesplňuje omezení '*omezení*'|
|[Chyba kompilátoru C3215](compiler-error-c3215.md)|"*constraint1*': Parametr obecného typu už se omezuje podle"*constraint2*.|
|[Chyba kompilátoru C3216](compiler-error-c3216.md)|omezení musí obecný parametr, ne "*typ*.|
...
|[Chyba kompilátoru C3225](compiler-error-c3225.md)|argument obecného typu pro '*argument*nemůže být*typ*", musí být typ hodnoty nebo o popisovač pro typ odkazu|
|[Chyba kompilátoru C3226](compiler-error-c3226.md)|V rámci obecné deklarace není povolená deklarace šablony|
|[Chyba kompilátoru C3227](compiler-error-c3227.md)|"*typ*': nelze použít '*operátor*" pro přidělení obecného typu|
|[Chyba kompilátoru C3228](compiler-error-c3228.md)|"*funkce*': argument obecného typu pro '*argument*nemůže být*typ*", musí být typ hodnoty nebo typ popisovače|
|[Chyba kompilátoru C3229](compiler-error-c3229.md)|"*typ*': indirekce parametru obecného typu nejsou povoleny.|
|[Chyba kompilátoru C3230](compiler-error-c3230.md)|"*funkce*': argument typu šablony pro"*argument*"nemůže obsahovat parametr obecného typu: '*typ*"|
|[Chyba kompilátoru C3231](compiler-error-c3231.md)|"*typ*': argument typu šablony nelze použít parametr obecného typu|
|[Chyba kompilátoru C3232](compiler-error-c3232.md)|"*parametr*': Parametr obecného typu nelze použít v kvalifikovaném názvu|
|[Chyba kompilátoru C3233](compiler-error-c3233.md)|"*typ*': už se omezuje parametr obecného typu|
|[Chyba kompilátoru C3234](compiler-error-c3234.md)|Obecná třída nemůže odvozovat od obecného parametru typu|
|[Chyba kompilátoru C3235](compiler-error-c3235.md)|"*specializace*': explicitní nebo částečná specializace obecné třídy není povolená.|
|[Chyba kompilátoru C3236](compiler-error-c3236.md)|explicitní vytváření instancí obecného není povolený.|
|[Chyba kompilátoru C3237](compiler-error-c3237.md)|"*třídy*': Obecná třída nemůže být vlastní atribut|
|[Chyba kompilátoru C3238](compiler-error-c3238.md)|"*typ*': typ s tímto názvem již byl přemístěn do sestavení '*sestavení*.|
|[Chyba kompilátoru C3239](compiler-error-c3239.md)|"*typ*': ukazatel na ukazatel interior/pin je zakázán modul common language runtime|
|[Chyba kompilátoru C3240](compiler-error-c3240.md)|"*identifikátor*': musí být abstraktní člen není Přetížená funkce"*typ*.|
|[Chyba kompilátoru C3241](compiler-error-c3241.md)|"*člen*': tuto metodu nezavádí"*rozhraní*.|
...
|[Chyba kompilátoru C3272](compiler-error-c3272.md)|"*symbol*': symbol vyžaduje FieldOffset, protože je členem struktury nebo třídy *type_name* definované pomocí StructLayout(LayoutKind::Explicit)|
|[Chyba kompilátoru C3273](compiler-error-c3273.md)|"*– klíčové slovo*': není povolené pro blok try jazyka C++|
|[Chyba kompilátoru C3274](compiler-error-c3274.md)|Nakonec /&#95;&#95;finally bez odpovídajícího try|
|[Chyba kompilátoru C3275](compiler-error-c3275.md)|"*identifikátor*': nelze použít tento symbol bez kvalifikátoru|
|[Chyba kompilátoru C3276](compiler-error-c3276.md)|"*– klíčové slovo*': přechod z nakonec /&#95;&#95;bloku finally má nedefinované chování během zpracování ukončení|
|[Chyba kompilátoru C3277](compiler-error-c3277.md)|nejde definovat Nespravovaný výčet "*výčet*uvnitř spravované*typ*.|
...
|[Chyba kompilátoru C3285](compiler-error-c3285.md)|pro každý příkaz nejde použít pro proměnné typu '*typ*.|
...
|[Chyba kompilátoru C3287](compiler-error-c3287.md)|Typ '*typ*"(návratový typ GetEnumerator) musí mít vhodnou členskou funkci public MoveNext a veřejnou vlastnost Current|
|[Chyba kompilátoru C3288](compiler-error-c3288.md)|"*typ*': neplatné přistoupení přes ukazatel typ popisovače|
|[Chyba kompilátoru C3289](compiler-error-c3289.md)|"*identifikátor*': triviální vlastnost nemůže být indexovaná|
|[Chyba kompilátoru C3290](compiler-error-c3290.md)|"*typ*': triviální vlastnost nemůže mít odkazový typ.|
