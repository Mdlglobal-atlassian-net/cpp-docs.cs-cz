...
ms.locfileid: "74754573"
---
# <a name="compiler-error-c3241"></a>Chyba kompilátoru C3241

' Method ': Tato metoda nebyla zavedena ' Interface '

Pokud explicitně přepíšete funkci, signatura funkce musí přesně odpovídat deklaraci funkce, kterou přepisujete.
