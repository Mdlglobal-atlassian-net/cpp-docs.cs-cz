...
Instance hodnotového typu (viz [třídy a struktury](../../extensions/classes-and-structs-cpp-component-extensions.md)), které obsahují spravované členy lze vytvořit v zásobníku, ale ne na haldě.
