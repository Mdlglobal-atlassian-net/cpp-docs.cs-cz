...
|Chyba kompilátoru C3402|"*funkce*': nelze přetížení jde vyřešit jedině v aktuálním rozsahu.|
|Chyba kompilátoru C3403|možnost thread_local nejde používat s parametrem/CLR: pure nebo/CLR: safe|
|Chyba kompilátoru C3404|"*vytvořit*': Neočekávaná chyba syntaxe|
|Chyba kompilátoru C3405|"*funkce*': přetížení nejde vyřešit bez deskriptoru complete|
|Chyba kompilátoru C3406|"*– klíčové slovo*': nelze použít ve vysvětlujícím specifikátoru typu|
|Chyba kompilátoru C3407|"*typ*" v tomto kontextu nelze použít|
...
|Chyba kompilátoru C3410|"*identifikátor*': typ explicitního vytvoření instance"*typ*"neodpovídá typu variabilní šablony"*typ*"|
|Chyba kompilátoru C3411|"*typ*' není platný jako velikost pole, protože není typu integer|
...
|Chyba kompilátoru C3422|"*deklarace*': Neshoda typů*typ*"a"*typ*.|
|Chyba kompilátoru C3423|Zastaralé.|
|Chyba kompilátoru C3424|"*typ*': function-style přetypovat na typ array není povolené.|
|Chyba kompilátoru C3425|nejde aktivovat ukazatel na objekt neúplného typu "*typ*.|
|Chyba kompilátoru C3426|nejde aktivovat objekt s neúplným typem "*typ*.|
|Chyba kompilátoru C3427|"*kontextu*": "*– klíčové slovo*' nelze použít s layout_version (*číslo*)|
|Chyba kompilátoru C3428|"*kontextu*": "*– klíčové slovo*se dá používat jedině pro definice nebo deklarace tříd|
|Chyba kompilátoru C3429|"*kontextu*": "*– klíčové slovo*' nejde použít u sjednocení|
|Chyba kompilátoru C3430|Výčet s oborem musí mít název|
|Chyba kompilátoru C3431|"*identifikátor*': *type1* nejde deklarovat jako *typ2*|
|Chyba kompilátoru C3432|"*identifikátor*': Dopředná deklarace výčtu bez oboru musí mít podkladový typ.|
|Chyba kompilátoru C3433|"*identifikátor*': všechny deklarace výčtu musí mít stejný základní typ., byl"*type1*'now'*type2*.|
|Chyba kompilátoru C3434|"*kontextu*': hodnota výčtu '*číslo*"nemůže být reprezentovaná jako"*typ*', hodnota je'*číslo*"|
...
|Chyba kompilátoru C3471|nový název modulu *název* (sada na příkazovém řádku) je v konfliktu s předchozím názvem *název*|
