...
ms.locfileid: "64344512"
---
# <a name="compiler-error-c3609"></a>Chyba kompilátoru C3609

'member': zapečetěné nebo konečné funkce musí být virtuální

[Zapečetěné](../../extensions/sealed-cpp-component-extensions.md) a [konečné](../../cpp/final-specifier.md) klíčová slova jsou povolené jenom pro třídy, struktury nebo člen funkce označené `virtual`.
