...
ms.locfileid: "74738723"
---
# <a name="compiler-error-c3202"></a>Chyba kompilátoru C3202

' ARG name ': neplatný výchozí argument pro parametr šablony ' Parameter ', očekávala se šablona třídy

Byl předán neplatný výchozí argument pro parametr šablony.
