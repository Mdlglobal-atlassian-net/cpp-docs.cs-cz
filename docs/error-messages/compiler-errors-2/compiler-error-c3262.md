---
title: C3262 Chyba kompilátoru | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
---
# <a name="compiler-error-c3262"></a>C3262 chyby kompilátoru
Neplatné pole indexování: dimenze '#' zadaná pro '#'-dimenzí, pole typu.  
  
Pole se nesprávně dolního indexu. Počet indexů nemusí odpovídat počet dimenzí v poli.  
