...
ms.locfileid: "59778992"
---
# <a name="compiler-error-c3655"></a>Chyba kompilátoru C3655

'function': funkce už je explicitně přepsaná

Funkci lze pouze explicitně přepsat jednou. Další informace najdete v tématu [explicitní přepsání](../../extensions/explicit-overrides-cpp-component-extensions.md).
