...
ms.locfileid: "74756354"
---
# <a name="compiler-error-c3650"></a>Chyba kompilátoru C3650

' interface_method ': nelze použít jako explicitní přepsání; musí se jednat o virtuální členskou funkci základní třídy.

Byl proveden pokus o provedení explicitního přepsání u člena, který není virtuální.
