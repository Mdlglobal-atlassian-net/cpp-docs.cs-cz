...
ms.locfileid: "74739192"
---
# <a name="compiler-error-c2800"></a>Chyba kompilátoru C2800

operátor operator nemůže být přetížený.

Následující operátory nelze přečítat: přístup ke členu třídy (`.`), ukazatel na člen (`.*`), překlad oboru (`::`), podmíněný výraz (`? :`) a `sizeof`.
