...
ms.locfileid: "74746484"
---
# <a name="compiler-error-c2518"></a>Chyba kompilátoru C2518

klíčové slovo klíčové slovo je v seznamu základních tříd neplatné. přeskočen

Klíčová slova `class` a `struct` by se neměly zobrazovat v seznamu základních tříd.
