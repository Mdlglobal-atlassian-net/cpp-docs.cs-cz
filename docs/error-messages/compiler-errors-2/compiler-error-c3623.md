...
ms.locfileid: "74740868"
---
# <a name="compiler-error-c3623"></a>Chyba kompilátoru C3623

' Variable ': bitová pole nejsou ve spravovaných typech nebo WinRT podporována.

Použití bitových polí není povoleno u proměnných ve spravované nebo třídy WinRT.
