...
ms.locfileid: "74753195"
---
# <a name="compiler-error-c3718"></a>Chyba kompilátoru C3718

v kontextu členské funkce přijímací třídy se dá volat jenom Event.

`event` lze volat pouze z přijímací třídy.
