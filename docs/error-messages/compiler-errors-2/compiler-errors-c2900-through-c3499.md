---
title: Chyby kompilátoru C2900 až C2999
ms.date: 11/17/2017
f1_keywords:
- C2900
- C2901
...
ms.locfileid: "50466892"
---
# <a name="compiler-errors-c2900-through-c2999"></a>Chyby kompilátoru C2900 až C2999
...
|Chyba|Zpráva|
|-----------|-------------|
|Kompilátoru C2900 chyba|"*deklarátor*': šablony členských funkcí v třídách WinRT musí být"Soukromé","vnitřní"nebo protected private|
|C2901 chyby kompilátoru|"*identifikátor*': Obecné rozhraní nebo delegát nemůžou být veřejné|
...
|C2907 chyby kompilátoru|argument registru "*číslo*' neurčuje platné číslo registru|
...
|C2915 chyby kompilátoru|"*identifikátor*": "*typ*' nelze použít přímo na publikované ploše typu WinRT. Použití "Platform::Object ^' místo toho k předání tohoto typu|
|C2916 chyby kompilátoru|"*identifikátor*": [FlagsAttribute] musí být zadaný (jenom) pro výčet public pomocí "unsigned int" základní typ|
...
|C2922 chyby kompilátoru|"*rozhraní*': rozhraní WinRT A nemůže obsahovat statické členy|
...
|C2925 chyby kompilátoru|rutina __declspec(Interrupt) nemůže používat s plovoucí desetinnou čárkou|
|C2926 chyby kompilátoru|"*identifikátor*': výchozí inicializátor členu se nepovoluje pro člen anonymní struktury v rámci sjednocení|
...
|C2938 chyby kompilátoru|"*identifikátor*': nepovedlo se specializovat šablonu aliasů|
...
|C2949 chyby kompilátoru|možnost thread_local není podporovaná s možností/Kernel.|
...
|C2954 chyby kompilátoru|argument word instrukce není v rozsahu|
...
|C2956 chyby kompilátoru|vybrala jako funkce dealokace vybere velikostí dealokace funkce 'operator delete (void *, size_t)".|
...
|C2961 chyby kompilátoru|"*funkce*': nekonzistentní explicitní vytváření instancí, předchozí explicitní vytváření instancí nejsou specifikovány"*argument*.|
...
|C2965 chyby kompilátoru|__declspec (*specifikátor*) není podporovaná s možností/Kernel.|
|C2966 chyby kompilátoru|"*identifier1*': musí mít stejné __declspec(code_seg(...)) jako svou základní třídou*identifier2*.|
|C2967 chyby kompilátoru|"*identifikátor*': přepisující virtuální funkce musí mít stejné __declspec(code_seg(...)) jako přepsané virtuální funkce|
|C2968 chyby kompilátoru|"*identifikátor*': rekurzivní deklarace aliasu|
...
|C2972 chyby kompilátoru|"*typ*': parametr šablony"*parametr*': typ beztypového argumentu není platný|
...
|C2980 chyby kompilátoru|Zpracování výjimek jazyka C++ není podporovaná s možností/Kernel.|
|C2981 chyby kompilátoru|Dynamická podoba "*– klíčové slovo*" není podporovaná s možností/Kernel.|
|C2982 chyby kompilátoru|"*deklarace*': používá jiný __declspec(code_seg(...)): byl"*identifier1*'now'*identifier2*"|
|C2983 chyby kompilátoru|"*deklarace*': všechny deklarace musí mít stejné __declspec(code_seg(...))|
|C2984 chyby kompilátoru|Zastaralé.|
|C2985 chyby kompilátoru|"*argument*': argument __declspec(code_seg(...)) musí být textový oddíl|
|C2986 chyby kompilátoru|"*identifikátor*': __declspec(code_seg(...)) může používat jedině pro třídu nebo funkci|
|C2987 chyby kompilátoru|deklarace nemůže mít oba __declspec (code_seg ("*identifikátor*")) a __declspec (code_seg ("*hodnotu*"))|
...
|[Chyba kompilátoru C2996](compiler-error-c2996.md)|"*funkce*': rekurzivní definice šablony funkcí|
|C2997 chyby kompilátoru|"*funkce*': hranice pole se nedá dedukovat z výchozí inicializátor členu|
|[Chyba kompilátoru C2998](compiler-error-c2998.md)|"*deklarátor*': nemůže být definice šablony|
|C2999 chyby kompilátoru|Neznámá chyba Zvolte prosím příkaz technická podpora v nabídce Nápověda pro Visual C++, nebo otevřete soubor nápovědy technické podpory pro další informace|
