...
ms.locfileid: "74742129"
---
# <a name="compiler-error-c3019"></a>Chyba kompilátoru C3019

přírůstek v příkazu OpenMP for má nesprávnou podobu.

Přírůstek součásti smyčky `for` OpenMP musí používat proměnnou indexu na levé i pravé straně operátoru.
