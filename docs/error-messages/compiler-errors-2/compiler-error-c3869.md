...
ms.locfileid: "58766778"
---
# <a name="compiler-error-c3869"></a>Chyba kompilátoru C3869

v omezení gcnew chybí prázdný parametr seznam '().

`gcnew` Zvláštní omezení byl zadán bez prázdný seznam parametrů. Zobrazit [omezení parametrů obecných typů (C + +/ CLI)](../../extensions/constraints-on-generic-type-parameters-cpp-cli.md) Další informace.
