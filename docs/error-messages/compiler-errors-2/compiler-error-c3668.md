...
ms.locfileid: "74758161"
---
# <a name="compiler-error-c3668"></a>Chyba kompilátoru C3668

' Method ': metoda s specifikátorem přepisu ' override ' nepřepsala žádné metody základní třídy

Funkce se pokusila přepsat neexistující funkci.
