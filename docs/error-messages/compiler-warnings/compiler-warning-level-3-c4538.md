...
Klíčové slovo kvalifikátor nesprávně použila na pole. Další informace najdete v tématu [pole](../../extensions/arrays-cpp-component-extensions.md).
