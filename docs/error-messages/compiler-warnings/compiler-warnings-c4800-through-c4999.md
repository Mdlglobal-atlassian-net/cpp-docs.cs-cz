...
|[Upozornění kompilátoru (úroveň 4) C4820](compiler-warning-level-4-c4820.md)|odsazení*bajtů v*bajtech přidané po sestavení '*MEMBER_NAME*'|
...
|Upozornění kompilátoru C4843|'*typ1*': obslužná rutina výjimky odkazu na typ pole nebo funkce je nedostupná, místo toho použijte '*typ2*'.|
|Upozornění kompilátoru C4844|' export Module *module_name*; je teď upřednostňovanou syntaxí pro deklaraci rozhraní modulu.|
| Upozornění kompilátoru (úroveň 4) C4845 | '\_\_declspec (No\_init\_All) ' se ignoruje, pokud na příkazovém řádku nebyl zadán parametr '/d1initall\[0\|1\|2\|3] '. |
...
| Upozornění kompilátoru (úroveň 4) C4847 | \_\_declspec (No\_init\_All) se dá použít jedině pro funkci, typ třídy nebo místní proměnnou: ignoruje se. |
| Upozornění kompilátoru (úroveň 1) C4848 | podpora standardních atributů No\_jedinečnou\_Address v C++ 17 a starších verzích je rozšířením dodavatele. |
|[Upozornění kompilátoru (úroveň 4) C4866](c4866.md)| Kompilátor nemůže vyhodnotit pořadí vyhodnocování zleva doprava pro volání *operator_name*|
...
|[Upozornění kompilátoru (úroveň 4) C4868](compiler-warning-c4868.md)|kompilátor_File_(*Line_Number*) nemůže v seznamu inicializace v závorkách vyhovět pořadí vyhodnocování zleva doprava.|
|Upozornění kompilátoru (úroveň 2) C4872|Při kompilování grafu volání pro: concurrency::p arallel_for_each v*umístění*se zjistilo dělení nulou s plovoucí desetinnou čárkou.|
|Upozornění kompilátoru (úroveň 1) C4880|přetypování z ' const *type_1*' na '*type_2*': odtypování odconst z ukazatele nebo odkazu může mít za následek nedefinované chování ve funkci s omezením amp|
|Upozornění kompilátoru (úroveň 4) C4881|konstruktor nebo destruktor se nebudou volat pro tile_static proměnnou*Variable*.|
...
|[Upozornění kompilátoru (úroveň 1) C4910](compiler-warning-level-1-c4910.md)|identifikátor\<>: __declspec (dllexport) a extern nejsou pro explicitní vytváření instancí kompatibilní.|
...
|[Upozornění kompilátoru (úroveň 1) C4920](compiler-warning-level-1-c4920.md)|Enum enum member member_1 = value_1 se již v výčtu výčtu zobrazila jako member_2 = value_2|
...
|[Upozornění kompilátoru (úroveň 4) C4932](compiler-warning-level-4-c4932.md)|__identifier (*identifikátor*) a \__identifier (*identifikátor*) nelze rozlišit.|
|Upozornění kompilátoru (úroveň 1) C4934|možnost __delegate (vícesměrové vysílání) je zastaralá, místo toho použijte\__delegate.|
...
|[Upozornění kompilátoru (úroveň 1, chyba) C4936](compiler-warning-c4936.md)|Tento __declspec je podporován pouze při kompilaci s možností/CLR nebo/CLR: Pure.|
...
|[Upozornění kompilátoru (úroveň 4) C4938](compiler-warning-level-4-c4938.md)|*var*: proměnlivé omezení desetinné čárky může způsobit nekonzistentní výsledky v/FP: strict nebo #pragma fenv_access|
...
|Upozornění kompilátoru C4954|'*Function*': není profilované (obsahuje výraz __int64 Switch)|
...
|Upozornění kompilátoru (úroveň 1) C4966|klíčové slovo*Function*má __code_seg anotace s nepodporovaným názvem segmentu, Poznámka se ignoruje.|
|Upozornění kompilátoru C4970|konstruktor Delegate: cílový objekt se ignoruje, protože*typ*je statický.|
|Upozornění kompilátoru (úroveň 1) C4971|Pořadí argumentů: \<cílový objekt >, \<cílových funkcí > pro konstruktor Delegate je zastaralé, použijte \<cílovou funkci >, \<cílový objekt = "" >|
...
|Upozornění kompilátoru (úroveň 3) C4981|Warbird:*funkce functioned*s označením __forceinline není vložená, protože obsahuje sémantiku výjimky.|
|[Upozornění kompilátoru C4984](compiler-warning-c4984.md)|If constexpr je rozšíření jazyka C++ 17.|
|[Upozornění kompilátoru (úroveň 4) C4985](compiler-warning-level-4-c4985.md)|'*symbol_name*': atributy nejsou přítomny v předchozí deklaraci.|
...
|Upozornění kompilátoru (úroveň 1) C5028|*Name*: zarovnání zadané v předchozí deklaraci (*Number*) není zadané v definici.|
...
| [Upozornění kompilátoru (úroveň 2) C5046](c5046.md) | '*Function*': symbol zahrnující typ s interní vazbou není definován |
| Upozornění kompilátoru (úroveň 1) C5047 | Použití nestandardních \_\_, pokud\_existuje s moduly, se nepodporuje. |
| Upozornění kompilátoru (úroveň 1) C5048 | Použití makra '*název_makra*' může mít za následek Nedeterministický výstup |
| Upozornění kompilátoru (úroveň 1) C5049 | '*String*': vložení úplné cesty může mít za následek výstup závislý na počítači |
| Upozornění kompilátoru (úroveň 1) C5050 | Možné nekompatibilní prostředí při importu modulu*module_name*: *problém* |
| Upozornění kompilátoru (úroveň 1) C5100 | \_\_VA\_ARGS\_\_ je vyhrazena pro použití v makrech variadické |
...
| Upozornění kompilátoru (úroveň 1) C5104 | v seznamu nahrazení makra se našla hodnota "*řetěze*#*řetěze*". měli jste na mysli "*řetěze*" "#*řetěze*"? |
