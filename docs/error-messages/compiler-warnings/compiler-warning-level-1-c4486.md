...
Protože funkce privátního virtuálního člena spravované třídy nebo struktury nelze přistupovat ani je přepsána, by měla být označena [zapečetěné](../../extensions/sealed-cpp-component-extensions.md).
