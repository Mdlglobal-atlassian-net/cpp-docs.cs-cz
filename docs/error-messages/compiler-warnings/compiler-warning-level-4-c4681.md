---
title: Upozornění (úroveň 4) C4681 kompilátoru | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46114485"
---
# <a name="compiler-warning-level-4-c4681"></a>Kompilátor upozornění (úroveň 4) C4681

'class': Konstrukt coclass nespecifikuje výchozí rozhraní, který je zdrojem událostí

A [zdroj](../../windows/source-cpp.md) nebyla zadána pro třídu.
