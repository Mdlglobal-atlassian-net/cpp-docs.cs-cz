---
title: Upozornění (úroveň 1) C4378 kompilátoru | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46135799"
---
# <a name="compiler-warning-level-1-c4378"></a>Kompilátor upozornění (úroveň 1) C4378

Musí se získat ukazatele funkce pro spouštění inicializačních; Vezměte v úvahu System::ModuleHandle::ResolveMethodHandle

V části **/CLR**, inicializátor symboly obsahují funkce tokeny, ne ukazatele na funkce.  Je potřeba převést na ukazatele pomocí tokenů <xref:System.ModuleHandle.ResolveMethodHandle%2A>.
