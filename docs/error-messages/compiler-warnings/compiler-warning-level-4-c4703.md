---
title: Upozornění kompilátoru (úroveň 4) C4703
ms.date: 11/04/2016
f1_keywords:
- C4703
helpviewer_keywords:
...
ms.locfileid: "76518358"
---
# <a name="compiler-warning-level-4-c4703"></a>Upozornění kompilátoru (úroveň 4) C4703

Používá se potenciálně neinicializovaná lokální proměnná ukazatele Name.

*Název* proměnné místního ukazatele byl pravděpodobně použit bez přiřazení hodnoty. To může vést k nepředvídatelným výsledkům.
