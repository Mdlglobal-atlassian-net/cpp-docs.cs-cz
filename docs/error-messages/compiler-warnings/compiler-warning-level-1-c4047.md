---
title: "Kompilátoru (úroveň 1) upozornění C4047 | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
'operátor': "identifier1" se liší v úrovních dereference z 'identifier2.  
 ...
 Ukazatel můžete proměnné (jednu úroveň dereference), přejděte na další ukazatele, který se odkazuje na proměnné (dvě úrovně dereference) a tak dále.  
