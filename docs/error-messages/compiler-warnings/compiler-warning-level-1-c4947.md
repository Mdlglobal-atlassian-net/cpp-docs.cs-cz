---
title: Upozornění (úroveň 1) C4947 kompilátoru | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46050447"
---
# <a name="compiler-warning-level-1-c4947"></a>Kompilátor upozornění (úroveň 1) C4947

'typ nebo člen': označené jako zastaralé

Člen nebo typ byl označený jako zastaralý s <xref:System.ObsoleteAttribute> třídy.

## <a name="example"></a>Příklad

Následující ukázka generuje C4947:
