---
title: Upozornění kompilátoru (úroveň 1) C4947
ms.date: 11/04/2016
f1_keywords:
- C4947
helpviewer_keywords:
...
ms.locfileid: "80199094"
---
# <a name="compiler-warning-level-1-c4947"></a>Upozornění kompilátoru (úroveň 1) C4947

' type_or_member ': označeno jako zastaralé

Člen nebo typ byl označen jako zastaralý s třídou <xref:System.ObsoleteAttribute>.
