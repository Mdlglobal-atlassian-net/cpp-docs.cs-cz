...
|[Závažná chyba C1001](../../error-messages/compiler-errors-1/fatal-error-c1001.md)|V kompilátoru došlo k vnitřní chybě.<br /><br /> (soubor kompilátoru "*souboru*!, řádek *číslo*)<br /><br /> Chcete-li tento problém vyřešit, zkuste zjednodušit nebo změnit program v blízkosti míst uvedených výše. Zvolte prosím příkaz technická podpora v nabídce Nápověda pro Visual C++, nebo otevřete soubor nápovědy technické podpory pro další informace|
...
|Závažná chyba C1012|Neshoda závorek: chybí "*znak*"|
|Závažná chyba C1013|limit kompilátoru: moc velký počet levých závorek|
|Závažná chyba C1014|moc velký počet vložených souborů: hloubka = *číslo*|
|Závažná chyba C1016|ifndef #ifdef / # byl očekáván identifikátor|
...
|Závažná chyba C1021|Neplatný příkaz preprocesoru "*řetězec*.|
|Závažná chyba C1022|očekávané #endif|
|Závažná chyba C1023|"*souboru*': došlo k neočekávané chybě se zkuste znovu sestavit soubor pch|
...
|Závažná chyba C1037|nejde otevřít souboru objektu "*souboru*.|
|Závažná chyba C1038|limit kompilátoru: "*funkce*': ovládací prvek stavu toku moc složitý; Zjednodušte funkci|
...
|Závažná chyba C1045|limit kompilátoru: Specifikace propojení jsou vnořené moc hluboko|
...
|Závažná chyba C1047|Soubor objektu nebo knihovny '*souboru*' byl vytvořen pomocí staršího kompilátoru než jiné objekty; znovu sestavit starší objekty a knihovny|
...
|Závažná chyba C1053|"*funkce*': funkce je příliš velká|
...
|Závažná chyba C1074|"IDB" není platná přípona souboru PDB: *souboru*|
...
|Závažná chyba C1086|Nelze vyhledat *typ* souboru: "*souboru*': *zprávy*|
|Závažná chyba C1087|nejde provést operace tell *typ* souboru: "*souboru*': *zprávy*|
|Závažná chyba C1088|nejde vyprázdnit *typ* souboru: "*souboru*': *zprávy*|
|Závažná chyba C1089|nejde zkrátit *typ* souboru: "*souboru*': *zprávy*|
|Závažná chyba C1090|Volání PDB API selhalo, kód chyby: '*kód*":"*zpráva*.|
|Závažná chyba C1091|limit kompilátoru: řetězec je delší než *číslo* délku bajtů|
...
|Závažná chyba C1099|Upravit a pokračovat ukončující kompilace modulu|
...
|Závažná chyba C1104|Závažná chyba při importu libid: "*zpráva*.|
...
|Závažná chyba C1108|nejde najít DLL: "*souboru*.|
|Závažná chyba C1109|nepovedlo se najít "*symbol*"v knihovně DLL'*souboru*"|
...
|Závažná chyba C1190|spravovaný cílený kód vyžaduje "/ clr: možnost|
...
|Závažná chyba C1196|"*identifikátor*': identifikátor našel v knihovně typů '*typelib*" není platný identifikátor C++|
...
|Závažná chyba C1202|rekurzivní typ nebo kontext závislosti funkce příliš složitý.|
|Závažná chyba C1205|Obecné typy nejsou podporovány verzí modulu runtime nainstalovaného|
|Závažná chyba C1206|Data na úrovni appdomain není podporovaná ve verzi modulu runtime nainstalovaného|
|Závažná chyba C1207|Spravované šablony nejsou podporované ve verzi modulu runtime nainstalovaný|
|Závažná chyba C1208|Přidělení referenčních tříd pro zásobník není podporovaná ve verzi modulu runtime nainstalovaného|
|Závažná chyba C1209|Sestavení Friend nejsou podporovaná ve verzi modulu runtime nainstalovaný|
|Závažná chyba C1210|/ CLR: pure a/CLR: safe nejsou podporované ve verzi modulu runtime nainstalovaný|
|Závažná chyba C1211|Vlastní atribut TypeForwardedTo není podporován verzí modulu runtime nainstalovaného|
...
|Závažná chyba C1310|optimalizace na základě profilu nejsou s OpenMP dostupné.|
...
|Závažná chyba C1312|Moc velký počet podmíněných větví ve funkci.  Zjednodušte nebo Refaktorujte zdrojový kód.|
...
|Závažná chyba C1352|Neplatný nebo poškozený kód MSIL ve funkci '*funkce*"z modulu'*modulu*"|
|Závažná chyba C1353|Operace metadat se nepovedla: modul runtime není nainstalovaný nebo nesouhlasí jeho verze|
...
|Závažná chyba C1383|– možnost kompilátoru /GL je nekompatibilní s nainstalovanou verzí modulu common language runtime|
...
|Závažná chyba C1508|limit kompilátoru: "*funkce*': více než 65 535 bajtů argumentu|
...
|Závažná chyba C1852|"*souboru*' není platný předkompilovaného hlavičkového souboru|
...
|Závažná chyba C1903|nejde obnovit z přechozích chyb; kompilace se zastavuje|
|Závažná chyba C1904|interakce se špatným zprostředkovatelem: "*souboru*.|
