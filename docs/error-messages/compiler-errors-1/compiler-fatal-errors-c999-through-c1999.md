...
|Chyba|Zpráva|
|-----------|-------------|
|[Závažná chyba C999](../../error-messages/compiler-errors-1/fatal-error-c999.md)|Neznámá zpráva Zvolte prosím příkaz se na technickou podporu v nabídce Nápověda Visual C++, nebo otevře soubor nápovědy se na technickou podporu pro další informace|
|[Závažná chyba C1001](../../error-messages/compiler-errors-1/fatal-error-c1001.md)|V kompilátoru došlo k vnitřní chybě.<br /><br /> (soubor kompilátoru '*soubor*', řádku *číslo*)<br /><br /> Chcete-li vyřešit tento problém, zkuste zjednodušit nebo změna programu blízkosti umístění uvedené výše. Zvolte prosím příkaz se na technickou podporu v nabídce Nápověda Visual C++, nebo otevřít soubor nápovědy se na technickou podporu pro další informace|
|[Závažná chyba C1002](../../error-messages/compiler-errors-1/fatal-error-c1002.md)|kompilátoru nemá dostatek místa na haldy při průchodu 2|
|[Závažná chyba C1003](../../error-messages/compiler-errors-1/fatal-error-c1003.md)|Počet chyb překračuje *číslo*; zastavení kompilace|
|[Závažná chyba C1004](../../error-messages/compiler-errors-1/fatal-error-c1004.md)|neočekávané end souboru nalezen|
|[Závažná chyba C1005](../../error-messages/compiler-errors-1/fatal-error-c1005.md)|řetězec příliš dlouhý pro vyrovnávací paměť|
|[Závažná chyba C1007](../../error-messages/compiler-errors-1/fatal-error-c1007.md)|Příznak nebyl rozpoznán '*řetězec*'v'*možnost*.|
|[Závažná chyba C1008](../../error-messages/compiler-errors-1/fatal-error-c1008.md)|nebyl zadán vstupní soubor|
|[Závažná chyba C1009](../../error-messages/compiler-errors-1/fatal-error-c1009.md)|omezení kompilátoru: makra vnořeny příliš hluboko|
|[Závažná chyba C1010](../../error-messages/compiler-errors-1/fatal-error-c1010.md)|Neočekávaný konec souboru při hledání předkompilovaných hlaviček. Nezapomněli jste přidat ' #include <*souboru*> se ke zdroji?|
|Závažná chyba C1012|závorky: chybí '*znak*"|
|Závažná chyba C1013|omezení kompilátoru: příliš mnoho otevřít závorky|
|Závažná chyba C1014|příliš mnoho souborů patří: hloubka = *číslo*|
|Závažná chyba C1016|#ifdef / #ifndef byl očekáván identifikátor|
...
|Závažná chyba C1023|'*souboru*': Neočekávaná chyba s pch, zkuste znovu sestavit pch|
|[Závažná chyba C1026](../../error-messages/compiler-errors-1/fatal-error-c1026.md)|přetečení zásobníku analyzátoru, program příliš složitý|
|[Závažná chyba C1033](../../error-messages/compiler-errors-1/fatal-error-c1033.md)|Nelze otevřít databázi programu '*soubor*.|
|Závažná chyba C1034|*soubor*: žádné patří nastavení cesty|
|Závažná chyba C1035|výraz je příliš složitý; zjednodušení výraz|
|Závažná chyba C1036|nelze přepsat dřívější formát databáze programu, odstranit,*souboru*se a znovu zkompiluje|
|Závažná chyba C1037|Nelze otevřít soubor objektu '*soubor*.|
|Závažná chyba C1038|omezení kompilátoru: '*funkce*': řízení toku stavu příliš složitý; zjednodušit – funkce|
|Závažná chyba C1041|Nelze otevřít databázi programu '*souboru*'; Pokud více CL. EXE zapisovat do stejné. PDB souboru, použijte prosím /FS|
|Závažná chyba C1045|omezení kompilátoru: Specifikace propojení vnořeny příliš hluboko|
|[Závažná chyba C1046](../../error-messages/compiler-errors-1/fatal-error-c1046.md)|omezení kompilátoru: *struktura* vnořeny příliš hluboko|
...
|Závažná chyba C1091|omezení kompilátoru: řetězec překračuje *číslo* délku bajtů|
...
|Závažná chyba C1208|Přidělování referenční třídy v zásobníku není podporována verze nainstalován modul runtime|
...
|[Závažná chyba C1902](../../error-messages/compiler-errors-1/fatal-error-c1902.md)|Neshoda správce databáze programu; Zkontrolujte, zda vaše instalace|
