...
|C2303 chyby kompilátoru|Strukturované zpracování výjimek nejde používat v korutině.|
|C2304 chyby kompilátoru|"*– klíčové slovo*' nelze použít uvnitř bloku catch.|
|C2305 chyby kompilátoru|"*souboru*' neobsahuje ladicí informace pro tento modul.|
|C2306 chyby kompilátoru|"*souboru*' neobsahuje nejaktuálnější ladicí informace pro tento modul.|
...
|C2314 chyby kompilátoru|– klíčové slovo '*keyword1*' se již nepoužívá: použijte "*keyword2*" místo toho|
...
|C2321 chyby kompilátoru|"*identifikátor*' je klíčové slovo a v tomto kontextu nelze použít|
|[Chyba kompilátoru C2322](compiler-error-c2322.md)|"*identifikátor*': adresa dllimport"*identifikátor*"není statická.|
|C2323 chyby kompilátoru|"*identifikátor*': bez operátoru new nebo delete funkce nemůže být deklarovaný jako static nebo v oboru názvů, než globální obor názvů|
...
|C2328 chyby kompilátoru|"*– klíčové slovo*': klíčové slovo se ještě nepodporuje.|
|C2329 chyby kompilátoru|"*identifikátor*': možnost __ptr64 není dostupná pro ukazatele na funkce|
|C2330 chyby kompilátoru|zadání implementation_key () je platná pouze v oblasti ohraničené #pragma start_map_region/stop_map_region.|
|C2331 chyby kompilátoru|přístup k '*identifikátor*"teď definovaný jako"*accessibility1*", dřív byl definovaný jako"*accessibility2*.|
...
|C2335 chyby kompilátoru|"*identifikátor*': typ nemůže být zavedený seznamem parametrů funkcí|
...
|C2339 chyby kompilátoru|"*identifikátor*': Neplatný typ ve vloženém IDL|
|C2340 chyby kompilátoru|"*identifikátor*': 'static' jde použít jenom uvnitř definice třídy|
...
|C2343 chyby kompilátoru|"*části*': konfliktní atributy section|
...
|C2358 chyby kompilátoru|"*identifikátor*': statická vlastnost nemůže být definovaná mimo definici třídy|
...
|C2363 chyby kompilátoru|funkce vnitřního číselného limitu kompilátoru vyžaduje jako argument řetězcový literál|
...
|C2366 chyby kompilátoru|"*identifikátor*': předefinování; odlišné specifikátory implementation_key|
...
|[Chyba kompilátoru C2394](compiler-error-c2394.md)|"*typ*:: – operátor *operátor*': operátor CLR/WinRT není platný. Nejméně jeden parametr musí být z následujících typů: nejde ^ ", nejde ^ %', 'T ^ &", kde T = "*typ*"|
|[Chyba kompilátoru C2395](compiler-error-c2395.md)|"*typ*:: – operátor *operátor*': operátor CLR/WinRT není platný. Nejméně jeden parametr musí být z následujících typů: nejde ", nejde %', 'T &", nejde ^ ", nejde ^ %", nejde ^ & ", kde T ="*typ*"|
|[Chyba kompilátoru C2396](compiler-error-c2396.md)|"*type1*:: – operátor *type2*': uživatelem definovaný převod funkce CLR/WinRT, není platný. Musíte převést nebo převést na: t ^ ", nejde ^ %', 'T ^ &", kde T = "*type1*"|
|[Chyba kompilátoru C2397](compiler-error-c2397.md)|Převod z '*type1*"do"*type2*' vyžaduje zúžení převodu|
|C2398 chyby kompilátoru|Element '*číslo*': převod z '*type1*"do"*type2*' vyžaduje zúžení převodu|
