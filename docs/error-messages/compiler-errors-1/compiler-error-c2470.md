...
ms.locfileid: "74743741"
---
# <a name="compiler-error-c2470"></a>Chyba kompilátoru C2470

' function ': vypadá jako definice funkce, ale neexistuje seznam parametrů; přeskakuje se zjevné tělo.

V definici funkce chybí seznam argumentů.
