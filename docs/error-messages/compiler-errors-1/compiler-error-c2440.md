...
Vizuál C++ kompilátoru již neumožňuje [operátor const_cast](../../cpp/const-cast-operator.md) pro přetypování směrem dolů, když zdrojový kód, který používá **/CLR** programování je zkompilován.
