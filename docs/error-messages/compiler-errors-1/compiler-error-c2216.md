---
title: Chyba kompilátoru C2216 | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46070142"
---
# <a name="compiler-error-c2216"></a>Chyba kompilátoru C2216

'keyword1' nelze použít s "keyword2.

Dvě klíčová slova, které se vzájemně vylučují byly použity dohromady.

## <a name="example"></a>Příklad

Následující ukázka generuje C2216.
