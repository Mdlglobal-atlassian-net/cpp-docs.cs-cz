---
title: C2216 Chyba kompilátoru | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33171556"
---
# <a name="compiler-error-c2216"></a>C2216 chyby kompilátoru
'keyword1' nelze použít s 'keyword2.  
  
 Dva klíčová slova, která se vzájemně vylučují měla použít společně.  
