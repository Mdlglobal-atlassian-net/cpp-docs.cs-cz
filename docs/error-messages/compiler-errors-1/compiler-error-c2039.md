---
title: Chyba kompilátoru C2039 | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46091228"
---
# <a name="compiler-error-c2039"></a>Chyba kompilátoru C2039

'identifier1': není členem "identifier2.

Kód správně volá nebo odkazuje na člen struktury, třídy nebo sjednocení.
...
C2039 může také dojít, pokud při pokusu o přístup k výchozímu indexeru nesprávně. Následující příklad definuje komponenty vytvořené v jazyce C#.
...
C2039 může také dojít, pokud použijte obecné typy. Následující ukázka generuje C2039.
