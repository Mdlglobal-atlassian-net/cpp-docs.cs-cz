---
title: Stránky vlastností nástroje manifest | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-ide
...
ms.locfileid: "33321984"
---
# <a name="manifest-tool-property-pages"></a>Stránky vlastností nástroje manifest
Použití **Nástroj Manifest** stránky vlastností nastavit možnosti pro mt.exe sestavení.  
  
 Další informace o nástroji manifest najdete v tématu [Mt.exe](http://msdn.microsoft.com/library/aa375649).  
