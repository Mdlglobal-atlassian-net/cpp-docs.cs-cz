...
Po dokončení těchto návody, jste připravení začít vytvářet své vlastní projekty. Další informace a materiály pro vývoje v jazyce Visual C++, najdete v části [Visual C++ v sadě Visual Studio](https://msdn.microsoft.com/library/60k1461a.aspx).
