...
![Zvýrazněné – makro. ](../ide/media/hint-squiggle-and-actions.png "Pomocného parametru vlnovku a rychlé akce")
...
![Makra v přeskočené možnost procházení oblastech. ](../ide/media/skipped-regions-squiggle-option.png "Přeskočeno možnost vlnovku oblastech.")
