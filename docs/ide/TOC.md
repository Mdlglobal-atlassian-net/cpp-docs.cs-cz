...
## [Vytváření rozhraní modelu COM (Visual C++)](creating-a-com-interface-visual-cpp.md)
### [Úpravy rozhraní modelu COM](editing-a-com-interface.md)
## [Implementace bodu připojení (Visual C++)](implementing-a-connection-point-visual-cpp.md)
### [Průvodce implementací bodu připojení](implement-connection-point-wizard.md)
## [Implementace rozhraní (Visual C++)](implementing-an-interface-visual-cpp.md)
### [Průvodce implementací rozhraní](implement-interface-wizard.md)
## [Navigace strukturou třídy (Visual C++)](navigating-the-class-structure-visual-cpp.md)
## [Přepisování virtuální funkce (Visual C++)](overriding-a-virtual-function-visual-cpp.md)
