...
Při psaní C++bude IntelliCode pomáhat při používání oblíbených knihoven, jako je C++ standardní knihovna. Kontext kódu slouží jako první k poskytnutí nejužitečnější doporučení. V následujícím příkladu `size` je členská funkce běžně používána `sort` s funkcí, takže je umístěná v horní části seznamu výsledků.

![IntelliCode&#43; &#43; ](../ide/media/intellicode-cpp.png " IntelliCode v jazyce CC++ ")

::: moniker range="vs-2019"

V aplikaci Visual Studio 2019 je IntelliCode k dispozici jako volitelná komponenta v úloze  **C++ vývoj desktopových** aplikací. Abyste se ujistili, že je IntelliCode C++aktivní pro, vyhledejte možnost **nástroje** > **Možnosti** > **IntelliCode** > **Obecné** a nastavte  **C++ základní model** na **povoleno**.
...
Kliknutím na **<T>** ikonu rozbalíte nebo sbalíte **panel šablon**. Kliknutím na ikonu tužky nebo dvojitým kliknutím na **panel šablon** otevřete okno **Upravit** . 
