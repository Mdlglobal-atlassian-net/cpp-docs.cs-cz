...
|Komponenty ASP knihovny ATL|[Průvodce komponentou stránky ASP knihovny ATL](../atl/reference/atl-active-server-page-component-wizard.md)|  
|Ovládací prvek ATL|[Průvodce ovládacím prvkem knihovny ATL](../atl/reference/atl-control-wizard.md)|  
|Dialogové okno knihovny ATL|[Dialogové okno Průvodce knihovny ATL](../atl/reference/atl-dialog-wizard.md)|  
|Komponenta knihovny ATL COM + 1.0|[ATL COM + 1.0 součást Průvodce](../atl/reference/atl-com-plus-1-0-component-wizard.md)|  
|Příjemce knihovny ATL OLEDB|[Průvodce příjemce ATL OLE DB](../atl/reference/atl-ole-db-consumer-wizard.md)|  
|Zprostředkovatele služeb ATL OLEDB|[Průvodce zprostředkovatele OLE DB knihovny ATL](../atl/reference/atl-ole-db-provider-wizard.md)|  
|Stránka vlastností knihovny ATL|[Stránka průvodce vlastností knihovny ATL](../atl/reference/atl-property-page-wizard.md)|  
|Jednoduchého objektu knihovny ATL|[Průvodce jednoduchého objektu knihovny ATL](../atl/reference/atl-simple-object-wizard.md)|  
...
|Příjemce knihovny MFC rozhraní ODBC|[Průvodce příjemcem knihovny MFC rozhraní ODBC](../mfc/reference/mfc-odbc-consumer-wizard.md)|  
