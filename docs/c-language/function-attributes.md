---
title: Funkce atributy | Microsoft Docs
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
**Konkrétní Microsoft**  
 ...
 Volitelné *atribut seq* nonterminal umožňuje vybrat konvence volání na základě na funkce. Funkce je možné určit také jako `__fastcall` nebo `__inline`.  
