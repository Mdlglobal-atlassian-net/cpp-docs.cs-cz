---
title: Chování definované implementací
ms.date: 11/04/2016
helpviewer_keywords:
...
> [!NOTE]
> Tato část popisuje pouze anglickou jazykovou verzi kompilátoru jazyka C. Implementace jazyka Microsoft C v jiných jazycích se mohou poněkud lišit.
