---
title: Omezení konstant s plovoucí desetinnou čárkou s | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
|**FLT_GUARD**||0|
|**FLT_MANT_DIG**<br />**DBL_MANT_DIG**<br />**LDBL_MANT_DIG**|Počet číslic v určeném konstantou **FLT_RADIX** v mantise s plovoucí desetinnou čárkou. Číselný základ je 2. Tyto hodnoty tedy představují bity.|24<br />53<br />53|
...
|**FLT_MAX_EXP**<br />**DBL_MAX_EXP**<br />**LDBL_MAX_EXP**|Maximální celočíselná hodnota tak, aby **FLT_RADIX** umocněné na toto číslo je reprezentovatelné číslo s plovoucí desetinnou čárkou.|128<br />1024<br />1024|
