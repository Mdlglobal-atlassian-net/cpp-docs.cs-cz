---
title: Základní adresování | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
ms.locfileid: "46059924"
---
# <a name="based-addressing"></a>Základní adresování

Tento oddíl obsahuje následující témata:

- [__based – gramatika](../cpp/based-grammar.md)
