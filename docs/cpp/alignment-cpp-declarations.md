...
1. Char – _pad0 [3] pro zarovnání členských b int na hranici čtyř bajtů

1. Char – _pad1 [1] pro zarovnání prvků pole struktury _x struktura panelu [3];

1. Odsazení se zarovná elementy panelu [3] způsobem, který umožňuje přístup k fyzické.
