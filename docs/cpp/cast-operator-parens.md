---
title: 'Operátor přetypování: () | Dokumentace Microsoftu'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
[Operátor převodu explicitního typu: ()](../cpp/explicit-type-conversion-operator-parens.md)<br/>
