---
title: dynamic_cast – operátor | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
```  
 ...
 ![Hierarchie, která zobrazuje vícenásobná dědičnost třídy](../cpp/media/vc39011.gif "vc39011")  
Hierarchie tříd zobrazují vícenásobná dědičnost  
...
```  
 ...
 ![Třída hierarchie, která ukazuje virtuální základní třídy](../cpp/media/vc39012.gif "vc39012")  
Hierarchie tříd s virtuálními základními třídami  
 ...
 ![Hierarchie, která zobrazuje duplicitní základní třídy třídy](../cpp/media/vc39013.gif "vc39013")  
Hierarchie tříd zobrazují duplicitní základní třídy  
