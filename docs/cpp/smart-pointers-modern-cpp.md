...
3.  Předejte nezpracovaný ukazatel **nové**-ed objekt v konstruktoru inteligentního ukazatele. (Některé funkce nástrojů nebo konstruktory inteligentního ukazatele to provedou za vás.)  
  
4.  Použijte přetížené `->` a `*` operátory pro přístup k objektu.  
