...
2.  *Seznam parametrů* volitelné. (Označované také jako *lambda declarator*)  
  
3.  *proměnlivé specifikace* volitelné.  
  
4.  *Specifikace výjimky* volitelné.  
  
5.  *trailing-return-type* volitelné.  
  
6.  *hlavní část výrazu lambda*)  
