---
title: Konvence volání | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
Informace o konvencích volání pro x64 procesory, naleznete v tématu [konvence volání](../build/calling-convention.md).
