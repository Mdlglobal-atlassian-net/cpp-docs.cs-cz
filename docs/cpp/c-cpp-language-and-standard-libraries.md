---
title: Jazyk C/C++ a standardní knihovny | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
|[Co je nového pro Visual C++](../what-s-new-for-visual-cpp-in-visual-studio.md)|Popisuje nové funkce a vylepšení v této verzi.|