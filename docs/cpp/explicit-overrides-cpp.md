...
ms.locfileid: "80189023"
---
# <a name="explicit-overrides-c"></a>Explicitní přepsání (C++)

**Specifické pro společnost Microsoft**

Pokud je stejná virtuální funkce deklarována ve dvou nebo více [rozhraních](../cpp/interface.md) a pokud je třída odvozena z těchto rozhraní, můžete explicitně přepsat každou virtuální funkci.

Informace o explicitních přepsáních ve spravovaném C++kódu pomocí/CLI naleznete v tématu [Explicit Overrides](../extensions/explicit-overrides-cpp-component-extensions.md).
