...
Informace o zpracování výjimek v aplikacích CLR naleznete v tématu [zpracování výjimek (C + +/ CLI a C + +/ CX)](../windows/exception-handling-cpp-component-extensions.md).
