...
Tento příklad kódu ukazuje rozdíl mezi použitím ukazatele na ukazatel a odkazu na ukazatel.

Funkce `Add1` a `Add2` jsou funkčně ekvivalentní, i když nejsou volány stejně. Rozdíl je, že `Add1` používá dvojitou dereferenci, ale `Add2` používá pohodlný odkaz na ukazatel.
