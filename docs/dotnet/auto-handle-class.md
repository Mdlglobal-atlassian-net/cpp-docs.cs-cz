...
ms.locfileid: "80078977"
---
# <a name="auto_handle-class"></a>auto_handle – třída

Automatická správa prostředků, která se dá použít k vložení virtuálního popisovače do spravovaného typu.
...
## <a name="members"></a><a name="members"></a>Pedagog
...
|[auto_handle::release](#release)|Uvolní objekt ze správy `auto_handle`.|
|[auto_handle::reset](#reset)|Zničit aktuální objekt vlastnictví a volitelně pořídit nový objekt.|
|[auto_handle::swap](#swap)|Prohodí objekty s jiným `auto_handle`.|  
...
|[auto_handle::operator auto_handle](#operator-auto-handle)|Operátor přetypování mezi `auto_handle` a kompatibilní typy.|  
|[auto_handle::operator bool](#operator-bool)|Operátor pro použití `auto_handle` v podmíněném výrazu.|
|[auto_handle::operator!](#operator-logical-not)|Operátor pro použití `auto_handle` v podmíněném výrazu.|  
...
Uvolní objekt ze správy `auto_handle`.
...
Prohodí objekty s jiným `auto_handle`.
...
*_right*<br/>
`auto_handle`, ve kterém se mají přeměnit objekty
...
*_right*<br/>
`auto_handle`, která má být přiřazena k aktuálnímu `auto_handle`.

### <a name="return-value"></a>Návratová hodnota

Aktuální `auto_handle`, který je teď vlastníkem `_right`.
...
Operátor pro použití `auto_handle` v podmíněném výrazu.
