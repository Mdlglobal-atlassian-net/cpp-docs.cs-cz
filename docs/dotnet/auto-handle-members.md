---
title: "auto_handle – členové | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="autohandle-members"></a>auto_handle – členové
Členové `auto_handle`.  
...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 [auto_handle – auto_handle::Operator](../dotnet/auto-handle-operator-auto-handle.md)  
