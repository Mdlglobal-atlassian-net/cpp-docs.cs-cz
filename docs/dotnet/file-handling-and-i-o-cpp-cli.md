---
title: Práce se soubory a I-O (C + +/ CLI) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
Ukazuje různé operace se soubory pomocí rozhraní .NET Framework.  
 ...
 Následující témata ukazují použití třídy definované v <xref:System.IO> oboru názvů k provádění různých operací se soubory.  
