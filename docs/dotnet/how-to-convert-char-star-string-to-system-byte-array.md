...
ms.locfileid: "74988522"
---
# <a name="how-to-convert-char--string-to-systembyte-array"></a>Postupy: převod řetězce char \* na pole System:: Byte

Nejúčinnější způsob, jak převést `char *` řetězec na <xref:System.Byte> pole, je použití třídy <xref:System.Runtime.InteropServices.Marshal>.
