...
2.  Přidejte odkaz na mfcmifc80.dll, což lze provést kliknutím pravým tlačítkem myši na uzel projektu v **Průzkumníka řešení**, kde vyberou **přidat**, **odkaz**a poté přejděte na Microsoft Visual Studio 10.0\VC\atlmfc\lib.  
...
6.  Přidejte následující definice metod do `UserControl1` (budeme vytvářet ID ovládacího prvku knihovny MFC v dalším kroku):  
...
7.  Otevřete aplikaci knihovny MFC, kterou jste vytvořili v [postupy: vytvoření uživatelského ovládacího prvku a poskytování zobrazení MDI hostitele](../dotnet/how-to-create-the-user-control-and-host-mdi-view.md).  
  
8.  Přidat položku nabídky, která se vyvolá `singleMenuHandler`.  
