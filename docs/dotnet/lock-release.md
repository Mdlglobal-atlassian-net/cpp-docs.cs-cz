...
## <a name="remarks"></a>Poznámky  
 Pokud žádné uzamčení čeká, `release` se nic nestane.  
  
 Není nutné explicitně; volání této funkce Když `lock` opuštění rozsahu, jeho volání destruktoru `release`.  
