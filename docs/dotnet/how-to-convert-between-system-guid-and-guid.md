---
title: 'Postupy: převody mezi hodnotami System::Guid a _GUID | Dokumentace Microsoftu'
...
ms.locfileid: "46418408"
---
# <a name="how-to-convert-between-systemguid-and-guid"></a>Postupy: Převody mezi hodnotami System::Guid a _GUID

Následující příklad kódu ukazuje, jak převést mezi <xref:System.Guid> a `_GUID`.
