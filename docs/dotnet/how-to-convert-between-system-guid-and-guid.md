---
title: 'Postupy: Převody mezi hodnotami System::Guid a _GUID'
...
ms.locfileid: "74988263"
---
# <a name="how-to-convert-between-systemguid-and-_guid"></a>Postupy: Převody mezi hodnotami System::Guid a _GUID

Následující ukázka kódu ukazuje, jak převést mezi <xref:System.Guid> a `_GUID`.
