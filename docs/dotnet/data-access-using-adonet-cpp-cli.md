---
title: Přístup k datům s použitím technologie ADO.NET (C + +/ CLI) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
|Část|Popis|  
|-------------|-----------------|  
|[ADO.NET](/dotnet/framework/data/adonet/index)|Poskytuje přehled technologie ADO.NET, sadu tříd, které zveřejňují služby data access services pro programátory rozhraní .NET.|  
