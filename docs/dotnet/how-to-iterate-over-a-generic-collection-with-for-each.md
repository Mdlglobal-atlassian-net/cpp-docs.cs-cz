---
title: 'Postupy: iterace v obecné kolekci s výrazem for each | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
## <a name="example"></a>Příklad  
 Tento příklad ukazuje způsob použití `for each` s kolekci jednoduché hodnota obecného typu.  
