...
## <a name="setiterator-stlclr"></a><a name="iterator"></a>Set:: iterátor (STL/CLR)
...
## <a name="setoperator-stlclr"></a><a name="op_as"></a>Set:: operator = – operátor (STL/CLR)
...
## <a name="operator-set-stlclr"></a><a name="op_neq"></a>operator! = (set) – operátor (STL/CLR)
...
## <a name="operatorlt-set-stlclr"></a><a name="op_lt"></a>operator&lt; (set) – operátor (STL/CLR)
...
## <a name="operatorlt-set-stlclr"></a><a name="op_lteq"></a>operator&lt;= (set) – operátor (STL/CLR)
...
## <a name="operator-set-stlclr"></a><a name="op_eq"></a>operator = = (set) – operátor (STL/CLR)
...
## <a name="operatorgt-set-stlclr"></a><a name="op_gt"></a>operator&gt; (set) – operátor (STL/CLR)
...
## <a name="operatorgt-set-stlclr"></a><a name="op_gteq"></a>operator&gt;= (set) – operátor (STL/CLR)
