---
title: 'Postupy: určení, pokud bitová kopie je nativní nebo CLR | Microsoft Docs'
...
ms.locfileid: "33128222"
---
# <a name="how-to-determine-if-an-image-is-native-or-clr"></a>Postupy: Určení, zda je bitová kopie nativní nebo CLR
Jeden ze způsobů, jak určit, zda obrázek byla sestavena pro modul common language runtime je použití **dumpbin**[/CLRHEADER](../build/reference/clrheader.md).  
  
 Můžete také prostřednictvím kódu programu zkontrolovat, zda byla sestavena bitovou kopii pro modul common language runtime. Další informace najdete v tématu [postupy: zjištění kompilaci/CLR](../dotnet/how-to-detect-clr-compilation.md).  
  
## <a name="example"></a>Příklad  
 Následující příklad určuje, zda obrázek byla sestavena pro spouštění v modulu common language runtime.  
