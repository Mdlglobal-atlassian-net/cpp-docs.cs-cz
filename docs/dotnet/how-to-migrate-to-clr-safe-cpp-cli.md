...
ms.locfileid: "34704511"
---
# <a name="how-to-migrate-to-clrsafe-ccli"></a>Postupy: Přechod na /clr:safe (C++/CLI)

> [!IMPORTANT]
> **/CLR: pure** a **/CLR: safe** – možnosti kompilátoru jsou zastaralé v sadě Visual Studio 2015 a nepodporované v Visual Studio 2017. Pokud potřebujete bezpečná sestavení CLR, doporučujeme, abyste že portu kódu jazyka C#.

Pokud používáte starší verzi sady nástrojů kompilátoru Visual C++ z před Visual Studio 2017, může generovat ověřitelné komponenty pomocí **/CLR: safe**, což způsobí, že kompilátor generuje chyby pro každou nejsou ověřitelné konstrukce kódu.
