...
|[copy (STL/CLR)](../dotnet/copy-stl-clr.md)|Kopie hodnoty z rozsahu zdrojového na cílový rozsah, iterace směrem vpřed.|  
...
|[find (STL/CLR)](../dotnet/find-stl-clr.md)|Vrátí pozici prvního výskytu zadané hodnoty.|  
...
|[generate (STL/CLR)](../dotnet/generate-stl-clr.md)|Přiřadí hodnoty generované objekt funkce pro každý prvek v pořadí hodnot.|  
|[generate_n (STL/CLR)](../dotnet/generate-n-stl-clr.md)|Přiřadí hodnoty generované funkce objektu na zadaný počet elementů.|  
|[includes (STL/CLR)](../dotnet/includes-stl-clr.md)|Ověřuje, zda jeden seřazené rozsah obsahuje všechny elementy v druhé seřazená.|  
...
|[max (STL/CLR)](../dotnet/max-stl-clr.md)|Porovná dva objekty a vrátí delší než dva.|  
...
|[mismatch (STL/CLR)](../dotnet/mismatch-stl-clr.md)|Porovná dva rozsahy elementu pomocí elementu a vrátí první pozici, kde dochází k rozdíl.|  
...
|[partition (STL/CLR)](../dotnet/partition-stl-clr.md)|Elementy v rozsahu uspořádá tak, aby tyto prvky, které splňují unárního predikátu předcházet ty, které nesplňují ho.|  
...
|[remove (STL/CLR)](../dotnet/remove-stl-clr.md)|Odstraní zadanou hodnotu z daného rozsahu bez narušení pořadí zbývající elementy a vrátí konec bezplatné zadaná hodnota nový rozsah.|  
...
|[replace (STL/CLR)](../dotnet/replace-stl-clr.md)|Nahradí elementy v rozsahu, které odpovídají zadané hodnotě s novou hodnotou.|  
...
|[rotate (STL/CLR)](../dotnet/rotate-stl-clr.md)|Vymění prvky ve dvou sousedních rozsazích.|  
...
|[search (STL/CLR)](../dotnet/search-stl-clr.md)|Vyhledá první výskyt sekvence v cílovém rozsahu, jejíž prvky jsou rovné prvkům v dané sekvenci prvků nebo jejíž prvky jsou ekvivalentní ve smyslu určeném binárním predikátem prvkům v dané sekvenci.|  
...
|[sort (STL/CLR)](../dotnet/sort-stl-clr.md)|Uspořádá prvky v zadaném rozsahu do nesestupného pořadí nebo podle setřiďovacího kritéria určeného binárním predikátem.|  
...
|[transform (STL/CLR)](../dotnet/transform-stl-clr.md)|Aplikuje zadaný objekt funkce na každý prvek ve zdrojovém rozsahu nebo na dvojici prvků ze dvou zdrojových rozsahů a zkopíruje vrácené hodnoty objektu funkce do cílového rozsahu.|  
|[unique (STL/CLR)](../dotnet/unique-stl-clr.md)|Odstraní duplicitní prvky, které v zadaném rozsahu sousedí.|  
