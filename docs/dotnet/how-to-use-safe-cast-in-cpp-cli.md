...
Tento článek popisuje, jak pomocí operátoru safe_cast v jazyce C + +/ CLI aplikací. Informace o operátoru safe_cast v jazyce C + +/ CX, viz [safe_cast](../extensions/safe-cast-cpp-component-extensions.md).
