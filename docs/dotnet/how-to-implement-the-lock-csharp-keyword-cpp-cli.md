---
title: "Postupy: implementace lock – klíčové slovo C# (C + +/ CLI) | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Toto téma ukazuje, jak implementovat jazyka C# `lock` – klíčové slovo v jazyce Visual C++. 
 ...
 Můžete také `lock` třídy v knihovna podpory C++. V tématu [synchronizace (třída lock)](../dotnet/synchronization-lock-class.md) Další informace.  
