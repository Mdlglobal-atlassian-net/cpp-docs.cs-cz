---
title: Použití jazyka sestavení v blocích __asm | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
ms.locfileid: "32050432"
---
# <a name="using-assembly-language-in-asm-blocks"></a>Použití jazyka sestavení v blocích __asm
## <a name="microsoft-specific"></a>Specifické pro Microsoft  
 Vložený assembler má mnohem společné s další kompletující. Lze například libovolný výraz, který je právní v MASM. Tato část popisuje použití funkce jazyka sestavení v `__asm` bloky.  
