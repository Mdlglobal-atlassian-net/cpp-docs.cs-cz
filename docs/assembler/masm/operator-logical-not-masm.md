---
title: "Operator – operátor! (MASM) | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="operator--masm"></a>Operator – operátor! (MASM)
Zpracovává `character` jako literál znak a nikoli jako operátor nebo symbol.  
