...
ms.locfileid: "32052909"
---
# <a name="qword"></a>QWORD
Přiděluje a volitelně inicializuje 8 bajtů úložiště pro každou `initializer`. Můžete také použít jako specifikátor typu kdekoli je právní typu.  
