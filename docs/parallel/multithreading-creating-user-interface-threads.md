---
title: 'Multithreading: Vytváření vláken uživatelského rozhraní | Dokumentace Microsoftu'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-parallel
...
|[Spustit](../mfc/reference/cwinthread-class.md#run)| Řídící funkce pro vlákno. Obsahuje pumpu zpráv. Přepsat jen zřídka. |  
