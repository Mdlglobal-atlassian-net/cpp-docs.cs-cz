---
title: 'Návod: Připojení pomocí úloh a žádostí XML HTTP | Dokumentace Microsoftu'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-concrt
...
>  C++ REST SDK můžete použít také k provádění požadavků protokolu HTTP z aplikace pro UPW pomocí aplikace jazyka C++ nebo z desktopové aplikace jazyka C++. Další informace najdete v tématu [C++ REST SDK (kódový název "Casablanca")](https://github.com/Microsoft/cpprestsdk).  
 ...
 Úplný příklad používající `HttpReader` třídy popsané v tomto dokumentu najdete v článku [vývoj optimalizace cesty mapy Bing, aplikace Windows Store v jazyce JavaScript a C++](http://msdn.microsoft.com/library/974cf025-de1a-4299-b7dd-c6c7bf0e5d30). Další příklad, který používá `IXMLHTTPRequest2` ale úkoly, naleznete v tématu [rychlý start: připojení pomocí XML požadavku protokolu HTTP (IXMLHTTPRequest2)](http://msdn.microsoft.com/en-us/cc7aed53-b2c5-4d83-b85d-cff2f5ba7b35).  
...
2.  Přidejte do projektu soubor hlaviček, který je pojmenován HttpRequest.h a zdrojový soubor, který je pojmenován HttpRequest.cpp.  
  
3.  V soubor pch.h přidejte tento kód:  
...
1.  V souboru MainPage.xaml definujte [StackPanel](http://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.controls.stackpanel.aspx) element následujícím způsobem.  
...
7.  Ve MainPage.xaml.cpp implementujte `MainPage::ProcessHttpRequest` metody.  
...
8.  Ve vlastnostech projektu v rámci **Linkeru**, **vstup**, zadejte `shcore.lib` a `msxml6.lib`.  
 ...
 ![Spuštěné aplikaci Windows Runtime](../../parallel/concrt/media/concrt_usingixhr2.png "concrt_usingixhr2")  
...
## <a name="see-also"></a>Viz také  
 ...
 [Rychlý start: Připojení pomocí XML požadavku protokolu HTTP (IXMLHTTPRequest2)](http://msdn.microsoft.com/en-us/cc7aed53-b2c5-4d83-b85d-cff2f5ba7b35)   
