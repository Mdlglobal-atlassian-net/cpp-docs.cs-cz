...
# [Vytváření asynchronních operací v jazyce C++ pro aplikace pro web Windows Store](creating-asynchronous-operations-in-cpp-for-windows-store-apps.md)
...
## [Postupy: Vytvoření agenta toku dat](walkthrough-creating-a-dataflow-agent.md)
