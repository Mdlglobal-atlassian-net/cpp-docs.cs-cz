...
|[zadat](#insert)|Přetíženo. Přidá prvky do objektu `concurrent_unordered_set`.|
|[key_eq](#key_eq)|Vrátí uložený objekt funkce porovnání rovnosti.|
|[adresu](#swap)|Zamění obsah dvou objektů `concurrent_unordered_set`. Tato metoda není bezpečná pro souběžnost.|
|[unsafe_erase](#unsafe_erase)|Přetíženo. Odebere prvky z `concurrent_unordered_set` na zadané pozici. Tato metoda není bezpečná pro souběžnost.|

### <a name="public-operators"></a>Veřejné operátory

|Název|Popis|
|----------|-----------------|
|[operátor =](#operator_eq)|Přetíženo. Přiřadí obsah jiného objektu `concurrent_unordered_set` k tomuto. Tato metoda není bezpečná pro souběžnost.|
