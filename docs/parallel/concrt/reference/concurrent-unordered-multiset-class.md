...
#### <a name="parameters"></a>Parametry  
 ...
 `_Allocator_type`  
 Typ, který představuje uložené allocator objekt, který zapouzdřuje informace o přidělení a zrušení přidělení paměti pro souběžné vektoru. Tento argument je volitelný a výchozí hodnota je `std::allocator<K>`.  
...
|Název|Popis|  
|----------|-----------------|  
|[concurrent_unordered_multiset](#ctor)|Přetíženo. Vytvoří souběžných neuspořádaný multimnožina.|  
...
##  <a name="ctor"></a> concurrent_unordered_multiset 
 ...
 Vytvoří souběžných neuspořádaný multimnožina.  
...
### <a name="parameters"></a>Parametry  
 ...
 `_Number_of_buckets`  
 Počáteční počet intervalů pro tento neuspořádaný multimnožina.  
  
 `_Hasher`  
 Funkce hash pro tuto neuspořádaný multimnožina.  
  
 `key_equality`  
 Funkce porovnání rovnosti pro tento neuspořádaný multimnožina.  
  
 `_Allocator`  
 Přidělení pro tento neuspořádaný multimnožina.  
  
 `first`  
 `last`  
 `_Uset`  
 Zdroj `concurrent_unordered_multiset` objekt, který chcete přesunout elementy z.  
  
### <a name="remarks"></a>Poznámky  
 Všechny konstruktory uložit objekt allocator `_Allocator` a inicializace neuspořádaný multimnožina.  
  
 První konstruktor určuje prázdná multimnožina počáteční a explicitně určuje počet intervalů, funkce hash, funkce rovnosti a allocator typ má být použit.  
  
 Druhý konstruktor určuje přidělení pro neuspořádaný multimnožina.  
  
 Třetí konstruktor určuje poskytl iterator rozsah hodnot [ `_Begin`, `_End`).  
  
 Konstruktory čtvrté a páté zadejte kopii souběžných neuspořádaný multiset `_Uset`.  
  
 Poslední konstruktor určuje přesunu souběžných neuspořádaný multimnožina `_Uset`.  
...
##  <a name="insert"></a> Vložení 
 ...
 Přidá elementy na `concurrent_unordered_multiset` objektu.  
...
##  <a name="operator_eq"></a> operátor = 
 ...
 Přiřadí obsah jiného `concurrent_unordered_multiset` k tomuto objektu. Tato metoda není bezpečná souběžnosti.  
...
### <a name="return-value"></a>Návratová hodnota  
 Odkaz na toto `concurrent_unordered_multiset` objektu.  
  
### <a name="remarks"></a>Poznámky  
 Po vymazání existující prvky v souběžných neuspořádaný multimnožina, `operator=` buď kopíruje nebo přesouvá obsah `_Uset` do souběžných neuspořádané multimnožina.  
...
##  <a name="swap"></a> Swap 
 ...
 Prohození obsahu dvou `concurrent_unordered_multiset` objekty. Tato metoda není bezpečná souběžnosti.  
...
### <a name="parameters"></a>Parametry  
 `_Uset`  
 `concurrent_unordered_multiset` Objekt, který chcete Prohodit s.  
...
##  <a name="unsafe_erase"></a> unsafe_erase – 
 ...
 Odebere elementy z `concurrent_unordered_multiset` v zadaných pozic. Tato metoda není bezpečná souběžnosti.  
