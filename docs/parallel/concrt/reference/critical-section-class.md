...
|[~critical_section Destructor](#dtor)|Zničí kritická sekce.|  
...
|[unlock](#unlock)|Odemkne kritická sekce.|  
...
##  <a name="critical_section__scoped_lock_class">critical_section::scoped_lock – třída</a>  
