---
title: concurrent_unordered_map – třída | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-concrt
...
|[Prohození](#swap)|Zamění obsah dvou `concurrent_unordered_map` objekty. Tato metoda není bezpečná pro souběžnost.|  
...
### <a name="return-value"></a>Návratová hodnota  
 A [pár](http://msdn.microsoft.com/en-us/c5a37023-d939-4eb2-ae24-ce8e0cd4505d) kde první prvek je iterace na začátek a druhý prvek je iterátor na konec rozsahu.  
