...
|[~single_link_registry Destructor](#dtor)|Zničí `single_link_registry` objektu.|  
  
### <a name="public-methods"></a>Veřejné metody  
  
|Název|Popis|  
|----------|-----------------|  
|[add](#add)|Přidá odkaz `single_link_registry` objektu. (Overrides [network_link_registry::add](network-link-registry-class.md#add).)|  
