---
title: 'Postupy: použití algoritmu parallel_invoke k provádění paralelních operací | Dokumentace Microsoftu'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-concrt
...
Můžete použít `parallel_invoke` algoritmus místo [concurrency::task_group](reference/task-group-class.md) a [concurrency::structured_task_group](../../parallel/concrt/reference/structured-task-group-class.md) třídy Pokud nepožadujete podporu pro zrušení. Příklad, který porovnává využití `parallel_invoke` algoritmus a skupiny úloh, naleznete v tématu [postupy: použití algoritmu parallel_invoke k zápisu rutiny paralelního třídění](../../parallel/concrt/how-to-use-parallel-invoke-to-write-a-parallel-sort-routine.md).
...
**cl.exe/EHsc/MD/DUNICODE /D_AFXDLL paralelní slovo mining.cpp**
