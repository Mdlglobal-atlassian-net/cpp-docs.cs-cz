---
title: Obsah | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-parallel
...
[2.4.2 sections – konstrukce](../../parallel/openmp/2-4-2-sections-construct.md)
...
[2.6.2 critical – konstrukce](../../parallel/openmp/2-6-2-critical-construct.md)

[2.6.3 barrier – direktiva](../../parallel/openmp/2-6-3-barrier-directive.md)

[2.6.4 atomic – konstrukce](../../parallel/openmp/2-6-4-atomic-construct.md)

[2.6.5 flush – direktiva](../../parallel/openmp/2-6-5-flush-directive.md)
...
[3.1.2 omp_get_num_threads – funkce](../../parallel/openmp/3-1-2-omp-get-num-threads-function.md)

[3.1.3 omp_get_max_threads – funkce](../../parallel/openmp/3-1-3-omp-get-max-threads-function.md)

[3.1.4 omp_get_thread_num – funkce](../../parallel/openmp/3-1-4-omp-get-thread-num-function.md)

[3.1.5 omp_get_num_procs – funkce](../../parallel/openmp/3-1-5-omp-get-num-procs-function.md)

[3.1.6 omp_in_parallel – funkce](../../parallel/openmp/3-1-6-omp-in-parallel-function.md)

[3.1.7 omp_set_dynamic – funkce](../../parallel/openmp/3-1-7-omp-set-dynamic-function.md)

[3.1.8 omp_get_dynamic – funkce](../../parallel/openmp/3-1-8-omp-get-dynamic-function.md)

[3.1.9 omp_set_nested – funkce](../../parallel/openmp/3-1-9-omp-set-nested-function.md)
...
[3.3.2 omp_get_wtick – funkce](../../parallel/openmp/3-3-2-omp-get-wtick-function.md)
...
[A.2 Nastavení podmíněné kompilace](../../parallel/openmp/a-2-specifying-conditional-compilation.md)

[A.3 použití paralelních oblastí](../../parallel/openmp/a-3-using-parallel-regions.md)

[A.4 použití klauzule nowait](../../parallel/openmp/a-4-using-the-nowait-clause.md)

[A.5 použití direktivy critical](../../parallel/openmp/a-5-using-the-critical-directive.md)

[A.6 použití klauzule lastprivate](../../parallel/openmp/a-6-using-the-lastprivate-clause.md)

[A.7 použití klauzule reduction](../../parallel/openmp/a-7-using-the-reduction-clause.md)

[A.8 určení paralelních oddílů](../../parallel/openmp/a-8-specifying-parallel-sections.md)

[A.9 Použití direktiv single](../../parallel/openmp/a-9-using-single-directives.md)

[A.10 nastavení sekvenčního řazení](../../parallel/openmp/a-10-specifying-sequential-ordering.md)

[A.11 určení pevného počtu vláken](../../parallel/openmp/a-11-specifying-a-fixed-number-of-threads.md)

[A.12 použití direktivy atomic](../../parallel/openmp/a-12-using-the-atomic-directive.md)

[A.13 použití direktivy flush se seznamem](../../parallel/openmp/a-13-using-the-flush-directive-with-a-list.md)

[A.14 použití direktivy flush bez seznamu](../../parallel/openmp/a-14-using-the-flush-directive-without-a-list.md)

[A.15 určení počtu použitých vláken](../../parallel/openmp/a-15-determining-the-number-of-threads-used.md)

[A.16 použití zámků](../../parallel/openmp/a-16-using-locks.md)

[A.17 použití Vnořitelných zámků](../../parallel/openmp/a-17-using-nestable-locks.md)

[A.18 vnořené direktivy for](../../parallel/openmp/a-18-nested-for-directives.md)

[A.19 příklady nesprávného vnoření direktiv pro sdílení práce](../../parallel/openmp/a-19-examples-showing-incorrect-nesting-of-work-sharing-directives.md)

[A.20 vazby direktiv barrier](../../parallel/openmp/a-20-binding-of-barrier-directives.md)

[A.21 rozsah platnosti proměnných s klauzulí private](../../parallel/openmp/a-21-scoping-variables-with-the-private-clause.md)

[A.22 použití klauzule default(none)](../../parallel/openmp/a-22-using-the-default-none-clause.md)

[A.23 příklady seřazený – direktiva](../../parallel/openmp/a-23-examples-of-the-ordered-directive.md)

[A.24 příklady použití klauzule private](../../parallel/openmp/a-24-example-of-the-private-clause.md)

[A.25 příklady klauzule datového atributu copyprivate](../../parallel/openmp/a-25-examples-of-the-copyprivate-data-attribute-clause.md)

[A.26 použití direktivy threadprivate](../../parallel/openmp/a-26-using-the-threadprivate-directive.md)

[A.27 použití polí proměnné délky C99](../../parallel/openmp/a-27-use-of-c99-variable-length-arrays.md)

[A.28 použití klauzule num_threads](../../parallel/openmp/a-28-use-of-num-threads-clause.md)

[A.29 použití Work-Sharing vytvoří uvnitř konstrukce critical](../../parallel/openmp/a-29-use-of-work-sharing-constructs-inside-a-critical-construct.md)

[A.30 použití reprivatizace](../../parallel/openmp/a-30-use-of-reprivatization.md)

[A.31 funkce zamykání bezpečné pro vlákna](../../parallel/openmp/a-31-thread-safe-lock-functions.md)
