...
[1. Úvod](../../parallel/openmp/1-introduction.md)  
 ...
 [A.1 paralelní provádění jednoduché smyčky](../../parallel/openmp/a-1-executing-a-simple-loop-in-parallel.md)  
  
 [A.2 zadání Podmíněná kompilace](../../parallel/openmp/a-2-specifying-conditional-compilation.md)  
  
 [A.3 použití paralelní oblastí](../../parallel/openmp/a-3-using-parallel-regions.md)  
  
 [A.4 pomocí nowait – klauzule](../../parallel/openmp/a-4-using-the-nowait-clause.md)  
  
 [A.5 pomocí kritické – direktiva](../../parallel/openmp/a-5-using-the-critical-directive.md)  
  
 [A.6 pomocí lastprivate – klauzule](../../parallel/openmp/a-6-using-the-lastprivate-clause.md)  
  
 [A.7 pomocí snížení – klauzule](../../parallel/openmp/a-7-using-the-reduction-clause.md)  
  
 [A.8 zadání paralelní části](../../parallel/openmp/a-8-specifying-parallel-sections.md)  
  
 [Jeden direktivy Using A.9](../../parallel/openmp/a-9-using-single-directives.md)  
  
 [A.10 zadání sekvenční řazení](../../parallel/openmp/a-10-specifying-sequential-ordering.md)  
  
 [A.11 zadání pevný počet vláken](../../parallel/openmp/a-11-specifying-a-fixed-number-of-threads.md)  
  
 [A.12 pomocí atomic – direktiva](../../parallel/openmp/a-12-using-the-atomic-directive.md)  
  
 [A13 pomocí seznamu vyprázdnění – direktiva](../../parallel/openmp/a-13-using-the-flush-directive-with-a-list.md)  
  
 [A.14 pomocí vyprázdnění – direktiva bez seznamu](../../parallel/openmp/a-14-using-the-flush-directive-without-a-list.md)  
  
 [Určení počet vláken používaných A.15](../../parallel/openmp/a-15-determining-the-number-of-threads-used.md)  
  
 [A.16 pomocí zámky.](../../parallel/openmp/a-16-using-locks.md)  
  
 [Zamkne A.17 pomocí Nestable](../../parallel/openmp/a-17-using-nestable-locks.md)  
  
 [A.18 vnořené pro direktivy](../../parallel/openmp/a-18-nested-for-directives.md)  
  
 [Příklady A.19 zobrazuje nesprávné vnořování direktiv sdílení práce](../../parallel/openmp/a-19-examples-showing-incorrect-nesting-of-work-sharing-directives.md)  
  
 [A.20 vazby direktiv bariéry](../../parallel/openmp/a-20-binding-of-barrier-directives.md)  
  
 [Proměnné rozsahu A.21 s privátní klauzule](../../parallel/openmp/a-21-scoping-variables-with-the-private-clause.md)  
  
 [A.22 pomocí default(none) – klauzule](../../parallel/openmp/a-22-using-the-default-none-clause.md)  
  
 [Příklady A.23 seřazené – direktiva](../../parallel/openmp/a-23-examples-of-the-ordered-directive.md)  
  
 [Příklad A.24 privátní klauzule](../../parallel/openmp/a-24-example-of-the-private-clause.md)  
  
 [Příklady A.25 copyprivate klauzule atribut dat](../../parallel/openmp/a-25-examples-of-the-copyprivate-data-attribute-clause.md)  
  
 [A.26 pomocí threadprivate – direktiva](../../parallel/openmp/a-26-using-the-threadprivate-directive.md)  
  
 [Použití A.27 C99 proměnlivou délkou pole](../../parallel/openmp/a-27-use-of-c99-variable-length-arrays.md)  
  
 [Použití A.28 num_threads – klauzule](../../parallel/openmp/a-28-use-of-num-threads-clause.md)  
  
 [A.29 sdílení použití práce vytvoří uvnitř critical – konstrukce](../../parallel/openmp/a-29-use-of-work-sharing-constructs-inside-a-critical-construct.md)  
  
 [Použití A.30 Reprivatization](../../parallel/openmp/a-30-use-of-reprivatization.md)  
