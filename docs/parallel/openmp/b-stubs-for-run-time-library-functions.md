---
title: B. Zástupných procedur pro funkce běhové knihovny | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-parallel
...
> [!NOTE]
>  Zámek proměnné, která se zobrazí v funkce Zámek je nutno přistupovat výhradně prostřednictvím těchto funkcí. By neměly být inicializován nebo jinak upraven v aplikaci uživatele. Uživatelé by neměl Zkontrolujte předpoklady o mechanismy použít k implementaci zámky založené na schéma používané funkce se zakázaným inzerováním OpenMP C a C++ implementace.  
