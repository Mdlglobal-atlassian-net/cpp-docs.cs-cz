...
1. [Direktivy](2-directives.md)

1. [Funkce knihovny run-time](3-run-time-library-functions.md)

1. [Proměnné prostředí](4-environment-variables.md)
...
C. [Gramatika OpenMP – C a C++](c-openmp-c-and-cpp-grammar.md)

D. [Klauzule schedule](d-using-the-schedule-clause.md)

E. [Chování definované implementací v OpenMP – C/C++](e-implementation-defined-behaviors-in-openmp-c-cpp.md)
