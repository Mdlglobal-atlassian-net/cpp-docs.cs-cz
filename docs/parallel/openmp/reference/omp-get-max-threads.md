---
title: omp_get_max_threads – | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-parallel
...
ms.locfileid: "46446683"
---
# <a name="ompgetmaxthreads"></a>omp_get_max_threads

Vrátí celé číslo, které je roven nebo větší než počet vláken, která bude k dispozici, pokud paralelní oblasti bez [num_threads](../../../parallel/openmp/reference/num-threads.md) nebyly definované v tomto bodě v kódu.
