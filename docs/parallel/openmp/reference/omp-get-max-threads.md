...
ms.locfileid: "33695834"
---
# <a name="ompgetmaxthreads"></a>omp_get_max_threads
Vrátí celé číslo, které je rovna nebo větší než počet vláken, které by byly k dispozici, pokud paralelní oblast bez [num_threads](../../../parallel/openmp/reference/num-threads.md) nebyly definované v tomto bodě v kódu.  
