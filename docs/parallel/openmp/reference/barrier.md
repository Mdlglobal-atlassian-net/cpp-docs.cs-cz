---
title: bariéra | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-parallel
...
Pro ukázku toho, jak používat `barrier`, naleznete v tématu [hlavní](../../../parallel/openmp/reference/master.md).
