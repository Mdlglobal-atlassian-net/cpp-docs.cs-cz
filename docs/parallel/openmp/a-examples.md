...
V následujícím příkladu C++ ukazuje, jak inicializovat pole zámky v paralelní oblasti s použitím [omp_init_lock](3-run-time-library-functions.md#321-omp_init_lock-and-omp_init_nest_lock-functions).
