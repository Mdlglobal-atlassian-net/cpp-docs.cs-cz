...
2.  `std::future_status::ready` Pokud je dokončena přidružená asynchronní operace.  
  
3.  `std::future_status::timeout` Pokud zadaný časový limit uplynul.  
