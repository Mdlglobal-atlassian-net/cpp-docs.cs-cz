---
title: "Používání modelu C++ AMP v aplikacích pro Windows Store | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="performance-considerations"></a>Důležité informace o výkonu  
 Pokud používáte [!INCLUDE[cppwrt](../../build/reference/includes/cppwrt_md.md)] ([!INCLUDE[cppwrt_short](../../build/reference/includes/cppwrt_short_md.md)]) k vytvoření vašeho [!INCLUDE[win8_appname_long](../../build/includes/win8_appname_long_md.md)] aplikace, doporučujeme použít typy prostý starý dat (POD) společně s souvislý úložiště – například `std::vector` nebo pole stylu jazyka C – pro data, která se použije s C++ AMP. Můžete dosáhnout vyšší výkon než pomocí jiných POD typy nebo Windows RT kontejnerů, protože žádné zařazování má proběhnout.  
