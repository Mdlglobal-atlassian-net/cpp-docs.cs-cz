...
|[pointer](#pointer)|Typ, který poskytuje ukazatel na element v seznamu předat dál.|  
|[reference](#reference)|Typ, který obsahuje odkaz na element v seznamu předat dál.|  
...
|||  
|-|-|  
|[assign](#assign)|Vymaže elementy ze seznamu dopředného a zkopíruje novou sadu elementů do cílového seznamu předat dál.|  
|[before_begin](#before_begin)|Vrátí iterator adresování pozice před prvním elementem v seznam předat dál.|  
|[Začátek](#begin)|Vrátí iterator adresování prvním elementem v seznam předat dál.|  
...
|[clear](#clear)|Vymaže všechny prvky dopředného seznamu.|  
...
|[resize](#resize)|Určuje novou velikost dopředného seznam.|  
|[Reverse](#reverse)|Obrátí pořadí, ve kterém elementy objevují v seznamu předat dál.|  
|[sort](#sort)|Uspořádá elementy ve vzestupném pořadí nebo k pořadí určeného predikátu.|  
|[splice_after](#splice_after)|Restitches propojení mezi uzly.|  
|[swap](#swap)|Výměny elementy dva seznamy předat dál.|  
|[unique](#unique)|Odebere přiléhající prvky, které předávají testu zadaný.|  
  
### <a name="operators"></a>Operátory  
  
|||  
|-|-|  
|[operator=](#op_eq)|Nahradí prvky dopředného seznamu kopii jiného seznamu předat dál.|  
