...
Popisuje objekt, který ukládá dvojici seřazené objektů typu **dvojité***,* první představující skutečné část reprezentující komplexní čísla a druhý představující pomyslná část.  
