---
title: basic_fstream – třída | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
*správné* reference na lvalue k `basic_fstream` objektu.
...
*správné* `lvalue` odkaz `basic_fstream` objektu.
