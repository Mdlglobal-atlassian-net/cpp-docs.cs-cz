...
#### <a name="parameters"></a>Parametry  
 T  
 Typ hodnoty; musí být typu integrální: bool, char, char16_t, char32_t, wchar_t, nebo podepsané nebo typy celé číslo bez znaménka.  
  
 Prů  
 Parametr není typu pack, která představuje pořadí hodnot integrální typu T.  
