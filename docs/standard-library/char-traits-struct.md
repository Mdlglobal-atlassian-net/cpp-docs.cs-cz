...
### <a name="parameters"></a>Parametry  
 **_** *CharFrom*  
 Znak, jehož hodnota má být přiřazena.  
 ...
 * strTo *  
 ...
 `_Num`  
 Počet elementů, které se chystáte přiřadit hodnoty.  
 ...
 * Str2 *  
 ...
 `_Num`  
 Počet elementů v řetězcích, který se má porovnat.  
...
### <a name="parameters"></a>Parametry  
 `_To`  
 Element na začátku řetězec nebo znak pole, které jsou cílené na přijímat zkopírovaný posloupnost znaků.  
  
 `_From`  
 Element na začátku zdrojové řetězec nebo znak pole ke kopírování.  
  
 `_Num`  
 Počet prvků který se má zkopírovat.  
...
### <a name="parameters"></a>Parametry  
 ...
 `dest_size`  
 Velikost `dest`. Pokud `char_type` je `char`, pak je tato velikost v bajtech. Pokud `char_type` je `wchar_t`, pak tato velikost je v slova.  
...
### <a name="parameters"></a>Parametry  
 `_Ch1`  
 První dva znaky má být testována rovnosti.  
  
 `_Ch2`  
 Druhý dva znaky má být testována rovnosti.  
...
### <a name="parameters"></a>Parametry  
 `_Ch1`  
 První dva znaky má být testována rovnosti jako **int_type –**s.  
  
 `_Ch2`  
 Druhý dva znaky má být testována rovnosti jako `int_type`s.  
...
### <a name="parameters"></a>Parametry  
 `str`  
 První znak v řetězci chcete prohledat.  
  
 `_Num`  
 Počet pozic, počítáno od první, v rozsahu prohledávání.  
...
### <a name="parameters"></a>Parametry  
 `str`  
 C – řetězec, jehož délka je měření.  
...
### <a name="parameters"></a>Parametry  
 ...
 `_Ch2`  
 Druhý dva znaky má být testována pro menší než.  
...
### <a name="parameters"></a>Parametry  
 ...
 `_Num`  
 Počet prvků který se má zkopírovat z zdrojový řetězec.  
...
### <a name="parameters"></a>Parametry  
 ...
 `dest_size`  
 Velikost `dest`. Pokud `char_type` je `char`, je to v bajtech. Pokud `char_type` je `wchar_t`, bude tato slova.  
...
### <a name="parameters"></a>Parametry  
 `_Ch`  
 Znak vyjádřené `int_type` má být testována pro, zda je znak EOF nebo ne.  
...
### <a name="parameters"></a>Parametry  
 `_Ch`  
 `int_type` Znak, který má být reprezentován jako `char_type`.  
...
### <a name="parameters"></a>Parametry  
 `_Ch`  
 `char_type` Znak, který má být reprezentován jako `int_type`.  
