...
### <a name="parameters"></a>Parametry  
 `Index`  
 Index elementu, který chcete získat.  
  
 `Types`  
 Pořadí typů deklarované v řazené kolekci členů, v pořadí deklarace.  
  
 `T`  
 Typ elementu, který chcete získat.  
  
 `Tuple`  
 Std::tuple, který obsahuje libovolný počet elementů.  
...
### <a name="parameters"></a>Parametry  
 `TN`  
 Základní typ elementu n-tou řazené kolekce členů.  
