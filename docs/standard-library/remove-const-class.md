---
title: remove_const – třída | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
Instance `remove_const<T>` obsahuje upravit – typ, který je `T1` při `T` je ve formátu `const T1`, jinak `T`.
