...
Člen typedef třídy Templates obsahuje základní celočíselný typ *T*, pokud *t* je typ výčtu, jinak neexistuje žádná definice `type`typu member. `type`
