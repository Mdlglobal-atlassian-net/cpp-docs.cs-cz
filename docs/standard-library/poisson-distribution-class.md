...
Podrobné informace o hodnotu Poissonovo rozdělení, najdete v článku Wolfram MathWorld [hodnotu Poissonovo rozdělení](http://go.microsoft.com/fwlink/LinkId=401112).  
