...
**Specifické pro společnost Microsoft**: **dlouhé typy Double** a **Double** mají stejnou reprezentaci, ale jsou odlišné typy. Další informace najdete v tématu [základní typy](../cpp/fundamental-types-cpp.md).
