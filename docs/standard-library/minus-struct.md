---
title: minus – struktura | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "44318600"
---
# <a name="minus-struct"></a>minus – struktura

Předdefinovaný objekt funkce, který provádí operace odčítání (binární `operator-`) na svých argumentů.
