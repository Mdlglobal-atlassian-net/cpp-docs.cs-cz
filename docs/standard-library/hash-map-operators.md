...
## <a name="operator-hash_multimap"></a><a name="op_neq_mm"></a>operator! = (hash_multimap) – operátor
...
## <a name="operator--hash_multimap"></a><a name="op_eq_eq_mm"></a>operator = = (hash_multimap) – operátor
