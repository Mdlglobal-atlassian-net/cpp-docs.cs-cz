...
*_Freezeit* A **bool** označující, zda chcete datového proudu k zmrazit.
...
*počet* velikost vyrovnávací paměti v bajtech.

*Reži_m* režimu vstupní a výstupní vyrovnávací paměti. Zobrazit [ios_base::openmode](../standard-library/ios-base-class.md#openmode) Další informace.
