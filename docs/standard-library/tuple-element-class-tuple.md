---
title: tuple_element – třída | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
**Záhlaví:** \<řazené kolekce členů > **hlavičky:** \<pole > (pro specializaci pole) **hlavičky:** \<nástroje > (pro dvojice specializace)  **Namespace:** std
