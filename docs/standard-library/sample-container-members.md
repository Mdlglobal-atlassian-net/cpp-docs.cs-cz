...
|[reference](../standard-library/container-class-reference.md)|Popisuje objekt, který může sloužit jako odkaz na element řízené sekvenci.|  
...
|[clear](../standard-library/container-class-clear.md)|Volání [vymazat](../standard-library/container-class-erase.md)( [začít](../standard-library/container-class-begin.md), [end](../standard-library/container-class-end.md)).|  
