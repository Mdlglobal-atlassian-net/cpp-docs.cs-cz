...
|[operátor &#124; &#124;](../standard-library/valarray-operators.md#op_lor)|Získá logické `OR` mezi odpovídající elementy dva stejně velké valarray – třídy nebo valarray – a zadanou hodnotu valarray – element typu.|  
