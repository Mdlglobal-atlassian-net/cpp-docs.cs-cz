...
#### <a name="parameters"></a>Parametry  
 `Type`  
 Datový typ základní element, jehož vlastnosti jsou právě testována dotaz nebo nastavit.  
...
|[maximální počet](#max)|Vrátí typ na maximální hodnotu omezené.|  
...
|[základ –](#radix)|Vrátí integrální základ, označuje jako základ –, použít pro reprezentaci typu.|  
...
### <a name="remarks"></a>Poznámky  
 Signalizační NAN je kódování pro není číslo, která signalizuje své přítomnosti ve výrazu. Vrácená hodnota je **true**[is_iec559 –](#is_iec559) hodnotu true.  
