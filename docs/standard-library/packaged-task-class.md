---
title: packaged_task – třída | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
*ALLOC* Přidělovač paměti. Další informace najdete v tématu [ \<alokátorů >](../standard-library/allocators-header.md).
