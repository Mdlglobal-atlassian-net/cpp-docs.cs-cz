---
title: weibull_distribution – třída | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
Šablony třídy popisuje distribuce, která vytváří hodnoty plovoucí desetinné čárky zadán uživatel nebo typu `double` Pokud žádný je k dispozici, distribuovat podle Weibullova rozdělení. Následující tabulka odkazy na články o jednotlivé členy.
...
Podrobné informace o distribuci Weibullova, najdete v článku Wolfram MathWorld [Weibullova rozdělení](http://go.microsoft.com/fwlink/p/?linkid=401115).
