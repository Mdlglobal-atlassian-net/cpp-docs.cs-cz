---
title: '&lt;iterátor&gt; | Dokumentace Microsoftu'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "38955449"
---
# <a name="ltiteratorgt"></a>&lt;iterátor&gt;
...
Do sady Visual Studio byla přidána rozšíření iterátorů standardní knihovny C++ za účelem podpory pro řady situací v režimu ladění pro kontrolované a nekontrolované iterátory. Další informace najdete v tématu [bezpečné knihovny: standardní knihovny C++](../standard-library/safe-libraries-cpp-standard-library.md).
...
|[iterátor](../standard-library/iterator-struct.md)|Třída šablony slouží jako základní typ pro všechny iterátory.|
