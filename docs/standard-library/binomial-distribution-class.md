...
Podrobné informace o funkci binomické rozdělení pravděpodobnosti diskrétní, najdete v článku Wolfram MathWorld [binomické rozdělení](http://go.microsoft.com/fwlink/p/?linkid=398469).
