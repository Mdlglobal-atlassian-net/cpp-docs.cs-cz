...
#### <a name="parameters"></a>Parametry  
 `_RealVal`  
 Hodnota typu **float** pro skutečné součástí komplexního čísla vytvářen.  
  
 `_ImagVal`  
 Hodnota typu **float** pro pomyslná součástí komplexního čísla vytvářen.  
  
 `complexNum`  
 Komplexní čísla typu **dvojité** nebo typu `long double` jejichž skutečné a pomyslná částí se používají k inicializaci komplexní čísla typu **float** vytvářen.  
