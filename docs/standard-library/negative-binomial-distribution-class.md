...
Podrobné informace o funkci diskrétní pravděpodobnost negativní binomické rozdělení, najdete v článku Wolfram MathWorld [negativní binomické rozdělení](https://go.microsoft.com/fwlink/p/?linkid=400516).
