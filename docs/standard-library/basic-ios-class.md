...
|||  
|-|-|  
|[bad](#bad)|Určuje, ke ztrátě integrity vyrovnávací paměti datového proudu.|  
...
|[narrow](#narrow)|Vyhledá ekvivalentní char k danou `char_type`.|  
...
### <a name="parameters"></a>Parametry  
 `state` (volitelné)  
 Příznaky, které chcete nastavit po vymazání všech příznaků. Použije se výchozí hodnota `goodbit`.  
  
 `reraise` (volitelné)  
 Určuje, zda má být výjimka znovu vyvolané. Použije se výchozí hodnota `false` (nebude znovu vyvolat výjimku).  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Datový proud, jejichž příznaky, které chcete kopírovat.  
...
### <a name="parameters"></a>Parametry  
 `Char`  
 Znak, který chcete používat jako výplňovým znakem.  
...
### <a name="parameters"></a>Parametry  
 ...
 `_Isstd`  
 Určuje, zda se jedná o standardní datového proudu.  
...
### <a name="parameters"></a>Parametry  
 `right`  
 `ios_base` Objekt, který chcete přesunout hodnot.  
...
### <a name="parameters"></a>Parametry  
 ...
 `Default`  
 `char` Zda mají být vráceny Pokud se nenajde žádný ekvivalent.  
...
### <a name="parameters"></a>Parametry  
 `strbuf`  
 Datový proud vyrovnávací paměť k vyrovnávací paměti pro čtení.  
...
### <a name="parameters"></a>Parametry  
 `right`  
 `basic_ios` Objekt, který se používá k výměně hodnoty.  
