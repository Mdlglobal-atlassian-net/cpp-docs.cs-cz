---
title: pointer_to_binary_function – třída | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
*levé* vlevo objekt, který  *\*pfunc* je volán na.

*správné* vpravo objekt, který  *\*pfunc* je volán na.
