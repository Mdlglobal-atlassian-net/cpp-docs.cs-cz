---
title: shared_future – třída | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
*Pravé* A [budoucí](../standard-library/future-class.md) nebo `shared_future` objektu.
