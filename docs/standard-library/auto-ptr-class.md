...
#### <a name="parameters"></a>Parametry  
 ...
 `ptr`  
 Ukazatel zadaný nahrazení ukazatele uložené.  
...
### <a name="parameters"></a>Parametry  
 `ptr`  
 Ukazatele na objekt, `auto_ptr` zapouzdří.  
  
 `right`  
 `auto_ptr` Objekt, který má být zkopírovaná pomocí konstruktoru.  
...
### <a name="parameters"></a>Parametry  
 `ptr`  
 Ukazatel zadaný nahrazení ukazatele uložené **myptr**.  
