---
title: error_code – třída | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
|*Val*|Hodnota kódu chyby k ukládání `error_code`.|
|*_Cat*|Kategorie chyby pro uložení v `error_code`.|
|*_Errcode*|Hodnota výčtu k ukládání `error_code`.|
...
Testuje, zda [error_code](http://msdn.microsoft.com/09c6ef90-b6f8-430a-b584-e168716c7e31) objekt je menší než `error_code` objekt předaný k porovnání.
...
|Parametr|Popis|
|---------------|-----------------|
|*doprava*|Error_code – objekt, který se má porovnat.|
...
Přiřadí novou hodnotu výčtu [error_code](http://msdn.microsoft.com/09c6ef90-b6f8-430a-b584-e168716c7e31) objektu.
