...
### <a name="parameters"></a>Parametry   
 `first`  
 Vstupní iterovat adresování prvním elementem v rozsahu sčítají nebo kombinaci podle zadaného binární operace.  
  
 `last`  
 Vstupní iterovat adresování posledním prvkem v rozsahu sčítají nebo kombinaci podle zadaný binární operace, které je nad rámec konečné element ve skutečnosti součástí iterated akumulace o jednu pozici.  
  
 `val`  
 Má počáteční hodnotu, na kterou každý prvek je pak přidat nebo v kombinaci s podle zadaného binární operace.  
  
 `binary_op`  
 Binární operace, která se má být použita pro každý element v zadaném rozsahu a výsledek jeho předchozí aplikace.  
...
### <a name="parameters"></a>Parametry  
 `first1`  
 Vstupní iterovat adresování prvním elementem v první oblasti, která jejichž vnitřní nebo produkt zobecněný vnitřní s druhého rozsahu je počítaný.  
  
 `last1`  
 Vstupní iterovat adresování posledním prvkem v první oblasti, která jejichž vnitřní nebo produkt zobecněný vnitřní s druhého rozsahu je počítaný.  
  
 `first2`  
 Vstupní iterovat adresování prvním elementem v druhého rozsahu, jejichž vnitřní nebo produkt zobecněný vnitřní s rozsahem první je počítaný.  
  
 `val`  
 Má počáteční hodnotu, do které vnitřní produktu nebo zobecněný vnitřní produktu mezi rozsahy má být přidán.  
  
 *binary_op1*  
 Binární operace, který nahrazuje operaci vnitřní produktu Sum element-wise produkty v generalizace vnitřní produktu.  
  
 *binary_op2*  
 Binární operace, který nahrazuje element-wise operaci vnitřní produktu vynásobte v generalizace vnitřní produktu.  
...
### <a name="parameters"></a>Parametry  
 `first`  
 Vstupní iterator, která řeší prvním elementem v rozsahu, aby byla vyplněna.  
  
 `last`  
 Vstupní iterator, která řeší posledním prvkem v rozsahu, aby byla vyplněna.  
  
 `value`  
 Výchozí hodnota pro uložení v první prvek a postupně přírůstek pro následné elementy.  
...
## <a name="see-also"></a>Viz také  
 [\<číselné >](../standard-library/numeric.md)
