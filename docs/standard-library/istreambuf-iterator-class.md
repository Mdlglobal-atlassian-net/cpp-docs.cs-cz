...
#### <a name="parameters"></a>Parametry  
 ...
 `Traits`  
 Typ, který představuje typ znaku pro istreambuf_iterator. Tento argument je volitelný a výchozí hodnota je `char_traits` \< *CharType >.*  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Iterator, pro které chcete zkontrolovat rovnosti.  
...
### <a name="parameters"></a>Parametry  
 `strbuf`  
 Vyrovnávací paměť vstupního datového proudu ke kterému `istreambuf_iterator` bude připojen.  
  
 `_Istr`  
 Vstupní proud, do kterého `istreambuf_iterator` bude připojen.  
