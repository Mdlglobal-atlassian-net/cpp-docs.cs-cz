...
#### <a name="parameters"></a>Parametry  
 `CharType`  
 Datový typ jednoho znaku v řetězci. Standardní knihovna C++ poskytuje specializací třídy této šablony, s definic typů [řetězec](../standard-library/string-typedefs.md#string) pro elementy typu `char`, [wstring](../standard-library/string-typedefs.md#wstring), pro `wchar_t`, [u16string](../standard-library/string-typedefs.md#u16string) pro `char16_t`, a [u32string –](../standard-library/string-typedefs.md#u32string) pro `char32_t`.  
  
 `Traits`  
 Různé důležité vlastnosti **CharType** elementů v basic_string specializace jsou popsány v třídě **vlastnosti**. Výchozí hodnota je `char_traits` <  `CharType`>.  
  
 `Allocator`  
 Typ, který představuje uložené allocator objekt, který zapouzdřuje informace o přidělení a zrušení přidělení paměti řetězec. Výchozí hodnota je **allocator**< `CharType`>.  
...
|[pointer](#pointer)|Typ, který poskytuje ukazatel na element znak v poli řetězec nebo znak.|  
|[reference](#reference)|Typ, který obsahuje odkaz na element uložené v řetězci.|  
...
|[assign](#assign)|Přiřadí nové znakových hodnot obsah řetězce.|  
...
|[capacity](#capacity)|Vrátí největší počet elementů, které může být uložený v řetězci bez zvýšení přidělení paměti řetězce.|  
...
|[clear](#clear)|Vymaže všechny elementy řetězce.|  
...
|[insert](#insert)|Vloží elementu nebo počet elementů nebo rozsah elementů do řetězce na zadané pozici.|  
...
|[reserve](#reserve)|Nastaví kapacitu řetězec na číslo skvělé jako určeného čísla.|  
|[resize](#resize)|Určuje novou velikost řetězce, připojením nebo vymazání elementy podle potřeby.|  
...
|[operator=](#op_eq)|Přiřadí nové znakových hodnot obsah řetězce.|  
|[operator&#91;&#93;](#op_at)|Poskytuje odkaz na znak na zadaný index v řetězci.|  
...
### <a name="parameters"></a>Parametry  
 `ptr`  
 C – řetězec, který bude přidán.  
  
 `str`  
 Řetězec, jehož znaky jsou mají být připojeny.  
  
 `_Off`  
 Index součástí zdrojový řetězec zadávání znaků, který má být připojen.  
  
 `count`  
 Počet znaků, který má být připojen maximálně z zdrojový řetězec.  
  
 `_Ch`  
 Hodnota znaku, který bude přidán.  
  
 `first`  
 Vstupní iterovat adresování prvním elementem v rozsahu mají být připojeny.  
  
 `last`  
 Vstupní iterator, const_pointer – nebo const_iterator – adresování pozice jeden nad rámec posledním prvkem v rozsahu připojí.  
...
### <a name="parameters"></a>Parametry  
 `ptr`  
 Ukazatel na znaky C-řetězec, který má být přiřazen cílový řetězec.  
 ...
 `_Ch`  
 Hodnota znaku přiřazení.  
  
 `first`  
 Vstupní iterator, const_pointer – nebo const_iterator – adresování první znak v rozsahu zdrojový řetězec má být přiřazen cílový rozsah.  
  
 `last`  
 Vstupní iterator, const_pointer – nebo const_iterator – adresování jeden nad rámec jeho poslední znak v rozsahu zdrojové řetězce, který má být přiřazen cílový rozsah.  
  
 `off`  
 Pozice, kdy se spustí novou znaků pro přiřazení.  
...
### <a name="parameters"></a>Parametry  
 `_Off`  
 Index pozice elementu, který chcete odkazovat.  
...
### <a name="parameters"></a>Parametry  
 `ptr`  
 C – řetězec, jehož znaky mají být použita k chybě při inicializaci `string` vytvářen. Tato hodnota nemůže být ukazatele null.  
  
 `_Al`  
 Třída přidělení úložiště pro vytvářen objekt řetězce.  
  
 `count`  
 Počet znaků, který má být inicializován.  
  
 `right`  
 Řetězec, který inicializuje řetězec vytvářen.  
  
 `_Roff`  
 Index znaku v řetězci, který je první, který se má použít k chybě při inicializaci znakových hodnot pro řetězec vytvářen.  
  
 `_Ch`  
 Hodnota znaku, který chcete zkopírovat do řetězce vytvářen.  
  
 `first`  
 Vstupní iterator, const_pointer – nebo const_iterator – prvním elementem v zdrojový rozsah adres má být vložen.  
  
 `last`  
 Vstupní iterator, const_pointer – nebo const_iterator – pozice jeden nad rámec posledním prvkem v zdrojový rozsah adres má být vložen.  
...
### <a name="parameters"></a>Parametry  
 `str`  
 Řetězec, který se má porovnat s operandem řetězec.  
  
 `_Pos1`  
 Index operand řetězce, při kterém začíná porovnání.  
 ...
 `_Off`  
 Index řetězec parametrů, při kterém začíná porovnání.  
...
### <a name="parameters"></a>Parametry  
 `ptr`  
 Znak cílového pole, do které budou elementy zkopírovány.  
  
 _ `Count`  
 Počet znaků, které se mají zkopírovat, maximálně z zdrojový řetězec.  
  
 `_Off`  
 Počáteční pozice v zdrojový řetězec, ze kterého mají být provedeny kopie.  
...
### <a name="parameters"></a>Parametry  
 `first`  
 Iterace adresování pozice první prvek v rozsahu jsou vymazány.  
  
 `last`  
 Iterace adresování pozici jeden po posledním prvkem v rozsahu jsou vymazány.  
  
 `_It`  
 Iterace adresování pozice elementu v řetězci jsou vymazány.  
  
 `_Pos`  
 Index prvního znaku v řetězci odeberou.  
  
 `count`  
 Počet elementů, které budou odstraněna, pokud jsou v rozsahu od začátku řetězce s tolik *_Pos*.  
...
### <a name="parameters"></a>Parametry  
 ...
 `_Off`  
 Index pozice, kdy je dokončení hledání.  
...
### <a name="parameters"></a>Parametry  
 *_P0*  
 Index pozice za bod vložení nové znaky.  
  
 `ptr`  
 C – řetězec, který má být zcela nebo částečně vložena do řetězce.  
  
 `count`  
 Počet znaků, který má být vložen.  
  
 `str`  
 Řetězec, který má být zcela nebo částečně vložena do řetězce cíl.  
  
 `_Off`  
 Index součástí zdrojový řetězec zadávání znaků, který má být připojen.  
  
 `_Ch`  
 Hodnota znak prvky, které mají být vloženy.  
  
 `_It`  
 Iterace adresování pozice, za které je možné vložit znak.  
...
### <a name="parameters"></a>Parametry  
 ...
 `right`  
 Znaky řetězec, který má být připojen.  
...
### <a name="parameters"></a>Parametry  
 `str`  
 Řetězec, který má být zdroj znaků pro operand řetězec.  
  
 `_Pos1`  
 Index operand řetězce, při kterém začíná nahrazení.  
  
 `_Num1`  
 Maximální počet znaků v řetězci operand vyměnit.  
  
 *_Pos2*  
 Index řetězec parametrů, ve kterém kopírování začíná.  
  
 `_Num2`  
 Maximální počet znaků, který se má použít z parametru C-řetězec.  
  
 `ptr`  
 C – řetězec, který má být zdroj znaků pro operand řetězec.  
  
 `_Ch`  
 Znak, který má být zkopírován do operand řetězec.  
  
 * first0 *  
 Iterace adresování první znak v řetězci operand odeberou.  
  
 * last0*  
 Iterace adresování poslední znak v řetězci operand odeberou.  
  
 `first`  
 Iterator, const_pointer – nebo const_iterator – adresování první znak zkopírovat do parametr řetězce.  
  
 `last`  
 Iterator, const_pointer – nebo const_iterator – adresování poslední znak zkopírovat do parametr řetězce.  
  
 `count`  
 Počet, kolikrát `_Ch` se zkopíruje do operand řetězce.  
...
### <a name="parameters"></a>Parametry  
 ...
 `_Ch`  
 Hodnota, který připojí znaky jsou inicializovány s, pokud další elementy jsou požadovány.  
...
### <a name="parameters"></a>Parametry  
 `_Off`  
 Index vyhledávání element na pozici, ze které je vytvořena kopie řetězce, výchozí hodnotou 0.  
...
### <a name="parameters"></a>Parametry  
 `str`  
 Zdrojový řetězec, jehož elementy jsou k výměně s těmi, která v cílový řetězec.  
