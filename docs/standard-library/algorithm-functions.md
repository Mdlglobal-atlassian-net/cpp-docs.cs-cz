...
První šablona funkce vrátí [is_sorted_until –](https://msdn.microsoft.com/bbad99d0-deaa-4fe6-ae58-eb5b3e4dded0)`( first, last ) == last`. `operator<` Funkce provádí porovnání pořadí.
