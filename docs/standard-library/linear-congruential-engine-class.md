...
```  
 ...
 Podrobné informace o algoritmus lineární congruential modul, najdete v článku Wikipedia [lineární congruential generátor](http://go.microsoft.com/fwlink/LinkId=402446).  
