...
||||
|-|-|-|
|[Absolutní](#absolute)|[Začátek](#begin)|[Kanonickém tvaru](#canonical)|
...
|[remove](#remove)|[remove_all](#remove_all)|[Přejmenování](#rename)|
...
1. Každý komponent cesty. (tečka je to aktuální adresář vymezenému předchozí komponenty cesty) se odebere.

1. Každý pár komponenty cesty X nebo... (tečkami je nadřazený adresář vymezenému předchozí komponenty cesty) se odebere.
...
- Pokud požádá & (copy_options::create_symlinks &#124; copy_options::skip_symlinks), pomocí symlink_status – volání
...
Jinak Pokud \!existuje\(k\) &#124; &#124; požádá & copy_options::overwrite_existing &#124; &#124; požádá & copy_options::update_existing & & last_write_time –\(na \) \< last_write_time –\(z\) &#124; &#124; \! \(požádá & \(copy_options::skip_existing &#124; copy_options::o verwrite_existing &#124; copy_options:update_existing\) \) pak pokus o zkopírování obsahu a atributy souboru ze souboru. Sestavy jako chybu, pokud se nezdaří pokus o kopírování.
