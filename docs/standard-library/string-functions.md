...
### <a name="parameters"></a>Parametry  
 `is`  
 Vstupní datový proud, ze které je extrahována řetězec.  
...
### <a name="parameters"></a>Parametry  
 `left`  
 Jeden řetězec, jehož elementy jsou záměnu s těmi jiným řetězcem.  
  
 `right`  
 Jiný řetězec, jehož elementy jsou k si místo se první řetězec.  
