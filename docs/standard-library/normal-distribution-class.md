...
Podrobné informace o normálního rozdělení, najdete v článku Wolfram MathWorld [normálního rozdělení](http://go.microsoft.com/fwlink/LinkId=400924).  
