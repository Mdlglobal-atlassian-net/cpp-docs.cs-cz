...
#### <a name="parameters"></a>Parametry  
 ...
 `Traits`  
 Typ poskytující objekt funkce, který může porovnat dvě hodnoty prvků pro určení jejich relativního pořadí v objektu map. Tento argument je volitelný a binární predikát `less<Key>` je výchozí hodnota.  
 ...
 `Allocator`  
 Typ představující uložený objekt alokátoru, který zapouzdřuje informace o přidělování a navrácení paměti zpět objektu map. Tento argument je volitelný a výchozí hodnota je `allocator<pair<const Key, Type> >`.  
...
### <a name="parameters"></a>Parametry  
 `key`  
 Hodnota klíče elementů lze porovnat z mapování.  
...
### <a name="parameters"></a>Parametry  
 `key`  
 Hodnota klíče argument být porovnána s klíč řazení elementu z prohledávaný mapy.  
...
### <a name="parameters"></a>Parametry  
 `key`  
 Hodnota klíče odpovídala klíč řazení elementu z mapy být vyhledán.  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Argument mapy poskytování elementy pro si místo se cíl mapy.  
...
### <a name="parameters"></a>Parametry  
 `key`  
 Hodnota klíče argument který se má porovnat s hodnotou klíče řazení elementu z mapy být vyhledán.  
...
## <a name="see-also"></a>Viz také  
 [\<Mapa > členy](http://msdn.microsoft.com/en-us/7e8f0bc2-6034-40f6-9d14-76d4cef86308)   
