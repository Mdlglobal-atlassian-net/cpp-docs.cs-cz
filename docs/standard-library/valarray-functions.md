...
### <a name="parameters"></a>Parametry  
 `left`  
 Vstupu valarray – jehož elementy jsou provozována na členskou funkci.  
...
### <a name="parameters"></a>Parametry  
 `left`  
 Konstantní číselná data typu nebo vstup valarray – jehož elementy zadejte hodnoty pro souřadnici y Arkus argumentu.  
  
 `right`  
 Konstantní číselná data typu nebo vstup valarray – jehož elementy zadejte hodnoty pro souřadnici x Arkus argumentu.  
...
### <a name="parameters"></a>Parametry  
 `left`  
 Vstupu valarray – základ pro každý element exponentiated zadat jehož elementy.  
  
 `right`  
 Vstupu valarray – jehož elementy zadejte možnosti pro každý element exponentiated.  
