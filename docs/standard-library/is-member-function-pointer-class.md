...
Instance predikátu typu má hodnotu true, *Pokud typ,* který je ukazatel na členskou funkci, nebo `cv-qualified` ukazatel na členskou funkci, v opačném případě obsahuje hodnotu false.
