...
|Operátor|Popis|
|-|-|
|[operátor =](#op_eq)|Přiřadí hodnoty k tomuto `basic_istringstream` objekt z objektu parametru.|
...
`right` Rvalue odkaz `basic_istringstream` objektu.
...
`right` Rvalue odkaz na `basic_istringstream` objektu.
