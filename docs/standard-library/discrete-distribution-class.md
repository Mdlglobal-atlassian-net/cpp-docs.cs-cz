...
### <a name="parameters"></a>Parametry  
*firstW*  
 Iterator první v seznamu, ze kterého chcete vytvořit rozdělení.  
  
*lastW*  
 Poslední iterator v seznamu, ze kterého chcete vytvořit distribuční (bez – včetně protože iterátory používají prázdný element end).  
...
*Vysoká*  
 Nejvyšší hodnotu v rozsahu distribuce.  
