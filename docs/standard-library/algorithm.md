...
|[stejné](../standard-library/algorithm-functions.md#equal)|Porovná dva rozsahy prvek podle prvku buď ke zjištění rovnosti, nebo ekvivalentnosti ve smyslu určeném binárním predikátem.|  
...
|[maximální počet](../standard-library/algorithm-functions.md#max)|Porovná dva objekty a vrátí větší z nich, kde kritérium pořadí může být určeno binárním predikátem.|  
...
|[zpětné](../standard-library/algorithm-functions.md#reverse)|Obrátí pořadí prvků v rozsahu.|  
...
|[hledání](../standard-library/algorithm-functions.md#search)|Vyhledá první výskyt sekvence v cílovém rozsahu, jejíž prvky jsou rovné prvkům v dané sekvenci prvků nebo jejíž prvky jsou ekvivalentní ve smyslu určeném binárním predikátem prvkům v dané sekvenci.|  
