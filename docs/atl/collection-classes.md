...
- [CComSafeArray](../atl/reference/ccomsafearray-class.md) Tato třída je obálkou pro strukturu [datového typu SafeArray](/windows/win32/api/oaidl/ns-oaidl-safearray) .

- [CComSafeArrayBound](../atl/reference/ccomsafearraybound-class.md) Tato třída je obálkou pro strukturu [SAFEARRAYBOUND](/windows/win32/api/oaidl/ns-oaidl-safearraybound) .
