---
title: Funkce obslužných rutin zpráv | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
ms.locfileid: "46040961"
---
# <a name="message-handler-functions"></a>Funkce obslužných rutin zpráv

Knihovna ATL poskytuje tři typy funkce obslužné rutiny zpráv:

|Typ obslužné rutiny zpráv|Odpovídající zprávu – makro|
|-----------------------------|---------------------------------|
