---
title: Programování s použitím knihovny ATL a běhového kódu jazyka C
ms.date: 11/04/2016
helpviewer_keywords:
- ATL_MIN_CRT macro
- CRT, using with ATL
...
[Výhody a nevýhody metody použité k připojení k CRT](../atl/benefits-and-tradeoffs-of-the-method-used-to-link-to-the-crt.md)<br/>
Shrnuje výhody a nevýhody účastnící se připojení k CRT staticky nebo dynamicky propojení.

[Propojení projektu ATL s knihovnami CRT](../atl/linking-to-the-crt-in-your-atl-project.md)<br/>
