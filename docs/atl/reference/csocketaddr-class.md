...
### <a name="return-value"></a>Návratová hodnota  
 Ukazatel na odkazovaného seznamu jednoho nebo více `addrinfo` struktury obsahující odpovědi informace o hostiteli. Další informace o `addrinfo` struktury, najdete v článku "addrinfo" v [knihovny MSDN](http://go.microsoft.com/fwlink/linkid=556)  
