...
|*iVerb* Value|Volá se funkce DoVerb pomocné funkce|
|-------------------|-----------------------------------|
...
Příkazy můžete přidat do souboru .rgs vašeho projektu. Podívejte se například CIRCCTL. RGS v [KR](../../overview/visual-cpp-samples.md) vzorku.
