...
|_chdir _wchdir _getcwd _getdcwd _wgetcwd _wgetdcwd|Koncept pracovního adresáře neplatí pro aplikace pro Windows 8.x Store.|Místo toho použijte úplné cesty.|  
