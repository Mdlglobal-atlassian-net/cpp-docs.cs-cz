...
Každý záznam. pdata pro ARM má délku 8 bajtů. Obecný formát záznamu umístí relativní virtuální adresu (RVA) funkce v prvním 32ovém slově následovaný druhým slovem, které obsahuje buď ukazatel na proměnnou length. xdata, nebo zabalené slovo, které popisuje kanonickou sekvenci unwind funkcí, jak je znázorněno v této tabulce:
...
|čl|*C*= = 1 a (*L*= = 0 a *R*= = 1 a PF = = 0)|16|`mov r11,sp`|C0 – CF/ARIAL|
...
Chcete-li nastavit řetězení rámců, je k dispozici buď instrukce 3a, nebo 3b, pokud je nastaven bit *jazyka C* . Pokud nejsou vloženy žádné Registry `mov` jiné než R11 a LR, jedná se o 16bitovou bitovou kopii. v opačném případě je to 32 bitů `add`.
...
|-------|-------|-------|--------|------------------------------|--------------------------|
|0|0|0|0|R4-r*N*|žádné|
|0|0|0|1|r*S*– r*N*|žádné|
|0|0|1|0|žádné|D8-d*E*|
|0|0|1|1|r*S*-R3|D8-d*E*|
|0|1|0|0|R4-r*N*, LR|žádné|
|0|1|0|1|r*S*-r*N*, LR|žádné|
|0|1|1|0|LR|D8-d*E*|
|0|1|1|1|r*S*-R3, LR|D8-d*E*|
|1|0|0|0|R4-r*N*, R11|žádné|
|1|0|0|1|r*S*-r*N*, R11|žádné|
|1|0|1|0|r11|D8-d*E*|
|1|0|1|1|r*S*-R3, R11|D8-d*E*|
|1|1|0|0|R4-r*N*, R11, LR|žádné|
|1|1|0|1|r*S*-r*N*, R11, LR|žádné|
...
|EE|00 – hodnotami 0f|||16|specifické pro společnost Microsoft|
|EE|10. FF|||16|K dispozici.|
|EF|00 – hodnotami 0f|||32|`ldr   lr,[sp],#X`<br /><br /> kde X je (Code & 0x000F) \* 4|
...
|POLOŽEK|00-FF|00-FF|00-FF|32|`add   sp,sp,#X`<br /><br /> kde X je (Code & 0x00FFFFFF) \* 4|
|Arial||||16|NOP (16 bitů)|
|FC||||32|NOP (32 bitů)|
