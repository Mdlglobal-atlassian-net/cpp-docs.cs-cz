...
1. Postupujte podle kroků popsaných v tématu [Principy závislostí Visual C++ aplikace](../windows/understanding-the-dependencies-of-a-visual-cpp-application.md). Prohlížeč závislostí může zobrazit většinu závislostí pro aplikaci nebo knihovnu DLL. Pokud zjistíte, že některé knihovny dll chybějí, nainstalujte je do počítače, na kterém se pokoušíte spustit aplikaci.
...
Předpokládejme, že máme aplikaci, soubor. exe, která je sestavena pomocí Visual C++. Manifest aplikace buď je vložen do souboru Application. exe jako binární RT_MANIFEST prostředku, který má ID rovnající se 1 nebo je uložen jako samostatný soubor. exe. manifest. Obsah tohoto manifestu se podobá tomuto:
