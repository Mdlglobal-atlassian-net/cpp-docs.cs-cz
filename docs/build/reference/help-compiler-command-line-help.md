---
title: -HELP (Nápověda příkazového řádku pro kompilátor) | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
- Tato možnost kompilátoru by měl dá přistupovat jenom z příkazového řádku.
