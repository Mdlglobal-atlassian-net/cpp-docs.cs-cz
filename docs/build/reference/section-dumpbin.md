...
## <a name="remarks"></a>Poznámky  
 Tato možnost omezuje výstup na informace o zadané *části*. Použití [/HEADERS](../../build/reference/headers.md) možnost získat seznam oddílů v souboru.  
