...
Tato část obsahuje informace o proměnných prostředí, které ovlivňují testovací scénáře na bitovou kopii vytvořené pomocí /LTCG:PGI.  
  
## <a name="remarks"></a>Poznámky  
 Existují tři proměnné prostředí, které ovlivňují testovací scénáře pro optimalizace na základě profilu:  
