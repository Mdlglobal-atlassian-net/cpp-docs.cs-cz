...
## <a name="remarks"></a>Poznámky  
 ...
 Další informace najdete v tématu [/NXCOMPAT (kompatibilní s předcházením spuštění dat)](../../build/reference/nxcompat-compatible-with-data-execution-prevention.md).  
