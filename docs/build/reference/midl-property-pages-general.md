---
title: 'MIDL – stránky vlastností: Obecné'
ms.date: 11/04/2016
f1_keywords:
...
Informace o tom, jak získat přístup k **Obecné** stránku vlastností v **MIDL** složky, najdete v článku [vlastnosti kompilátoru a sestavení nastavte C++ v sadě Visual Studio](../working-with-project-properties.md).
