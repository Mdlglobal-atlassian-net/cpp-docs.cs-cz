...
|[/Gd](gd-gr-gv-gz-calling-convention.md)|Používá konvenci `__cdecl` volání (pouze x86).|
...
|[/Gr](gd-gr-gv-gz-calling-convention.md)|Používá konvenci `__fastcall` volání (pouze x86).|
...
|[/Gz](gd-gr-gv-gz-calling-convention.md)|Používá konvenci `__stdcall` volání (pouze x86).|
...
|[/OpenMP](openmp-enable-openmp-2-0-support.md)|[`#pragma omp`](../../preprocessor/omp.md) Povoluje direktivu ve zdrojovém kódu.|
...
|[/QIfist](qifist-suppress-ftol.md)|Zastaralé Potlačí `_ftol` , když je vyžadován převod z typu s plovoucí desetinnou čárkou na integrální typ (pouze x86).|
