---
title: Možnosti kompilátoru seřazené abecedně
ms.date: 08/08/2019
helpviewer_keywords:
- compiler options, C++
...
ms.locfileid: "71685320"
---
# <a name="compiler-options-listed-alphabetically"></a>Možnosti kompilátoru seřazené abecedně
...
|[/GH](gh-enable-pexit-hook-function.md)|Funkce vidlice volání `_pexit`.|
|[/GH](gh-enable-penter-hook-function.md)|Funkce vidlice volání `_penter`.|
...
|[/OpenMP](openmp-enable-openmp-2-0-support.md)|Povolí direktivu [`#pragma omp`](../../preprocessor/omp.md) ve zdrojovém kódu.|
...
|[/QIfist](qifist-suppress-ftol.md)|Zastaralé. Potlačí `_ftol`, pokud je vyžadován převod z typu s plovoucí desetinnou čárkou na integrální typ (pouze x86).|
