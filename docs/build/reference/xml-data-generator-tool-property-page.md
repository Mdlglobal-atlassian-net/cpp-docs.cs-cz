---
title: Stránka vlastností nástroje generátoru dat XML
ms.date: 11/04/2016
f1_keywords:
...
Informace o tom, jak získat přístup k **nástroje generátoru dat XML** stránky vlastností naleznete v tématu [vlastnosti kompilátoru a sestavení nastavte C++ v sadě Visual Studio](../working-with-project-properties.md).
