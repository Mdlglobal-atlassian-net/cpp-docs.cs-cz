---
title: Soubory .Def jako vstup linkeru
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "62272816"
---
# <a name="def-files-as-linker-input"></a>Soubory .Def jako vstup linkeru

Zobrazit [soubory definice modulu (.def)](module-definition-dot-def-files.md) Další informace. Použití [def](def-specify-module-definition-file.md) můžete zadat název souboru .def.
