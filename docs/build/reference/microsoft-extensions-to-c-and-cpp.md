---
title: Rozšíření Microsoft pro C a C++ | Dokumentace Microsoftu
ms.custom: ''
ms.date: 06/14/2018
ms.technology:
- cpp-tools
...
- [/Za, /Ze (zakázání jazykových rozšíření)](../../build/reference/za-ze-disable-language-extensions.md)
