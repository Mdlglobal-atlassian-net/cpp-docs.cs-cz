...
Ve výchozím nastavení se vytvoří sestavení. Můžete také použít [/LN (vytvoření modulu MSIL)](ln-create-msil-module.md) – možnost kompilátoru jak vytvořit modul.
