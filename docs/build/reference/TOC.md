...
#### [-AI (zadání adresáře metadat)](ai-specify-metadata-directories.md)
...
#### [-await (povolení podpory pomocné rutiny)](await-enable-coroutine-support.md)
#### [-bigobj (zvýšení počtu oddílů v souboru .Obj)](bigobj-increase-number-of-sections-in-dot-obj-file.md)
#### [-C (zachování komentářů při předběžném zpracování)](c-preserve-comments-during-preprocessing.md)
...
#### [-E (předběžné zpracování výstupu stdout)](e-preprocess-to-stdout.md)
#### [-EH (model zpracování výjimek)](eh-exception-handling-model.md)
#### [-EP (předběžné zpracování do direktiv bez příkazů #line)](ep-preprocess-to-stdout-without-hash-line-directives.md)
#### [-errorReport (sestava s interními chybami kompilátoru)](errorreport-report-internal-compiler-errors.md)
...
##### [-FA, -Fa (soubor seznamu)](fa-fa-listing-file.md)
...
##### [-Fi (předběžné zpracování názvu výstupního souboru)](fi-preprocess-output-file-name.md)
...
#### [-fp (zadání chování hodnot s plovoucí desetinnou čárkou)](fp-specify-floating-point-behavior.md)
...
#### [-GH (povolení funkce háku _pexit)](gh-enable-pexit-hook-function.md)
#### [-Gh (povolení funkce háku _penter)](gh-enable-penter-hook-function.md)
...
#### [-GR (povolení informací typu run-time)](gr-enable-run-time-type-information.md)
...
#### [-GT (podpora úložiště thread local se zabezpečenými vlákny)](gt-support-fiber-safe-thread-local-storage.md)
#### [-Gw (optimalizace globálních dat)](gw-optimize-global-data.md)
#### [-GX (povolení zpracování výjimek)](gx-enable-exception-handling.md)
#### [-Gy (povolení propojení na úrovni funkcí)](gy-enable-function-level-linking.md)
#### [-GZ (povolení běhové kontroly chyb rámce zásobníku)](gz-enable-stack-frame-run-time-error-checking.md)
#### [-H (omezení délky externích názvů)](h-restrict-length-of-external-names.md)
#### [-HELP (nápověda příkazového řádku pro kompilátor)](help-compiler-command-line-help.md)
#### [-homeparams (kopírování parametrů registru do zásobníku)](homeparams-copy-register-parameters-to-stack.md)
#### [-hotpatch (vytvoření bitové kopie s možností provádění oprav za běhu)](hotpatch-create-hotpatchable-image.md)
#### [-I (další adresáře souborů k zahrnutí)](i-additional-include-directories.md)
...
#### [-nologo (potlačení úvodního nápisu při spouštění) (C/C++)](nologo-suppress-startup-banner-c-cpp.md)
...
#### [-P (předběžné zpracování souboru)](p-preprocess-to-a-file.md)
...
##### [-Qpar-report (úroveň sestav s automatickou paralelizací)](qpar-report-auto-parallelizer-reporting-level.md)
##### [-Qsafe_fp_loads](qsafe-fp-loads.md)
##### [-Qvec-report (úroveň sestav s automatickou vektorizací)](qvec-report-auto-vectorizer-reporting-level.md)
...
#### [-Tc, -Tp, -TC, -TP (zadání typu zdrojového souboru)](tc-tp-tc-tp-specify-source-file-type.md)
#### [-U, -u (nedefinované symboly)](u-u-undefine-symbols.md)
#### [-utf-8 (nastavení zdrojové znakové sady a znakové sady spuštění na UTF-8)](utf-8-set-source-and-executable-character-sets-to-utf-8.md)
...
#### [-vd (zakázání posunutí konstrukcí)](vd-disable-construction-displacements.md)
#### [-vmb, -vmg (metoda reprezentace)](vmb-vmg-representation-method.md)
#### [-vmm, -vms, -vmv (obecná reprezentace)](vmm-vms-vmv-general-purpose-representation.md)
...
#### [-Wp64 (zjištění problémů s 64bitovou přenositelností)](wp64-detect-64-bit-portability-issues.md)
...
##### [-Yc (vytvoření předkompilovaného hlavičkového souboru)](yc-create-precompiled-header-file.md)
##### [-Yd (umístění informací o ladění do souboru objektu)](yd-place-debug-information-in-object-file.md)
##### [-Yl (vložení reference PCH do ladicí knihovny)](yl-inject-pch-reference-for-debug-library.md)
##### [-Yu (použití předkompilovaného hlavičkového souboru)](yu-use-precompiled-header-file.md)
...
##### [-Zc:forScope (vynucení dodržování standardu pro obor cyklu for)](zc-forscope-force-conformance-in-for-loop-scope.md)
##### [-Zc:implicitNoexcept (specifikátory implicitních výjimek)](zc-implicitnoexcept-implicit-exception-specifiers.md)
##### [-Zc:inline (odebrání neodkazovaných sekvencí COMDAT)](zc-inline-remove-unreferenced-comdat.md)
##### [-Zc:noexceptTypes (pravidla C++17 noexcept)](zc-noexcepttypes.md)
##### [-Zc:referenceBinding (vynucení pravidel vazby referencí)](zc-referencebinding-enforce-reference-binding-rules.md)
##### [-Zc:rvalueCast (vynucení pravidel převodu typů)](zc-rvaluecast-enforce-type-conversion-rules.md)
##### [-Zc:sizedDealloc (povolení funkcí dealokace v globálním měřítku)](zc-sizeddealloc-enable-global-sized-dealloc-functions.md)
...
##### [-Zc:trigraphs (náhrada spřežek tří znaků)](zc-trigraphs-trigraphs-substitution.md)
...
#### [-Zm (určení omezení přidělení paměti pro předkompilované hlavičky)](zm-specify-precompiled-header-memory-allocation-limit.md)
#### [-Zo (rozšířené optimalizované ladění)](zo-enhance-optimized-debugging.md)
#### [-Zp (zarovnání členů struktury)](zp-struct-member-alignment.md)
#### [-Zs (pouze kontrola syntaxe)](zs-syntax-check-only.md)
#### [-ZW (kompilace Windows Runtime)](zw-windows-runtime-compilation.md)
...
### [-APPCONTAINER (aplikace pro web Windows Store)](appcontainer-windows-store-app.md)
### [-ASSEMBLYDEBUG (přidání atributu DebuggableAttribute)](assemblydebug-add-debuggableattribute.md)
### [-ASSEMBLYLINKRESOURCE (vytvoření odkazu na prostředek rozhraní .NET Framework)](assemblylinkresource-link-to-dotnet-framework-resource.md)
...
### [-CLRIMAGETYPE (zadání typu bitové kopie modulu CLR)](clrimagetype-specify-type-of-clr-image.md)
...
### [-DEBUG (generování ladicích informací)](debug-generate-debug-info.md)
### [-DEBUGTYPE (možnosti ladicích informací)](debugtype-debug-info-options.md)
...
### [-DELAY (nastavení importu odloženého načtení)](delay-delay-load-import-settings.md)
### [-DELAYLOAD (import odloženého načtení)](delayload-delay-load-import.md)
### [-DELAYSIGN (částečně podepsané sestavení)](delaysign-partially-sign-an-assembly.md)
...
### [-DYNAMICBASE (použití modulu pro náhodné určení rozložení adresního prostoru)](dynamicbase-use-address-space-layout-randomization.md)
...
### [-FUNCTIONPADMIN (vytvoření bitové kopie s možností provádění oprav za běhu)](functionpadmin-create-hotpatchable-image.md)
...
### [-GUARD (povolení kontroly ochrany)](guard-enable-guard-checks.md)
...
### [-INCREMENTAL (inkrementální odkaz)](incremental-link-incrementally.md)
### [-INTEGRITYCHECK (povinná kontrola podpisu)](integritycheck-require-signature-check.md)
### [-KEYCONTAINER (určení kontejneru klíčů pro podpis sestavení)](keycontainer-specify-a-key-container-to-sign-an-assembly.md)
### [-KEYFILE (určení klíče nebo páru klíčů pro podpis sestavení)](keyfile-specify-key-or-key-pair-to-sign-an-assembly.md)
...
### [-MACHINE (určení cílové platformy)](machine-specify-target-platform.md)
...
### [-MANIFESTUAC (vložené informace UAC v manifestu)](manifestuac-embeds-uac-information-in-manifest.md)
### [-MAP (generování souboru mapování)](map-generate-mapfile.md)
### [-MAPINFO (zahrnutí informaci do souboru mapování)](mapinfo-include-information-in-mapfile.md)
...
### [-NOLOGO (potlačení úvodního nápisu při spouštění) (linker)](nologo-suppress-startup-banner-linker.md)
...
### [-SAFESEH (bitová kopie má bezpečné obslužné rutiny výjimek)](safeseh-image-has-safe-exception-handlers.md)
...
### [-SWAPRUN (načtení výstupu linkeru do odkládacího souboru)](swaprun-load-linker-output-to-swap-file.md)
...
### [-VERBOSE (tisk zpráv průběhu)](verbose-print-progress-messages.md)
