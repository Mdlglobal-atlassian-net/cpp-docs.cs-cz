...
# [Referenční zdroje k nástroji MSBuild pro projekty C++](msbuild-reference-cpp.md)
## [Vnitřní fungování nástroje MSBuild pro projekty C++](msbuild-visual-cpp-overview.md)
## [Běžná makra pro příkazy a vlastnosti sestavení](common-macros-for-build-commands-and-properties.md)
## [Typy souborů používaných v projektech C++](file-types-created-for-visual-cpp-projects.md)
### [Soubory projektu a řešení](project-and-solution-files.md)
### [Šablony projektů C++](visual-cpp-project-types.md)
### [Šablony nových položek v C++](using-visual-cpp-add-new-item-templates.md)
...
### [Soubory nápovědy HTML](help-files-html-help.md)
### [Soubory nápovědy WinHelp](help-files-winhelp.md)
### [Soubory pokynů pro Intellisense](hint-files.md)
...
## [Referenční zdroje k vlastnostem projektu C++](property-pages-visual-cpp.md)
### [Obecná stránka vlastností](general-property-page-project.md)
### [Obecná stránka vlastností](general-property-page-file.md)
...
# [Referenční zdroje ke kompilátorům MSVC](compiling-a-c-cpp-program.md)
...
##### [Optimalizace plovoucí čárky v MSVC](floating-point-optimization.md)
...
##### [/Zc:__cplusplus (povolení aktualizovaného makra __cplusplus)](zc-cplusplus.md)
...
### [/CETCOMPAT (kompatibilní s technologií Control-flow Enforcement Technology)](cetcompat.md)
...
# [Další nástroje sestavení MSVC](c-cpp-build-tools.md)
## [NMAKE – referenční zdroje](nmake-reference.md)
### [Projekty NMAKE v sadě Visual Studio](creating-a-makefile-project.md)
...
# [Chyby kompilátoru a nástrojů sestavení](../../error-messages/)
# [Dokumentace XML pro C++](xml-documentation-visual-cpp.md)
## [Doporučené značky pro komentáře dokumentace C++](recommended-tags-for-documentation-comments-visual-cpp.md)
### [<c>](c-visual-cpp.md)
...
## [Oddělovače pro značky dokumentace C++](delimiters-for-visual-cpp-documentation-tags.md)
