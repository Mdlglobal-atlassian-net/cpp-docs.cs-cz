...
description: Pomocí integrovaného vývojového prostředí sady C++ Visual Studio můžete změnit možnosti kompilátoru a linkeru a další nastavení sestavení.
ms.date: 07/17/2019
helpviewer_keywords:
