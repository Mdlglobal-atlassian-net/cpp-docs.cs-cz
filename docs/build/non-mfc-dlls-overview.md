---
title: 'Knihovny DLL mimo MFC: Přehled | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
MFC DLL není knihovnu DLL, kterou nepoužívá MFC interně a může být volána exportovaných funkcí v knihovně DLL knihovny MFC nebo mimo MFC spustitelné soubory. Funkce jsou obvykle exportovány z non - MFC DLL pomocí standardní rozhraní jazyka.  
 ...
 Další informace o MFC DLL najdete v tématu [knihoven](http://msdn.microsoft.com/library/windows/desktop/ms682589) v [!INCLUDE[winsdkshort](../atl-mfc-shared/reference/includes/winsdkshort_md.md)].  
  
## <a name="what-do-you-want-to-do"></a>Co chcete udělat?  
  
-   [Návod: Vytvoření a použití dynamické knihovny](../build/walkthrough-creating-and-using-a-dynamic-link-library-cpp.md)  
