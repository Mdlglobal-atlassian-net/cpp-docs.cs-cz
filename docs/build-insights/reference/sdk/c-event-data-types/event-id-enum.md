---
title: Výčet EVENT_ID
description: Odkaz C++ na výčet EVENT_ID Build Insights SDK
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
ms.locfileid: "78333781"
---
# <a name="event_id-enum"></a>Výčet EVENT_ID
...
| Název | Hodnota | Adresa URL podrobností události |
|--|--|--|
...
| `EVENT_ID_COMPILER` | 7 (0x00000007) | [PŘEPÍNAČ](../event-table.md#compiler) |
...
| `EVENT_ID_LINKER` | 18 (0x00000012) | [LINKERU](../event-table.md#linker) |
...
| `EVENT_ID_THREAD` | 29 (0x0000001D) | [Doporučujeme](../event-table.md#thread) |
