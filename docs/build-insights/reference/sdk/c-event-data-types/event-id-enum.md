---
title: výčtEVENT_ID
description: C++ Build Insights SDK EVENT_ID výčtu odkaz.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
ms.locfileid: "81325569"
---
# <a name="event_id-enum"></a>výčtEVENT_ID
...
| Name (Název) | Hodnota | Adresa URL podrobností o události |
|--|--|--|
...
| `EVENT_ID_COMPILER` | 7 (0x00000007) | [Kompilátoru](../event-table.md#compiler) |
...
| `EVENT_ID_FUNCTION` | 15 (0x000000F) | [Funkce](../event-table.md#function) |
...
| `EVENT_ID_PASS1` | 24 (0x00000018) | [PRŮKAZ 1](../event-table.md#pass1) |
| `EVENT_ID_PASS2` | 25 (0x00000019) | [PRŮKAZ 2](../event-table.md#pass2) |
...
| `EVENT_ID_THREAD` | 29 (0x0000001D) | [Vlákno](../event-table.md#thread) |
...
Tyto hodnoty se používají s funkcemi Sady C SDK.
