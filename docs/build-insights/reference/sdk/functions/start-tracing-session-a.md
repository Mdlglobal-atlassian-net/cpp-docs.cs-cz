---
title: Spuštění TrasováníRelaceA
description: C++ Build Insights SDK StartTracingSessionA odkaz na funkci.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
ms.locfileid: "81323769"
---
# <a name="starttracingsessiona"></a>Spuštění TrasováníRelaceA
...
*Název_relace*\
Název relace trasování, která má být zahájena. Použijte stejný název při volání [StopTracingSessionA](stop-tracing-session.md) nebo jiné funkce stop stop.
