...
Je-li sestavit a spustit kód znovu v tomto okamžiku, se stále zobrazí "Hello World" v konzole. V dalším kroku upravíte `main` funkce provedete pár výpočtů.
