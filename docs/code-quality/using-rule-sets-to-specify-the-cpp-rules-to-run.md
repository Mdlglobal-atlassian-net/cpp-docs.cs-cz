...
1. Na kartě **vlastnosti** klikněte na možnost **Analýza kódu**.

1. V rozevíracím seznamu **sada pravidel** proveďte jednu z následujících akcí:
...
1. Zvolením možnosti **otevřít** zobrazte pravidla v editoru sad pravidel.
