...
Tato část uvádí a popisuje rutiny běhové knihovny Microsoft podle kategorie. Pro usnadnění práce odkaz jsou uvedeny některé rutiny ve více než jednu kategorii. Rutiny vícebajtových znaků a široká charakterová rutiny jsou seskupené s jednobajtové - svými protějšky znaku, pokud existují.  
  
 Hlavní kategorie rutiny běhové knihovny Microsoft jsou:  
