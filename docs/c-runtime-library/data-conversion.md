...
|[labs](../c-runtime-library/reference/abs-labs-llabs-abs64.md)|Najít absolutní hodnota **dlouhé** celé číslo|
...
|[tolower, _tolower, towlower, _tolower_l, _towlower_l](../c-runtime-library/reference/tolower-tolower-towlower-tolower-l-towlower-l.md)|Převod znaků na malá písmena bezpodmínečně|
