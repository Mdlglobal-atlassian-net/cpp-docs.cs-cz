---
title: "Podpora plovoucí desetinné čárky | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="floating-point-support"></a>Podpora plovoucí desetinné čárky
