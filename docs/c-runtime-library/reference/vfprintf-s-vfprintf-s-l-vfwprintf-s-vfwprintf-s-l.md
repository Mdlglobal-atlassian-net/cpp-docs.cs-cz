...
ms.locfileid: "70957438"
---
# <a name="vfprintf_s-_vfprintf_s_l-vfwprintf_s-_vfwprintf_s_l"></a>vfprintf_s, _vfprintf_s_l, vfwprintf_s, _vfwprintf_s_l

Zapíše formátovaný výstup pomocí ukazatele na seznam argumentů. Jedná se o verze [vfprintf, _vfprintf_l, vfwprintf, _vfwprintf_l](vfprintf-vfprintf-l-vfwprintf-vfwprintf-l.md) s vylepšeními zabezpečení, jak [je popsáno v části funkce zabezpečení v CRT](../../c-runtime-library/security-features-in-the-crt.md).
...
Tyto funkce se liší od nezabezpečených verzí pouze v tom, že zabezpečené verze kontrolují, zda řetězec *formátu* obsahuje platné formátovací znaky.

**vfwprintf_s** je **vfprintf_s**verze s velkým znakem; Tyto dvě funkce se chovají stejně, pokud je datový proud otevřen v režimu ANSI. **vfprintf_s** v současné době nepodporuje výstup do datového proudu Unicode.
