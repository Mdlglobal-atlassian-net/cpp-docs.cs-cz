...
Tato funkce POSIX je zastaralý. Používat vyhovující ISO C++ [_lfind –](../../c-runtime-library/reference/lfind.md) nebo rozšířené zabezpečení [_lfind_s –](../../c-runtime-library/reference/lfind-s.md) místo.