...
Tato funkce POSIX je zastaralý. Používat vyhovující ISO C++ [_stricmp –](../../c-runtime-library/reference/stricmp-wcsicmp-mbsicmp-stricmp-l-wcsicmp-l-mbsicmp-l.md) místo.