...
Porovná řetězce pomocí aktuálního národního prostředí nebo zadané kategorie konverze LC_COLLATE-State.
...
Každá z těchto funkcí vrátí **_NLSCMPERROR** na chybu. Chcete-li použít **_NLSCMPERROR**, zahrňte buď řetězec. H nebo MBSTRING. Y. **wcscoll** se může podařit, pokud buď *řetězec1* nebo *řetězec2* má **hodnotu null** , nebo obsahuje kódy s velkým znakem mimo doménu pořadí řazení. Když dojde k chybě, **wcscoll** může nastavit **errno** na **EINVAL**. Chcete-li vyhledat chybu volání **wcscoll**, nastavte **errno** na hodnotu 0 a po volání **wcscoll**zaškrtněte **errno** .
