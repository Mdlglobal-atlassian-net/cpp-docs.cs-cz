...
## <a name="return-value"></a>Návratová hodnota  
 Jednotlivé funkce vrátí `__int64` hodnotu vyprodukované interpretace vstupu znaky jako číslo. Vrácená hodnota je 0 pro `_atoi64` Pokud vstup nelze převést na hodnotu daného typu.  
