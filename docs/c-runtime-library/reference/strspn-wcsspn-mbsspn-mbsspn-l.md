...
**wcsspn** a **_mbsspn** jsou verze **strspn**pro velké znaky a vícebajtové znaky. Argumenty **wcsspn** jsou řetězce s velkým počtem znaků; **_mbsspn** jsou vícebajtové znakové řetězce. **_mbsspn** ověří své parametry. Pokud parametr *str* nebo *StrCharSet* má **hodnotu null**, je vyvolána obslužná rutina neplatného parametru, jak je popsáno v tématu [ověřování parametru](../../c-runtime-library/parameter-validation.md) . Pokud provádění může pokračovat, **_mbspn** nastaví **errno** na **EINVAL** a vrátí hodnotu 0. **strspn** a **wcsspn** neověřují své parametry. Tyto tři funkce se chovají identicky jinak.
