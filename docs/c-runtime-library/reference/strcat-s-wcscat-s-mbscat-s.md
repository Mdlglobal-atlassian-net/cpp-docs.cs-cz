...
|Jakýmikoli|Jakýmikoli|**NULL**|**EINVAL**|*strDestination* [0] nastavit na 0|
|Jakýmikoli|0 nebo příliš malý|Jakýmikoli|**ERANGE**|*strDestination* [0] nastavit na 0|
