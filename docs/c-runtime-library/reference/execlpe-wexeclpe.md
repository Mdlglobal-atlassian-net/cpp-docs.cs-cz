...
Každá z těchto funkcí načte a spustí nový proces předávání každý argument příkazového řádku jako samostatného parametru a také řadu ukazatele předávání do nastavení prostředí. Použijte tyto funkce **cesta** proměnnou prostředí najít soubor provést.
