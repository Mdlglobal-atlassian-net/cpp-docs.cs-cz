...
Vzhledem k tomu, že jazyk C++ umožňuje přetížení, můžete volat přetížení metody **tan** , které přijímají a vracejí hodnoty **float** nebo **Long** **Double** . V programu v jazyce C provede funkce **tan** vždycky a vrátí hodnotu **Double**.
