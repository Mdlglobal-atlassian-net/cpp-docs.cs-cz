...
Protože jazyk C++ umožňuje přetížení, můžete volat přetížení **casinh** , která používají a vrací **_Fcomplex** a **_Lcomplex** hodnoty. V programu jazyka C **casinh** vždy převezme a vrátí **_Dcomplex** hodnotu.
