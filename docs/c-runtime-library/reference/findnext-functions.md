...
Najít další název, pokud existuje, který odpovídá `filespec` argument v předchozích volání [_findfirst –](../../c-runtime-library/reference/findfirst-functions.md)a poté změňte `fileinfo` struktury obsah odpovídajícím způsobem.  
...
## <a name="return-value"></a>Návratová hodnota  
 ...
 `ENOMEM`  
 Nedostatek paměti nebo překročena délka názvu souboru `MAX_PATH`.  
