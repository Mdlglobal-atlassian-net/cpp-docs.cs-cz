...
Protože C++ umožňuje, aby přetížení, můžete volat přetížení **ccos** , přijmout a vrátit **_Fcomplex** a **_Lcomplex** hodnoty. V programu C **ccos** vždy provede a vrátí **_Dcomplex** hodnotu.
