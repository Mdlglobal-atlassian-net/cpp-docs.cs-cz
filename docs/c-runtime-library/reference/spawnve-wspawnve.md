...
Každá z těchto funkcí se vytvoří a spustí nový proces, předávání pole ukazatele argumenty příkazového řádku a pole ukazatele na nastavení prostředí.
