...
Funkce **_strupr** převádí na místě každé malé písmeno v *str* na velká písmena. Převod je určen nastavením kategorie **LC_CTYPE** národního prostředí. Jiné znaky nejsou ovlivněny. Další informace o **LC_CTYPE**najdete v tématu [setlocale](setlocale-wsetlocale.md). Verze těchto funkcí bez přípony **_l** používají aktuální národní prostředí; verze s příponou **_l** jsou stejné s tím rozdílem, že místo toho používají předané národní prostředí. Další informace najdete v tématu [národní prostředí](../../c-runtime-library/locale.md).

**_wcsupr** a **_mbsupr** jsou verze **_strupr**a vícebajtových znaků. Argument a návratová hodnota **_wcsupr** jsou řetězce s velkým počtem znaků; **_mbsupr** jsou vícebajtové znakové řetězce. Tyto tři funkce se chovají identicky jinak.
...
Podívejte se na příklad [_strlwr](strlwr-wcslwr-mbslwr-strlwr-l-wcslwr-l-mbslwr-l.md).
