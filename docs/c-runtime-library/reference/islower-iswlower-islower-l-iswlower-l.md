...
Každá z těchto rutin vrátí nenulovou hodnotu, pokud je *c* konkrétní reprezentace malého znaku. funkce **Lower** vrátí nenulovou hodnotu, pokud je *c* malý znak (a-z). **iswlower** vrací nenulovou hodnotu, pokud je *c* celé číslo, které odpovídá malému písmenu, nebo pokud je *c* jednou ze sad definovaných implementací velkých znaků, pro které žádná z hodnot **iswcntrl**, **iswdigit**, **iswpunct**nebo **iswspace** není nenulová. Každá z těchto rutin vrátí hodnotu 0, pokud *c* nesplňuje podmínky testu.
...
Chování **Lower** a **_islower_l** není definováno, pokud *c* není EOF nebo v rozsahu 0 až 0xFF, včetně. Pokud je použita knihovna CRT ladění a *c* není jedna z těchto hodnot, funkce vyvolá kontrolní výraz.

### <a name="generic-text-routine-mappings"></a>Mapování rutin obecného textu

|Rutina TCHAR.H|_UNICODE & _MBCS není definováno.|_MBCS definováno|_UNICODE definováno|
|---------------------|------------------------------------|--------------------|-----------------------|
|**_istlower**|**snížit**|[_ismbclower](ismbclower-ismbclower-l-ismbcupper-ismbcupper-l.md)|**iswlower**|
