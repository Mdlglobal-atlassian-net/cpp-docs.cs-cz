---
title: "Zrušit propojení | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Tato funkce POSIX je zastaralý. Používat vyhovující ISO C++ [_unlink –](../../c-runtime-library/reference/unlink-wunlink.md) místo.