...
Tyto funkce POSIX jsou zastaralé. Používat vyhovující ISO C++ [_strrev –, _wcsrev –, _mbsrev _mbsrev_l –](../../c-runtime-library/reference/strrev-wcsrev-mbsrev-mbsrev-l.md) místo.