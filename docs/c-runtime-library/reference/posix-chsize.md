...
Tato funkce POSIX je zastaralý. Používat vyhovující ISO C++ [_chsize –](../../c-runtime-library/reference/chsize.md) nebo rozšířené zabezpečení [_chsize_s –](../../c-runtime-library/reference/chsize-s.md) místo.