...
Funkce **wcstombs_s** převede řetězec velkých znaků, na které odkazoval *wcstr* na vícebajtové znaky uložené ve vyrovnávací paměti, na kterou ukazuje *mbstr*. Převod bude pro každý znak pokračovat, dokud nebude splněna jedna z těchto podmínek:
...
Pokud *Count* je speciální hodnota [_TRUNCATE](../../c-runtime-library/truncate.md), **wcstombs_s** se převede jako velká část řetězce, aby se vešla do cílové vyrovnávací paměti, zatímco pořád opouští místo pro ukončovací znak null. Pokud je řetězec zkrácen, návratová hodnota je **STRUNCATE**a převod je považován za úspěšný.
...
Pokud **wcstombs_s** nalezne velký znak, nemůže převést na vícebajtový znak, bude mít 0 v *&#42;pReturnValue*, nastaví cílovou vyrovnávací paměť na prázdný řetězec, nastaví **errno** na **EILSEQ**a vrátí **EILSEQ**.
...
**wcstombs_s** používá aktuální národní prostředí pro jakékoli chování závislé na národním prostředí; **_wcstombs_s_l** se shodují s **wcstombs** s tím rozdílem, že místo toho používá národní prostředí předané. Další informace najdete v tématu [národní prostředí](../../c-runtime-library/locale.md).
