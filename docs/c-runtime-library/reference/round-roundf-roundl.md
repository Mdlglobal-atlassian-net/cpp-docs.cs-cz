...
Vzhledem k tomu, že jazyk C++ umožňuje přetížení, můžete volat přetížení **zaoblení** , která přijímají a vracejí hodnoty **float** a **Long** **Double** . V programu v jazyce C, **zaokrouhlí** vždy zabere a vrátí hodnotu **Double**.
