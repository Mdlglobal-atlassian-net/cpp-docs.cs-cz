...
Pro další podrobnosti můžete použít [_fpclass _fpclassf,](fpclass-fpclassf.md) které jsou specifické pro společnost Microsoft. Pro přenositelnost použijte makro nebo funkci [fpclassify –](fpclassify.md) .
...
Tyto primitivy s plovoucí desetinnou čárkou implementují verze C++ funkce CRT [fpclassify –](fpclassify.md) pro typy s plovoucí desetinnou čárkou. Argument *x* je vyhodnocen a klasifikace je vrácena jako jedna z těchto konstant, definována v Math. h:
...
Pro další podrobnosti můžete použít [_fpclass _fpclassf,](fpclass-fpclassf.md) které jsou specifické pro společnost Microsoft. Pro přenositelnost použijte funkci [fpclassify –](fpclassify.md) .
...
Tyto primitivní funkce s plovoucí desetinnou čárkou Vrátí přirozený protokol *x*, LN (*x*) nebo protokolu<sub>*e*</sub>(*x*), když *base_flag* je 0. Vrátí protokolový základ 10 z *x*nebo protokol<sub>10</sub>(*x*), pokud *base_flag* není nula. Tyto funkce se nepoužívají interně. Pro přenositelnost, preferovat protokoly funkcí [, logf –, logl, log10 –, log10f – a log10l](log-logf-log10-log10f.md).
...
Tyto primitivy s plovoucí desetinnou čárkou vrací *x* sinus posunu x *kvadrantem* modulo 4. Efektivně Vrátí sinus, kosinus,-sinus a-kosinus hodnoty *x* , pokud je v případě *, že modulo* 4 je 0, 1, 2 nebo 3, v uvedeném pořadí. Tyto funkce se nepoužívají interně. Pro přenositelnost můžete upřednostnit funkce [Sin, sinf –, Sinl](sin-sinf-sinl.md), [cos, cosf – a cosl](cos-cosf-cosl.md) .
