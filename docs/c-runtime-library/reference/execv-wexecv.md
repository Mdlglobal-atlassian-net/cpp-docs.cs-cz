...
Funkce **_execv** ověřují jejich parametry. Pokud *cmdname* je ukazatel null, nebo pokud *argv* je ukazatel null, ukazatel na prázdné pole, nebo pokud pole obsahuje prázdný řetězec jako první argument, **_execv** funkce vyvolat neplatný parametr obslužné rutiny, jak je popsáno v [ověření parametru](../../c-runtime-library/parameter-validation.md). Pokud je povoleno provádění pokračovat, tyto funkce nastavit **errno** **eINVAL** a vrátit -1. Není spuštěn žádný proces.
