...
*Název souboru*<br/>
Ukazatel na název zdrojového souboru, který požadovanou operaci realloc – nebo hodnota NULL.

*lineNumber*<br/>
Ve zdrojovém souboru, kde byla vyžádána operace realloc – číslo řádku nebo hodnota NULL.
