---
title: Národní prostředí | Dokumentace Microsoftu
ms.custom: ''
ms.date: 04/11/2018
ms.technology:
...
|[je rutiny](../c-runtime-library/is-isw-routines.md)|Test pro konkrétní podmínky zadané celé číslo.|**LC_CTYPE**|
