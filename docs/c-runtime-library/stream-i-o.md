---
title: Stream vstupně-výstupních operací | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
|[freopen –, _wfreopen –](../c-runtime-library/reference/freopen-wfreopen.md), [freopen_s –, _wfreopen_s –](../c-runtime-library/reference/freopen-s-wfreopen-s.md)|Přiřazení **souboru** datového proudu ukazatel na nový soubor nebo zařízení|
...
|[gets_s, _getws_s](../c-runtime-library/reference/gets-s-getws-s.md)|Načíst řádek ze **stdin –**|
...
|[_rmtmp](../c-runtime-library/reference/rmtmp.md)|Odeberte dočasné soubory vytvořené **tmpfile –**|
