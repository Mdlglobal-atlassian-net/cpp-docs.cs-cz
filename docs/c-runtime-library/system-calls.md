---
title: Systémová volání | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
|Funkce|Použití|
|--------------|---------|
|[_findclose](../c-runtime-library/reference/findclose.md)|Uvolnění prostředků z předchozí operace hledání|
