...
|[_ismbcalpha, _ismbcalpha_l](../c-runtime-library/reference/ismbcalnum-functions.md)|Abecedy|Vrátí nenulovou hodnotu právě tehdy `c` je jednobajtové znázornění písmena anglické abecedy ASCII: Viz příklady pro `_ismbcupper` a `_ismbclower`; nebo písma katakana písmena: 0xA6<=`c`<=0xDF.|
...
|[_ismbcl1, _ismbcl1_l](../c-runtime-library/reference/ismbcl0-ismbcl0-l-ismbcl1-ismbcl1-l-ismbcl2-ismbcl2-l.md)|Úroveň JIS-1: 0x889F < =`c`< = 0x9872.|
|[_ismbcl2, _ismbcl2_l](../c-runtime-library/reference/ismbcl0-ismbcl0-l-ismbcl1-ismbcl1-l-ismbcl2-ismbcl2-l.md)|Úroveň JIS-2: 0x989F<=`c`<=0xEA9E.|
