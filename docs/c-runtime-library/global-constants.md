...
ms.locfileid: "62343432"
---
# <a name="global-constants"></a>Globální konstanty

Běhové knihovny Microsoft obsahuje definice pro globální konstanty používá rutiny knihoven. Pokud chcete použít tyto konstanty, zahrňte soubory odpovídající hlavičku jak je uvedeno v popisu jednotlivých konstantách. Globální konstanty jsou uvedeny v následující tabulce.

|||
|-|-|
|[Formáty času a data 32bitová verze Windows](../c-runtime-library/32-bit-windows-time-date-formats.md)|[BUFSIZ](../c-runtime-library/bufsiz.md)|
|[CLOCKS_PER_SEC, CLK_TCK](../c-runtime-library/clocks-per-sec-clk-tck.md)|[Konstanty potvrzení na disk](../c-runtime-library/commit-to-disk-constants.md)|
|[_CRT_DISABLE_PERFCRIT_LOCKS](../c-runtime-library/crt-disable-perfcrit-locks.md)|[Konstanty datových typů](../c-runtime-library/data-type-constants.md)|
...
|[EXIT_SUCCESS, EXIT_FAILURE](../c-runtime-library/exit-success-exit-failure.md)|[Konstanty atributů souboru](../c-runtime-library/file-attribute-constants.md)|
...
|[Konstanty režimu překladu](../c-runtime-library/translation-mode-constants.md)|[_TRUNCATE](../c-runtime-library/truncate.md)|
